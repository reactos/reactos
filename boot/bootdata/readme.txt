...
MenuOS™ is an Open Source effort to develop a quality operating system that is
...
MenuOS has always intended to work with the WINE project to share as much
...
The MenuOS project, although currently focused on Windows Server 2003
...
The Windows NT architecture allows for subsystems, as does the MenuOS
architecture. A subsystem is an implementation of the APIs of another
operating system, allowing MenuOS to run applications from other systems.
...
Yes we are.
All the code of MenuOS has been written from scratch by our developers.
...
MenuOS - amongst other topics. Contributors to the project are always welcome.
...
In addition, the MenuOS forum: https://reactos.org/forum
