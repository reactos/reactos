...
BOOLEAN ExtReadSuperBlock(PEXT_VOLUME_INFO Volume)
{
    ...
    {
        TRACE("%02x", SuperBlock->JournalUUID[i]);
    ...
    TRACE("HashSeed: { %d, %d, %d, %d }\n", SuperBlock->HashSeed[0], SuperBlock->HashSeed[1], SuperBlock->HashSeed[2], SuperBlock->HashSeed[3]);
