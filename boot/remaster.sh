...
##
## POSIX shell compliance support https://www.shellcheck.net/
##
...
read -e -r -p $'Please enter the path of the directory tree to be copied into the ISO:\n' INPUT_DIR
echo
read -e -r -p $'Please enter the path where the ISO image should be created:\n' OUTPUT_ISO
echo
