...
UNICODE_STRING PopPowerRegPath = RTL_CONSTANT_STRING(L"\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Session Manager\\Power");
UNICODE_STRING PopPowerSimulateRegValue = RTL_CONSTANT_STRING(L"PowerSimulate");
