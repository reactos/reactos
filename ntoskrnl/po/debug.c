...
/**
 * @brief
 * Reports the watchdog time of a power IRP to the debugger.
 */
VOID
NTAPI
...
/**
 * @brief
 * Translates the power system state to a readable string.
 */
PCSTR
NTAPI
...
/**
 * @brief
 * Translates the power device state to a readable string.
 */
PCSTR
NTAPI
...
/**
 * @brief
 * Translates the power information levels enumeration into
 * readable strings.
 */
PCWSTR
NTAPI
...
/**
 * @brief
 * Reports the composite battery information to the debugger.
 */
VOID
NTAPI
...
/**
 * @brief
 * Reports the composite battery status to the debugger.
 */
VOID
NTAPI
...
/**
 * @brief
 * Scans for any active power request and reports their information
 * to the debugger.
 */
...
/**
 * @brief
 * Reports a power request object to the debugger that's been
 * newly created.
 */
VOID
NTAPI
