...
#define POP_POWER_SETTING_CALLBACK_NOTIFY_ALLOCATION_FAILURE 6
...
#define POP_CB_INITIALIZING             0x00000008
...
//
// Power setting notify entry
//
typedef struct _POP_POWER_SETTING_NOTIFY_ENTRY
{
    WORK_QUEUE_ITEM NotifyWorkItem;
    PPOP_POWER_SETTING_CALLBACK SettingCallback;
} POP_POWER_SETTING_NOTIFY_ENTRY, *PPOP_POWER_SETTING_NOTIFY_ENTRY;
...
extern KEVENT PopCbInitialized;
