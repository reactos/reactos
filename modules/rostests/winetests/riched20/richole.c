...
#ifdef __REACTOS__  
#define debugstr_guid(id) wine_dbgstr_guid(id)  
#endif
...
#ifdef __REACTOS__ // -Werror=discarded-qualifiers
static struct IRichEditOleCallbackVtbl reolecb_obj_Vtbl = {
#else 
...
#ifdef __REACTOS__ // -Werror=discarded-qualifiers
static struct IOleObjectVtbl testoleobj_IOleObject_Vtbl = {
#else
...
#ifdef __REACTOS__ // -Werror=discarded-qualifiers
static struct IViewObjectVtbl testoleobj_IViewObject_Vtbl = {
#else
...
#ifndef __REACTOS__ // Already defined in psdk/textserv.h
