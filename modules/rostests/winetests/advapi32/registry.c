...
#ifndef __REACTOS__ // FIXME: ReactOS has no implementation for RegLoadAppKeyA()
...
{
#ifdef __REACTOS__
    skip("test_RegRenameKey() can't be built until ReactOS gets an implementation for RegRenameKey()\n");
#else
    HKEY key, key2;
    LSTATUS ret;
