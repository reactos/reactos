...
static const TEST_ENTRY s_entries[] =
{
    ...
    {__LINE__, GM_COMPATIBLE, {XCENTER, YCENTER}, TA_LEFT | TA_BOTTOM, {0, 0, 0, 0, 1, 0}, FALSE, L"012.bmp", NO_TRANS_1},
    {__LINE__, GM_COMPATIBLE, {XCENTER, YCENTER}, TA_LEFT | TA_BOTTOM, {0, 0, 0, 0, 0, 1}, FALSE, L"013.bmp", NO_TRANS_1},
    ...
    {__LINE__, GM_COMPATIBLE, {XCENTER, YCENTER}, TA_LEFT | TA_TOP, {0, 0, 0, 0, 1, 0}, FALSE, L"112.bmp", NO_TRANS_2},
    {__LINE__, GM_COMPATIBLE, {XCENTER, YCENTER}, TA_LEFT | TA_TOP, {0, 0, 0, 0, 0, 1}, FALSE, L"113.bmp", NO_TRANS_2},
    ...
    {__LINE__, GM_ADVANCED, {XCENTER, YCENTER}, TA_LEFT | TA_BOTTOM, {0, 0, 0, 0, 1, 0}, FALSE, L"212.bmp", NO_TRANS_1},
    {__LINE__, GM_ADVANCED, {XCENTER, YCENTER}, TA_LEFT | TA_BOTTOM, {0, 0, 0, 0, 0, 1}, FALSE, L"213.bmp", NO_TRANS_1},
