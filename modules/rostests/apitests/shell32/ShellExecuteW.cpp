...
START_TEST(ShellExecuteW)
{
    ...
    trace("TEST #1 ret: %d.\n", ret);
    CloseWindow(hInstance, NULL, L"Properties for Display");
    ...
    trace("TEST #2 ret: %d.\n", ret);
    CloseWindow(hInstance, L"Notepad", L"Untitled - Notepad");
    ...
    trace("TEST #6 ret: %d.\n", ret);
    CloseWindow(hInstance, L"CabinetWClass", L"Search Results");
