...
static BOOL extract_resource(WCHAR* Filename, LPCWSTR ResourceName)
{
...
static bool InitializeShellFolder_(const char* file, int line, const WCHAR* Filename, CComPtr<IShellFolder>& spFolder)
{
