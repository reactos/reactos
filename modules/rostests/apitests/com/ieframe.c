...
{
    {
        ID_NAME(CLSID_IE_SearchBand, NTDDI_MIN, NTDDI_MAX),
        {
    ...
    {
        ID_NAME(CLSID_Internet, NTDDI_MIN, NTDDI_MAX),
        {
            { NTDDI_MIN, NTDDI_MAX, &IID_IObjectWithBackReferences },
    ...
    {
        ID_NAME(CLSID_ShellWindows, NTDDI_MIN, NTDDI_MAX),
        {
            { NTDDI_MIN, NTDDI_MAX, &IID_IMarshal2 },
            { NTDDI_MIN, NTDDI_MAX, &IID_IMarshal },
            { NTDDI_MIN, NTDDI_MAX, &IID_IClientSecurity },
            { NTDDI_MIN, NTDDI_MAX, &IID_IRpcOptions },
            { NTDDI_MIN, NTDDI_MAX, &IID_ICallFactory },
            { NTDDI_MIN, NTDDI_MAX, &IID_IForegroundTransfer },
            { NTDDI_MIN, NTDDI_MAX, &IID_IMultiQI },
            { NTDDI_MIN, NTDDI_MAX, &IID_IUnknown },
            { NTDDI_MIN, NTDDI_MAX, &IID_IShellWindows },
            { NTDDI_MIN, NTDDI_MAX, &IID_IDispatch },
            { NTDDI_MIN, NTDDI_MAX, &IID_IConnectionPointContainer },
        }
    },
    {
        ID_NAME(CLSID_WebBrowser, NTDDI_MIN, NTDDI_MAX),
        {
            ...
            { NTDDI_MIN, NTDDI_MAX, &IID_IEFrameAuto },
            { NTDDI_MIN, NTDDI_MAX, &IID_IWebBrowserPriv },
            { NTDDI_MIN, NTDDI_MAX, &IID_IWebBrowserPriv2 },
