...
int _setjmp3(_JUMP_BUFFER* Buf, unsigned Count, void* UnwindFunc, unsigned TryLevel, ...);
...
static void TEST_setjmp3(void)
{
    ...
    memset(&BufferData, 0xCC, sizeof(BufferData));
    _setjmp3(Buf, 0, (void*)0x12345, 3, 0xA1A1A1A1, 0xA2A2A2A2, 0xA3A3A3A3, 0xA4A4A4A4);
    ok_eq_hex(Buf->Registration, __readfsdword(0));
    ...
    memset(&BufferData, 0xCC, sizeof(BufferData));
    _setjmp3(Buf, 1, Data, 7, 0xA1A1A1A1, 0xA2A2A2A2, 0xA3A3A3A3, 0xA4A4A4A4);
    ok_eq_hex(Buf->Registration, __readfsdword(0));
    ...
    memset(&BufferData, 0xCC, sizeof(BufferData));
    _setjmp3(Buf, 2, Data, 7, 0xA1A1A1A1, 0xA2A2A2A2, 0xA3A3A3A3, 0xA4A4A4A4);
    ok_eq_hex(Buf->Registration, __readfsdword(0));
    ok_eq_hex(Buf->TryLevel, 7);
    ok_eq_hex(Buf->Cookie, 0x56433230);
    ok_eq_hex(Buf->UnwindFunc, (ULONG)Data);
    ...
    memset(&BufferData, 0xCC, sizeof(BufferData));
    _setjmp3(Buf, 3, Data, 7, 0xA1A1A1A1, 0xA2A2A2A2, 0xA3A3A3A3, 0xA4A4A4A4);
    ok_eq_hex(Buf->Registration, __readfsdword(0));
    ok_eq_hex(Buf->TryLevel, 7);
    ok_eq_hex(Buf->Cookie, 0x56433230);
    ok_eq_hex(Buf->UnwindFunc, (ULONG)Data);
    ...
    memset(&BufferData, 0xCC, sizeof(BufferData));
    _setjmp3(Buf, 11, (PVOID)0xdeadbeef, 7, 0xA1A1A1A1, 0xA2A2A2A2, 0xA3A3A3A3, 0xA4A4A4A4, 0xA5A5A5A5, 0xA6A6A6A6, 0xA7A7A7A7, 0xA8A8A8A8, 0xA9A9A9A9);
    ok_eq_hex(Buf->Registration, __readfsdword(0));
    ok_eq_hex(Buf->TryLevel, 7);
    ok_eq_hex(Buf->Cookie, 0x56433230);
