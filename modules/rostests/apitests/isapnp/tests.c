...
DrvTestResources(VOID)
{
        ...
        switch (i++)
        {
            ...
            case 2:
            {
                ...
                /* I/O configuration test */
                {
                    ...
                    ResourceList = DrvTestCard1Dev3CreateConfigurationResources();
                    ...
                    DrvTestCard1Dev3ConfigurationResult(LogDev);
    ...
    ok(i == 4, "Some devices not tested\n");
}
