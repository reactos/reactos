 ...
 * PURPOSE:     Precompiled header for isapnp_apitest
...
typedef struct _IO_RESOURCE_LIST
{
    ...
    USHORT Revision;
    ULONG Count;
    IO_RESOURCE_DESCRIPTOR Descriptors[ANYSIZE_ARRAY];
...
typedef struct _IO_RESOURCE_REQUIREMENTS_LIST
{
    ...
    IO_RESOURCE_LIST List[ANYSIZE_ARRAY];
...
#define TEST_MAX_SUPPORTED_DEVICES     3
...
PCM_RESOURCE_LIST
DrvTestCard1Dev3CreateConfigurationResources(VOID);

VOID
DrvTestCard1Dev3ConfigurationResult(
