...
static MUI_ENTRY ukUAConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        10,
        "Системнi роздiли можуть мiстити дiагностичнi програми, програми",
        TEXT_STYLE_NORMAL
    },
    {
        6,
        11,
        "налаштування апаратних засобiв, програми для запуску ОС (як ReactOS)",
        TEXT_STYLE_NORMAL
    },
    {
        6,
    ...
    },
    {
        6,
        14,
        "Видаляйте системний роздiл, коли впевненi, що на ньому немає важливих",
        TEXT_STYLE_NORMAL
    },
    {
        6,
        15,
        "програм або коли ви впевненi, що вони не потрiбнi.",
        TEXT_STYLE_NORMAL
    },
    {
        6,
    ...
    },
    {
        8,
        20,
        "\x07  Натиснiть ENTER щоб видалити системний роздiл. ",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        21,
        "   Пiзнiше Ви повиннi будете пiдтвердити видалння знову.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        24,
        "\x07  Натиснiть ESC щоб повернутись до попередньої сторiнки.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        25,
        "   Роздiл не буде видалено.",
        TEXT_STYLE_NORMAL
    },
    {
        0,
...
//     "Ви хочете створити новий роздiл на"},
    ...
    "%I64u %s  Жорсткий диск %lu  (Порт=%hu, Шина=%hu, Id=%hu) на %wZ [%s]."},
    {STRING_HDINFOPARTCREATE_2,
    "%I64u %s  Жорсткий диск %lu  (Порт=%hu, Шина=%hu, Id=%hu) [%s]."},
    {STRING_HDDINFOUNK2,
    "   %c%c  Type 0x%02X    %I64u %s"},
    {STRING_HDINFOPARTDELETE_1,
    "на %I64u %s  Жорсткий диск %lu  (Порт=%hu, Шина=%hu, Id=%hu) на %wZ [%s]."},
    ...
    "%6lu %s  Жорсткий диск %lu  (Порт=%hu, Шина=%hu, Id=%hu) на %wZ [%s]"},
