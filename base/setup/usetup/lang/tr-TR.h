...
static MUI_ENTRY trTRChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        18,
        "ReactOS'u başar\215yla kurmak i\207in, Kurulum program\215 mevcut",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        32,
        "Orijinal sistem b\224l\201m\201ne ba\247lı olan başka i\237letim sistemleri olmas\215",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR trTRErrorEntries[] =
{
    ...
    {
        // ERROR_SOURCE_DIR
        "ReactOS'u kurulum kaynak dizini i\207ine kuramazsınız!\n"
        "ENTER = Bilgisayar\215 Yeniden Ba\237lat"
    },
    {
        // ERROR_NO_HDD
...
MUI_STRING trTRStrings[] =
{
    ...
    {STRING_DELETING,
     "   Dosya siliniyor: %S"},
    {STRING_MOVING,
     "   Dosya ta\237ınıyor: %S \237uraya: %S"},
    {STRING_RENAMING,
