    ...
    _In_opt_ PFMIFSCALLBACK Callback)
{
    ...
    if (!FileSystem || !FileSystem->ChkdskFunc)
    {
        ...
        return STATUS_NOT_SUPPORTED; // STATUS_UNRECOGNIZED_VOLUME;
    }
...
//
// TODO: Here, call a vollist.c function that updates
    ...
    _In_opt_ PVOID Context)
{
    ...
    ASSERT(PartitionList && InstallVolume && SystemVolume);
