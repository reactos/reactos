...
.
Language=Romanian
Afișează și modifică tabelele de traducere din adrese IP în adrese fizice folosite de
...
ARP -a [inet_addr] [-N if_addr]
  ...
  if_addr       Dacă e prezentă, aceasta specifică adresa de Internet a
                interfeței al cărui tabel de traducere a adreselor trebuie modificat.
