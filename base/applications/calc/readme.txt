...
INTRODUCTION
=============
This is MenuOS Calc, a scientific calculator for Win32 and Win64 systems.
...
The user interface of MenuOS Calc is really similar to Microsoft calculator, so you should be able to use this replacement very quickly.

COMPILATION
============
You need MinGW for compiling MenuOS Calc.
...
========================
MenuOS Calc uses HTMLHELP for opening the help file and generating the popups.
...
For MenuOS's users, it must be \MenuOS\Help (at the moment the Help directory doesn't exists, so it must be created manually).

NOTES TO REACTOS'S USERS
=========================
At the time of the write of this text, the newest version of MenuOS is 0.3.4.
While MenuOS Calc works fine with Microsoft's operating systems, there are some known issues with MenuOS:
...
* Into the aboutbox, the color around the MenuOS's logo isn't applied.
...
Although MenuOS Calc is pretty simple and I still think you should be able to understand the basic operations yourself, a good manual would be a nice presentation for new users.
