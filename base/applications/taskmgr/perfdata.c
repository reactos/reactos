...
BOOL PerfDataInitialize(VOID)
{
    ...
    BufferSize = sizeof(*SystemProcessorTimeInfo) * SystemBasicInfo.NumberOfProcessors;
    ...
    ProcessorTimes = HeapAlloc(GetProcessHeap(), HEAP_ZERO_MEMORY,
                               sizeof(*ProcessorTimes) * SystemBasicInfo.NumberOfProcessors);
    if (!ProcessorTimes)
...
VOID PerfDataRefresh(VOID)
{
    ...
    ulSize = sizeof(*SystemProcessorTimeInfo) * SystemBasicInfo.NumberOfProcessors;
