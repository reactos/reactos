...
int wmain(int argc, WCHAR *argv[])
{
    ...
    {
        totalNumberOfBytes.QuadPart = DeviceInformation->SectorSize * DeviceInformation->SectorCount.QuadPart;
    }

    RtlFreeHeap(RtlGetProcessHeap(), 0, DeviceInformation);

    /* GetDiskFreeSpaceExW fallback for XP/2003 */
