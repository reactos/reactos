  ...
  DWORD Routine)
{
  ...
  switch(Routine)
  {
    ...
    case ONEPARAM_ROUTINE_GETCURSORPOSITION:
    {
      ...
      UserGetCursorLocation(WinStaObject, &Pos);
...
//   BOOL Result = TRUE;
  ...
  UserEnterExclusive();
   ...
   //huhuh???? Result &= IntDesktopUpdatePerUserSettings(bEnable);
  RETURN( IntDesktopUpdatePerUserSettings(bEnable));
