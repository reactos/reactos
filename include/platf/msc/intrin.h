...
#if defined(_M_X64)
i8u _interlockedbittestandset64(i64 volatile *dest, i64 bit);
#define _InterlockedBitTestAndSet64 _interlockedbittestandset64
_INLINEF i8u _InterlockedBitTestAndSetPointer(void * volatile *dest, i64 bit) {
	return _InterlockedBitTestAndSet64((i64 volatile *)dest, bit);
}
#else
_INLINEF i8u _InterlockedBitTestAndSetPointer(void * volatile *dest, i32 bit) {
	return _InterlockedBitTestAndSet((i32 volatile *)dest, bit);
}
#endif

unsigned char _interlockedbittestandreset(volatile long * a, const long b);

i32 _InterlockedCompareExchange(i32 volatile * dest, i32 exch, i32 comperand);
char _InterlockedCompareExchange8(char volatile* dest, char exch, char comperand);
short _InterlockedCompareExchange16(volatile short * const Destination, const short Exchange, const short Comperand);
#if defined(_M_X64)
void * _InterlockedCompareExchangePointer(void * volatile * const dest, void * const exch, void * const comperand);
#else
_INLINEF void *_InterlockedCompareExchangePointer(void * volatile *dest, void *exch, void *comperand)
{
