...
#if defined(__REACTOS__) && !defined(_LIBCPP_VERSION)
/* Helpers for the mingw libstdc++ configuration that lacks std::to_wstring;
 * libc++ provides the full overload set and these would be ambiguous there */
