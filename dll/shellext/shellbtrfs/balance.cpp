    ...
    try {
        switch (uMsg) {
            case WM_INITDIALOG:
            {
                ...
                s = btrfs_to_wstring(opts->usage_start);
                ...
                s = btrfs_to_wstring(opts->usage_end);
                ...
                s = btrfs_to_wstring(opts->drange_start);
                SetDlgItemTextW(hwndDlg, IDC_DRANGE_START, s.c_str());

                s = btrfs_to_wstring(opts->drange_end);
                ...
                s = btrfs_to_wstring(opts->vrange_start);
                SetDlgItemTextW(hwndDlg, IDC_VRANGE_START, s.c_str());

                s = btrfs_to_wstring(opts->vrange_end);
                ...
                s = btrfs_to_wstring(opts->limit_start);
                ...
                s = btrfs_to_wstring(opts->limit_end);
                ...
                s = btrfs_to_wstring(opts->stripes_start);
                ...
                s = btrfs_to_wstring(opts->stripes_end);
