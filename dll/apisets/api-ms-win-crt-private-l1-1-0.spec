...
@ stdcall -arch=i386 __CxxFrameHandler2() msvcrt.__CxxFrameHandler2 # should be x64, too
@ stdcall -arch=arm __CxxFrameHandler3() msvcrt.__CxxFrameHandler3 # should be x64, too
