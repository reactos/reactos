...
@ stdcall -version=0x600+ _access_s() msvcrt._access_s
...
@ stdcall -version=0x600+ _makepath_s() msvcrt._makepath_s
...
@ stdcall -version=0x600+ _umask_s() msvcrt._umask_s
@ stdcall _unlink() msvcrt._unlink
@ stub _unlock_file
@ stdcall _waccess() msvcrt._waccess
@ stdcall -version=0x600+ _waccess_s() msvcrt._waccess_s
