...
353 stdcall -noname -private StrCmpNIA(str str long) kernelbase_ros.StrCmpNIA
354 stdcall -noname -private StrStrA(str str) kernelbase_ros.StrStrA
355 stdcall -noname -private StrStrIA(str str) kernelbase_ros.StrStrIA
356 stdcall -noname -private StrCSpnA(str str) kernelbase_ros.StrCSpnA
357 stdcall -noname -private StrToIntA(str) kernelbase_ros.StrToIntA
358 stdcall -noname -private StrChrW(wstr long) kernelbase_ros.StrChrW
359 stdcall -noname -private StrRChrW(wstr wstr long) kernelbase_ros.StrRChrW
360 stdcall -noname -private StrCmpNW(wstr wstr long) kernelbase_ros.StrCmpNW
361 stdcall -noname -private StrCmpNIW(wstr wstr long) kernelbase_ros.StrCmpNIW
362 stdcall -noname -private StrStrW(wstr wstr) kernelbase_ros.StrStrW
363 stdcall -noname -private StrStrIW(wstr wstr) kernelbase_ros.StrStrIW
364 stdcall -noname -private StrCSpnW(wstr wstr) kernelbase_ros.StrCSpnW
365 stdcall -noname -private StrToIntW(wstr) kernelbase_ros.StrToIntW
366 stdcall -noname -private StrChrIA(str long) kernelbase_ros.StrChrIA
367 stdcall -noname -private StrChrIW(wstr long) kernelbase_ros.StrChrIW
368 stdcall -noname -private StrRChrIA(str str long) kernelbase_ros.StrRChrIA
369 stdcall -noname -private StrRChrIW(wstr wstr long) kernelbase_ros.StrRChrIW
372 stdcall -noname -private StrRStrIA(str str str) kernelbase_ros.StrRStrIA
373 stdcall -noname -private StrRStrIW(wstr wstr wstr) kernelbase_ros.StrRStrIW
374 stdcall -noname -private StrCSpnIA(str str) kernelbase_ros.StrCSpnIA
