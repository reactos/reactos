...
EXTERN ___regs__setjmp:PROC
PUBLIC __setjmp
__setjmp:
    mov ecx, [esp + 4]   /* jmp_buf */
    mov [ecx + 0], ebp   /* jmp_buf.Ebp */
    mov [ecx + 4], ebx   /* jmp_buf.Ebx */
    mov [ecx + 8], edi   /* jmp_buf.Edi */
    mov [ecx + 12], esi  /* jmp_buf.Esi */
    mov [ecx + 16], esp  /* jmp_buf.Esp */
    mov eax, [esp + 0]
    mov [ecx + 20], eax  /* jmp_buf.Eip */
    jmp ___regs__setjmp

EXTERN ___regs__setjmp3:PROC
PUBLIC __setjmp3
__setjmp3:
    mov ecx, [esp + 4]   /* jmp_buf */
    mov [ecx + 0], ebp   /* jmp_buf.Ebp */
