...
@ stdcall -stub AllocateUserPhysicalPagesNuma(long ptr ptr long)
...
@ stdcall BaseGetNamedObjectDirectory() ;wine? BaseGetNamedObjectDirectory(ptr)
...
@ stdcall -stub CancelSynchronousIo(long)
...
@ stdcall -stub -version=0x602+ DisablePredefinedHandleTableInternal(long)
@ stdcall DisableThreadLibraryCalls(long)
@ stdcall DisassociateCurrentThreadFromCallback(ptr) ntdll.TpDisassociateCallback
@ stdcall -stub -version=0x603+ DiscardVirtualMemory(ptr long)
@ stdcall DisconnectNamedPipe(long)
@ stdcall -version=0x603+ DnsHostnameToComputerNameExW(wstr ptr ptr)
...
@ stdcall -stub EventActivityIdControl(long ptr) ;ntdll.EtwEventActivityIdControl
@ stdcall -stub EventEnabled(int64 ptr) ;ntdll.EtwEventEnabled
@ stdcall -stub EventProviderEnabled(int64 long int64) ;ntdll.EtwEventProviderEnabled
@ stdcall -stub EventRegister(ptr ptr ptr ptr) ;ntdll.EtwEventRegister
@ stdcall -stub EventSetInformation(int64 long ptr long) ;ntdll.EtwEventSetInformation
@ stdcall -stub EventUnregister(int64) ;ntdll.EtwEventUnregister
@ stdcall -stub EventWrite(int64 ptr long ptr) ;ntdll.EtwEventWrite
# @ stub EventWriteEx
@ stdcall -stub EventWriteString(int64 long int64 ptr) ;ntdll.EtwEventWriteString
@ stdcall -stub EventWriteTransfer(int64 ptr ptr ptr long ptr) ;ntdll.EtwEventWriteTransfer
...
@ stdcall -stub FindFirstFileNameW(wstr long ptr ptr)
@ stdcall FindFirstFileW(wstr ptr)
@ stdcall FindFirstFreeAce(ptr ptr)
@ stdcall FindFirstStreamW(wstr long ptr long)
@ stdcall FindFirstVolumeW(ptr long)
@ stdcall -stub FindNLSString(long long wstr long wstr long ptr)
@ stdcall -stub FindNLSStringEx(wstr long wstr long wstr long ptr ptr ptr long)
...
@ stub GetCalendar
@ stdcall -version=0x600+ GetCalendarInfoEx(wstr long ptr long ptr long ptr)
...
@ stdcall -version=0x600+ GetConsoleScreenBufferInfoEx(long ptr)
@ stdcall GetConsoleTitleA(ptr long)
@ stdcall GetConsoleTitleW(ptr long)
@ stdcall GetConsoleWindow()
@ stdcall -version=0x600+ GetCurrencyFormatEx(wstr long wstr ptr ptr long)
@ stdcall GetCurrencyFormatW(long long wstr ptr ptr long)
@ stdcall GetCurrentActCtx(ptr)
@ stdcall GetCurrentApplicationUserModelId(ptr wstr)
@ stdcall GetCurrentConsoleFont(long long ptr)
@ stdcall -version=0x600+ GetCurrentConsoleFontEx(long long ptr)
...
@ stdcall -stub GetCurrentProcessorNumberEx(ptr) ;ntdll.RtlGetCurrentProcessorNumberEx
...
@ stdcall -stub -version=0xA00+ GetGeoInfoEx(ptr long ptr long)
...
@ stdcall -version=0x600+ GetNumberFormatEx(wstr long wstr ptr ptr long)
...
@ stdcall GetProcessHeaps(long ptr) ntdll.RtlGetProcessHeaps
...
@ stdcall -stub -version=0xA00+ GetSystemWow64Directory2A(ptr long long)
@ stdcall -stub -version=0xA00+ GetSystemWow64Directory2W(ptr long long)
...
@ stdcall -stub -version=0xA01+ GetTempPath2W(long ptr) ; Win11
@ stdcall -stub -version=0xA01+ GetTempPath2A(long ptr) ; Win11
...
@ stdcall HeapAlloc(long long long)
...
@ stdcall -stub -version=0x602+ InterlockedPushListSListEx(ptr ptr ptr long); ntdll.RtlInterlockedPushListSListEx
...
@ stdcall -stub -version=0xA00+ MapViewOfFile3(long long ptr int64 long long long ptr long)
@ stdcall MapViewOfFileEx(long long long long long ptr)
@ stdcall -stub MapViewOfFileExNuma(long long long long long ptr long)
...
@ stdcall -stub NlsValidateLocale(ptr long)
...
@ stdcall QueryUnbiasedInterruptTime(ptr) QueryUnbiasedInterruptTimePrecise
@ stdcall -version=0xA00+ QueryUnbiasedInterruptTimePrecise(ptr)
...
@ stdcall -stub RemapPredefinedHandleInternal(long long)
...
@ stdcall -stub -version=0x602+ ResolveDelayLoadedAPI(ptr ptr ptr ptr ptr long) ntdll.LdrResolveDelayLoadedAPI
...
@ stdcall -version=0x600+ SetConsoleScreenBufferInfoEx(long ptr)
...
@ stdcall -stub SetCurrentConsoleFontEx(long long ptr)
...
@ stdcall -stub -version=0xA00+ SetStdHandleEx(long long ptr)
...
@ stdcall -stub TraceEvent(int64 ptr) ;ntdll.EtwLogTraceEvent
@ varargs -stub TraceMessage(int64 long ptr long) ;ntdll.EtwTraceMessage
...
@ stdcall -stub -version=0xA00+ UnmapViewOfFile2(long ptr long)
@ stdcall -stub -version=0x602+ UnmapViewOfFileEx(ptr long)
...
@ stdcall -stub -version=0xA00+ VirtualAllocFromApp(ptr long long long)
...
; The following are either not in kernelbase or ignored by wine.
...
@ stdcall GetNlsSectionName(long long long str str long)
...
@ stdcall HeapCreateTagsW(ptr long wstr wstr)
...
@ stdcall NlsConvertIntegerToString(long long long wstr long)
