...
@ stdcall -version=0x502+ SetupDiGetActualModelsSectionA(ptr ptr str long ptr ptr)
@ stdcall -version=0x502+ SetupDiGetActualModelsSectionW(ptr ptr wstr long ptr ptr)
