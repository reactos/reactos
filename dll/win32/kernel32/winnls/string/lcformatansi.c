...
{
  DWORD cp = CP_ACP;
  WCHAR szDec[8], szGrp[8], szCur[16], szIn[128], szOut[128];
  CURRENCYFMTW fmt;
  ...
  if (lpFormat)
  {
    ...
    {
      MultiByteToWideChar(cp, 0, lpFormat->lpCurrencySymbol, -1, szCur, ARRAY_SIZE(szCur));
      fmt.lpCurrencySymbol = szCur;
    }
  }
