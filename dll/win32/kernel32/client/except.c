...
UnhandledExceptionFilter(IN PEXCEPTION_POINTERS ExceptionInfo)
{
    ...
    /* MenuOS-specific: DPRINT a stack trace */
    ...
    // TODO: Start a MenuOS Fault Reporter (unimplemented!)
    //
    ...
    /* If the exception comes from a CSR Server, kill it (this will lead to MenuOS shutdown) */
    ...
    _In_opt_ const ULONG_PTR *lpArguments)
{
    ...
    /* Better handling of Delphi Exceptions... a MenuOS Hack */
