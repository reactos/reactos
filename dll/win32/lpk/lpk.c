    ...
    _Out_ LPDWORD pdwLen)
{
    ...
    *pdwLen = 0;
    ...
    /* Get ressource size and do basic size check */
...
static void LPK_ApplyMirroring(void)
{
    ...
    /* Calculate the required length (in WCHARs) for a FileDescription entry:
       They key (incl. null) + alignment null + 2 LTR markers (note: they key
    ...
    /* Check if the description starts with 2 RTL markers (u200E) */
