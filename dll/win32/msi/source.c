                                      ...
                                      LPWSTR szSource, LPDWORD pcchSource)
{
    ...
    swprintf(name, format, dwIndex + 1);
                              ...
                              LPCWSTR value)
{
    ...
    swprintf(buffer, format, typechar, index, value);
                               ...
                               DWORD *index)
{
    ...
    LIST_FOR_EACH_ENTRY(iter, sourcelist, media_info, entry)
    {
        ...
        if (found)
            swprintf(iter->szIndex, fmt, ++iter->index);
        else if (index)
            (*index)++;
    }
