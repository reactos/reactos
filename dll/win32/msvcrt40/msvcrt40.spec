...
@ cdecl __doserrno()
@ cdecl __fpecode()
@ cdecl __getmainargs(ptr ptr ptr long long)
...
@ cdecl -i386 _inp(long)
@ cdecl -i386 _inpd(long)
@ cdecl -i386 _inpw(long)
...
@ extern atexit MSVCRT_atexit # <-- changing this will kill your cat, understand?
@ cdecl atof(str)
@ cdecl atoi(str)
@ cdecl atol(str)
