/*
 * ReactOS Serbian (Cyrillic) Keyboard layout
...
ROSDATA DEADKEY dead_key[] = {
   { DEADTRANS(0x0433, '\'', 0x0453, 0x0000) },
   { DEADTRANS(0x0413, '\'', 0x0403, 0x0000) },
   { DEADTRANS(0x043a, '\'', 0x045c, 0x0000) },
   { DEADTRANS(0x041a, '\'', 0x040c, 0x0000) },
   { DEADTRANS(L' ',   '\'', '\'',   0x0000) },
   {0, 0}
};
