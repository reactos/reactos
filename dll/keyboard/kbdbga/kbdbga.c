...
ROSDATA VK_TO_WCHARS2 key_to_chars_2mod[] = {
  ...
  { 'Q',         CAPS,   {0x447, 0x427} }, //чЧ
  { 'W',         CAPS,   {0x448, 0x428} }, //шШ
  { 'E',         CAPS,   {0x435, 0x415} }, //еЕ
  { 'R',         CAPS,   {0x440, 0x420} }, //рР
  { 'T',         CAPS,   {0x442, 0x422} }, //тТ
  { 'Y',         CAPS,   {0x44a, 0x42a} }, //ъЪ
  { 'U',         CAPS,   {0x443, 0x423} }, //уУ
  { 'I',         CAPS,   {0x438, 0x418} }, //иИ
  { 'O',         CAPS,   {0x43e, 0x41e} }, //оО
  { 'P',         CAPS,   {0x43f, 0x41f} }, //пП
  { VK_OEM_4,    CAPS,   {0x44f, 0x42f} }, //яЯ
  { VK_OEM_6,    CAPS,   {0x449, 0x429} }, //щЩ

  /* Second letter row Втори ред букви асдфгхйкл ;:'" */
  { 'A',         CAPS,   {0x430, 0x410} }, //аА
  { 'S',         CAPS,   {0x441, 0x421} }, //сС
  { 'D',         CAPS,   {0x434, 0x414} }, //дД
  { 'F',         CAPS,   {0x444, 0x424} }, //фФ
  { 'G',         CAPS,   {0x433, 0x413} }, //гГ
  { 'H',         CAPS,   {0x445, 0x425} }, //хХ
  { 'J',         CAPS,   {0x439, 0x419} }, //йЙ
  { 'K',         CAPS,   {0x43a, 0x41a} }, //кК
  { 'L',         CAPS,   {0x43b, 0x41b} }, //лЛ
  { VK_OEM_1,    NOCAPS, {';', ':'} },
  { VK_OEM_7,    NOCAPS, {'\'','\"'} },


  /* Third letter row Трети ред букви */
  { 'Z',         CAPS,   {0x437, 0x417} }, //зЗ
  { 'X',         CAPS,   {0x436, 0x416} }, //жЖ
  { 'C',         CAPS,   {0x446, 0x426} }, //цЦ
  { 'V',         CAPS,   {0x432, 0x412} }, //вВ
  { 'B',         CAPS,   {0x431, 0x411} }, //бБ
  { 'N',         CAPS,   {0x43d, 0x41d} }, //нН
  { 'M',         CAPS,   {0x43c, 0x41c} }, //мМ
/*  { VK_OEM_COMMA,CAPS,   {0x431, 0x411} }, */
  { VK_OEM_COMMA,   NOCAPS, {',', 0x84} }, //,„
/*  { VK_OEM_PERIOD,CAPS,  {0x44e, 0x42e} }, */
  { VK_OEM_PERIOD,  NOCAPS, {'.', 0x94} }, //.”
/*  { VK_OEM_2,	NOCAPS,    {'.', ','} }, */
  { VK_OEM_2,       NOCAPS,    {'/', '?'} },
