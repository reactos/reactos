/*
 * ReactOS Colemak Keyboard layout
...
ROSDATA VK_TO_WCHARS4 key_to_chars_4mod[] = {
  ...
  { '4',           0,                  {'4',      '$',      0x00a2,   0x00a3  } },
  { '5',           0,                  {'5',      '%',      0x20ac,   0x00a5  } },
  { '7',           CAPLOKALTGR,        {'7',      '&',      0x00f0,   0x00d0  } },
  { '8',           CAPLOKALTGR,        {'8',      '*',      0x00fe,   0x00de  } },
  { '9',           0,                  {'9',      '(',      0x2018,   0x201c  } },
  { '0',           0,                  {'0',      ')',      0x2019,   0x201d  } },
  { VK_OEM_PLUS,   0,                  {'=',      '+',      0x00d7,   0x00f7  } },
  { 'Q',           CAPLOK|CAPLOKALTGR, {'q',      'Q',      0x00e4,   0x00c4  } },
  { 'W',           CAPLOK|CAPLOKALTGR, {'w',      'W',      0x00e5,   0x00c5  } },
  { 'F',           CAPLOK|CAPLOKALTGR, {'f',      'F',      0x00e3,   0x00c3  } },
  { 'P',           CAPLOK|CAPLOKALTGR, {'p',      'P',      0x00f8,   0x00d8  } },
  { 'J',           CAPLOK|CAPLOKALTGR, {'j',      'J',      0x0111,   0x0110  } },
  { 'L',           CAPLOK|CAPLOKALTGR, {'l',      'L',      0x0142,   0x0141  } },
  { 'U',           CAPLOK|CAPLOKALTGR, {'u',      'U',      0x00fa,   0x00da  } },
  { 'Y',           CAPLOK|CAPLOKALTGR, {'y',      'Y',      0x00fc,   0x00dc  } },
  { VK_OEM_1,      CAPLOKALTGR,        {';',      ':',      0x00f6,   0x00d6  } },
  { 'A',           CAPLOK|CAPLOKALTGR, {'a',      'A',      0x00e1,   0x00c1  } },
  { 'S',           CAPLOK|CAPLOKALTGR, {'s',      'S',      0x00df,   0x1e9e  } },
  { 'T',           CAPLOK,             {'t',      'T',      WCH_DEAD, WCH_DEAD} },
  ...
  { VK_OEM_7,      CAPLOKALTGR,        {'\'',     '\"',     0x00f5,   0x00d5  } },
  { VK_OEM_102,    0,                  {'-',      '_',      0x2013,   0x2014  } },
  { 'Z',           CAPLOK|CAPLOKALTGR, {'z',      'Z',      0x00e6,   0x00c6  } },
  { 'C',           CAPLOK|CAPLOKALTGR, {'c',      'C',      0x00e7,   0x00c7  } },
  { 'V',           CAPLOK|CAPLOKALTGR, {'v',      'V',      0x0153,   0x0152  } },
  { 0, 0 }
};

ROSDATA VK_TO_WCHARS5 key_to_chars_5mod[] = {
  /* Normal, Shift, Ctrl+Alt, Shift+Ctrl+Alt, Ctrl */
  { VK_OEM_4,      0,                  {'[',      '{',      0x00ab,   0x2039,   0x001b  } },
  { VK_OEM_6,      0,                  {']',      '}',      0x00bb,   0x203A,   0x001d  } },
  { VK_OEM_5,      0,                  {'\\',     '|',      WCH_DEAD, WCH_NONE, 0x001c  } },
...
ROSDATA VK_TO_WCHARS6 key_to_chars_6mod[] = {
  ...
  { '2',          0,                   {'2',      '@',      0x00ba,   0x00b2,   WCH_NONE, 0x0000  } },
  { '6',          CAPLOKALTGR,         {'6',      '^',      0x0127,   0x0126,   WCH_NONE, 0x001e  } },
...
ROSDATA DEADKEY dead_key[] = {
   ...
   { DEADTRANS(L'o',   0x02dd, 0x0151, 0x0000) }, /* DOUBLE ACUTE */
