 ...
 * Author: \310\230tefan Fulea (stefan dot fulea at mail dot com)
...
ROSDATA VSC_LPWSTR extended_key_names[] =
{
  ...
  { 0x38, L"Alt dreapta" },
  { 0x45, L"Fix. numerice" },
  { 0x46, L"\303\216ntrerupere" },
  { 0x47, L"Acas\304\203" },
  { 0x48, L"Sus" },
  { 0x49, L"Pag. sus" },
  { 0x4b, L"St\303\242nga" },
  { 0x4c, L"Centru" },
  { 0x4d, L"Dreapta" },
  { 0x4f, L"Sf\303\242r\310\231it" },
  { 0x50, L"Jos" },
  { 0x51, L"Pag. jos" },
  { 0x52, L"Inser\310\233ie" },
  { 0x53, L"\310\230tergere" },
  { 0x54, L"Meniu" },
  { 0x56, L"Ajutor" },
  { 0x5b, L"Meniu st\303\242nga" },
...
ROSDATA DEADKEY_LPWSTR dead_key_names[] =
{
    ...
    L"\x0303"   L"Tild\304\203",
    L"\x0306"   L"Breve",
    L"\x0307"   L"Suprapunct",
    L"\x0308"   L"Trem\304\203",
    L"\x030A"   L"Supracerc",
    L"\x030B"   L"Accent acut dublu",
    L"\x030C"   L"Caron",
    L"\x0326"   L"Virgul\304\203",
    L"\x0327"   L"Sedil\304\203",
    L"\x0328"   L"Ogonek",
    NULL
};
