...
@ stdcall -version=0x601+ RtlGetEnabledExtendedFeatures(int64)
...
@ stdcall -version=0x601+ RtlInitializeExtendedContext(ptr long ptr)
...
@ stdcall -version=0x601+ RtlLocateLegacyContext(ptr ptr)
@ stdcall -version=0x601+ RtlLocateExtendedFeature(ptr long ptr)
...
@ stdcall -version=0x601+ RtlSetExtendedFeaturesMask(ptr int64)
