...
@ stdcall NtLockVirtualMemory(ptr ptr ptr long)
...
@ stdcall NtProtectVirtualMemory(ptr ptr ptr long ptr)
...
@ stdcall NtQueryVirtualMemory(ptr ptr long ptr long ptr)
...
@ stdcall NtReadVirtualMemory(ptr ptr ptr long ptr)
...
@ stdcall NtUnlockVirtualMemory(ptr ptr ptr long)
...
@ stdcall NtWriteVirtualMemory(ptr ptr ptr long ptr)
...
@ stdcall ZwLockVirtualMemory(ptr ptr ptr long)
...
@ stdcall ZwReadVirtualMemory(ptr ptr ptr long ptr)
...
@ stdcall ZwUnlockVirtualMemory(ptr ptr ptr long)
...
@ stdcall ZwWriteVirtualMemory(ptr ptr ptr long ptr)
