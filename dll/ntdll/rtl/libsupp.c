...
LONG
(NTAPI *ApisetpRtlCompareUnicodeString)
(IN PCUNICODE_STRING String1, IN PCUNICODE_STRING String2, IN BOOLEAN CaseInSensitive) = RtlCompareUnicodeString;
    ...
    *RedirectedDll = FALSE;
    ...
    else
    {
        ...
        Status = RtlDosApplyFileIsolationRedirection_Ustr(
            RTL_DOS_APPLY_FILE_REDIRECTION_USTR_FLAG_RESPECT_DOT_LOCAL, OriginalName, Extension, StaticString, DynamicString, NewName, NULL, NULL, NULL);
        ...
        else /* Status == STATUS_SXS_KEY_NOT_FOUND */
        {
