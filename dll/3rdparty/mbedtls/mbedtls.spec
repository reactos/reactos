...
@ cdecl mbedtls_cipher_update(ptr ptr long ptr ptr)
@ cdecl mbedtls_cipher_update_ad(ptr ptr long)
@ cdecl mbedtls_cipher_finish(ptr ptr ptr)
...
@ cdecl mbedtls_pk_verify_ext(long ptr ptr long ptr long ptr long)
