...
function(add_d3dx9_target __version)
    ...
    add_importlibs(${module} d3dcompiler_43 d3dxof usp10 user32 ole32 gdi32 msvcrt kernel32_vista kernel32 ntdll)
...
if(CMAKE_C_COMPILER_ID STREQUAL "GNU")
    target_compile_options(${module} PRIVATE -Wno-incompatible-pointer-types -Wno-unused-but-set-variable -Wno-switch -Wno-error) # Our favourite compiler :)
endif()
