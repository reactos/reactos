...
# Which tools to use
find_program(CMAKE_C_COMPILER ${MINGW_TOOLCHAIN_PREFIX}gcc${MINGW_TOOLCHAIN_SUFFIX} REQUIRED)
find_program(CMAKE_CXX_COMPILER ${MINGW_TOOLCHAIN_PREFIX}g++${MINGW_TOOLCHAIN_SUFFIX} REQUIRED)
find_program(CMAKE_ASM_COMPILER ${MINGW_TOOLCHAIN_PREFIX}gcc${MINGW_TOOLCHAIN_SUFFIX} REQUIRED)
set(CMAKE_ASM_COMPILER_ID "GNU")
find_program(CMAKE_MC_COMPILER ${MINGW_TOOLCHAIN_PREFIX}windmc REQUIRED)
find_program(CMAKE_RC_COMPILER ${MINGW_TOOLCHAIN_PREFIX}windres REQUIRED)
find_program(CMAKE_DLLTOOL ${MINGW_TOOLCHAIN_PREFIX}dlltool REQUIRED)
#set(CMAKE_AR ${MINGW_TOOLCHAIN_PREFIX}gcc-ar${MINGW_TOOLCHAIN_SUFFIX})
find_program(CMAKE_OBJCOPY ${MINGW_TOOLCHAIN_PREFIX}objcopy REQUIRED)
