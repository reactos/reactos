...
BUILDNO_HOST_CXXFLAGS = -I$(TOOLS_BASE) -Isdk/include/reactos $(TOOLS_CPPFLAGS)

BUILDNO_HOST_LFLAGS = $(TOOLS_LFLAGS)

BUILDNO_VERSION = sdk$(SEP)include$(SEP)reactos$(SEP)version.h
...
$(BUILDNO_H): $(BUILDNO_TARGET)
	${mkdir} $(INTERMEDIATE_)sdk$(SEP)include$(SEP)reactos 2>$(NUL)
	$(ECHO_BUILDNO)
