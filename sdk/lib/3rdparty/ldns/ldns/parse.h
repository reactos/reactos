 ...
 */
ptrdiff_t ldns_fget_token(FILE *f, char *token, const char *delim, size_t limit);
 ...
 */
ptrdiff_t ldns_fget_token_l(FILE *f, char *token, const char *delim, size_t limit, int *line_nr);
 ...
 */
ptrdiff_t ldns_bget_token(ldns_buffer *b, char *token, const char *delim, size_t limit);
 ...
 */
ptrdiff_t ldns_fget_keyword_data(FILE *f, const char *keyword, const char *k_del, char *data, const char *d_del, size_t data_limit);
 ...
 * \return the number of character read
 */
ptrdiff_t ldns_fget_keyword_data_l(FILE *f, const char *keyword, const char *k_del, char *data, const char *d_del, size_t data_limit, int *line_nr);
 ...
 * \return the number of character read
 */
ptrdiff_t ldns_bget_keyword_data(ldns_buffer *b, const char *keyword, const char *k_del, char *data, const char *d_del, size_t data_limit);
