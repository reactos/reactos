...
//
#ifndef _WDF_V1_7_TYPES_H_
#define _WDF_V1_7_TYPES_H_
...
typedef struct _WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_7 *PWDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_7;
typedef const struct _WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_7 *PCWDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_7;
typedef struct _WDF_REQUEST_FATAL_ERROR_INFORMATION_LENGTH_MISMATCH_DATA_V1_7 *PWDF_REQUEST_FATAL_ERROR_INFORMATION_LENGTH_MISMATCH_DATA_V1_7;
...
typedef struct _WDF_QUEUE_FATAL_ERROR_DATA_V1_7 *PWDF_QUEUE_FATAL_ERROR_DATA_V1_7;
typedef const struct _WDF_QUEUE_FATAL_ERROR_DATA_V1_7 *PCWDF_QUEUE_FATAL_ERROR_DATA_V1_7;
typedef struct _WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_7 *PWDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_7;
typedef const struct _WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_7 *PCWDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_7;
...
typedef struct _WDF_CHILD_RETRIEVE_INFO_V1_7 *PWDF_CHILD_RETRIEVE_INFO_V1_7;
typedef const struct _WDF_CHILD_RETRIEVE_INFO_V1_7 *PCWDF_CHILD_RETRIEVE_INFO_V1_7;
typedef struct _WDF_CHILD_LIST_CONFIG_V1_7 *PWDF_CHILD_LIST_CONFIG_V1_7;
typedef const struct _WDF_CHILD_LIST_CONFIG_V1_7 *PCWDF_CHILD_LIST_CONFIG_V1_7;
typedef struct _WDF_CHILD_LIST_ITERATOR_V1_7 *PWDF_CHILD_LIST_ITERATOR_V1_7;
typedef const struct _WDF_CHILD_LIST_ITERATOR_V1_7 *PCWDF_CHILD_LIST_ITERATOR_V1_7;
typedef struct _WDF_CLASS_EXTENSION_DESCRIPTOR_V1_7 *PWDF_CLASS_EXTENSION_DESCRIPTOR_V1_7;
typedef const struct _WDF_CLASS_EXTENSION_DESCRIPTOR_V1_7 *PCWDF_CLASS_EXTENSION_DESCRIPTOR_V1_7;
typedef struct _WDF_COMMON_BUFFER_CONFIG_V1_7 *PWDF_COMMON_BUFFER_CONFIG_V1_7;
typedef const struct _WDF_COMMON_BUFFER_CONFIG_V1_7 *PCWDF_COMMON_BUFFER_CONFIG_V1_7;
typedef struct _WDF_FILEOBJECT_CONFIG_V1_7 *PWDF_FILEOBJECT_CONFIG_V1_7;
typedef const struct _WDF_FILEOBJECT_CONFIG_V1_7 *PCWDF_FILEOBJECT_CONFIG_V1_7;
typedef struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_7 *PWDF_DEVICE_PNP_NOTIFICATION_DATA_V1_7;
typedef const struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_7 *PCWDF_DEVICE_PNP_NOTIFICATION_DATA_V1_7;
typedef struct _WDF_DEVICE_POWER_NOTIFICATION_DATA_V1_7 *PWDF_DEVICE_POWER_NOTIFICATION_DATA_V1_7;
typedef const struct _WDF_DEVICE_POWER_NOTIFICATION_DATA_V1_7 *PCWDF_DEVICE_POWER_NOTIFICATION_DATA_V1_7;
typedef struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA_V1_7 *PWDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA_V1_7;
typedef const struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA_V1_7 *PCWDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA_V1_7;
typedef struct _WDF_PNPPOWER_EVENT_CALLBACKS_V1_7 *PWDF_PNPPOWER_EVENT_CALLBACKS_V1_7;
typedef const struct _WDF_PNPPOWER_EVENT_CALLBACKS_V1_7 *PCWDF_PNPPOWER_EVENT_CALLBACKS_V1_7;
typedef struct _WDF_POWER_POLICY_EVENT_CALLBACKS_V1_7 *PWDF_POWER_POLICY_EVENT_CALLBACKS_V1_7;
typedef const struct _WDF_POWER_POLICY_EVENT_CALLBACKS_V1_7 *PCWDF_POWER_POLICY_EVENT_CALLBACKS_V1_7;
typedef struct _WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_7 *PWDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_7;
typedef const struct _WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_7 *PCWDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_7;
typedef struct _WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_7 *PWDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_7;
typedef const struct _WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_7 *PCWDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_7;
typedef struct _WDF_DEVICE_STATE_V1_7 *PWDF_DEVICE_STATE_V1_7;
typedef const struct _WDF_DEVICE_STATE_V1_7 *PCWDF_DEVICE_STATE_V1_7;
typedef struct _WDF_DEVICE_PNP_CAPABILITIES_V1_7 *PWDF_DEVICE_PNP_CAPABILITIES_V1_7;
typedef const struct _WDF_DEVICE_PNP_CAPABILITIES_V1_7 *PCWDF_DEVICE_PNP_CAPABILITIES_V1_7;
typedef struct _WDF_DEVICE_POWER_CAPABILITIES_V1_7 *PWDF_DEVICE_POWER_CAPABILITIES_V1_7;
typedef const struct _WDF_DEVICE_POWER_CAPABILITIES_V1_7 *PCWDF_DEVICE_POWER_CAPABILITIES_V1_7;
...
typedef struct _WDF_DPC_CONFIG_V1_7 *PWDF_DPC_CONFIG_V1_7;
typedef const struct _WDF_DPC_CONFIG_V1_7 *PCWDF_DPC_CONFIG_V1_7;
typedef struct _WDF_DRIVER_CONFIG_V1_7 *PWDF_DRIVER_CONFIG_V1_7;
typedef const struct _WDF_DRIVER_CONFIG_V1_7 *PCWDF_DRIVER_CONFIG_V1_7;
typedef struct _WDF_DRIVER_VERSION_AVAILABLE_PARAMS_V1_7 *PWDF_DRIVER_VERSION_AVAILABLE_PARAMS_V1_7;
typedef const struct _WDF_DRIVER_VERSION_AVAILABLE_PARAMS_V1_7 *PCWDF_DRIVER_VERSION_AVAILABLE_PARAMS_V1_7;
typedef struct _WDF_FDO_EVENT_CALLBACKS_V1_7 *PWDF_FDO_EVENT_CALLBACKS_V1_7;
typedef const struct _WDF_FDO_EVENT_CALLBACKS_V1_7 *PCWDF_FDO_EVENT_CALLBACKS_V1_7;
typedef struct _WDF_DRIVER_GLOBALS_V1_7 *PWDF_DRIVER_GLOBALS_V1_7;
typedef const struct _WDF_DRIVER_GLOBALS_V1_7 *PCWDF_DRIVER_GLOBALS_V1_7;
typedef struct _WDF_INTERRUPT_CONFIG_V1_7 *PWDF_INTERRUPT_CONFIG_V1_7;
typedef const struct _WDF_INTERRUPT_CONFIG_V1_7 *PCWDF_INTERRUPT_CONFIG_V1_7;
...
typedef const struct _WDF_IO_QUEUE_CONFIG_V1_7 *PCWDF_IO_QUEUE_CONFIG_V1_7;
typedef struct _WDF_IO_TARGET_OPEN_PARAMS_V1_7 *PWDF_IO_TARGET_OPEN_PARAMS_V1_7;
typedef const struct _WDF_IO_TARGET_OPEN_PARAMS_V1_7 *PCWDF_IO_TARGET_OPEN_PARAMS_V1_7;
typedef struct _WDFMEMORY_OFFSET_V1_7 *PWDFMEMORY_OFFSET_V1_7;
typedef const struct _WDFMEMORY_OFFSET_V1_7 *PCWDFMEMORY_OFFSET_V1_7;
typedef struct _WDF_MEMORY_DESCRIPTOR_V1_7 *PWDF_MEMORY_DESCRIPTOR_V1_7;
typedef const struct _WDF_MEMORY_DESCRIPTOR_V1_7 *PCWDF_MEMORY_DESCRIPTOR_V1_7;
typedef struct _WDF_OBJECT_ATTRIBUTES_V1_7 *PWDF_OBJECT_ATTRIBUTES_V1_7;
typedef const struct _WDF_OBJECT_ATTRIBUTES_V1_7 *PCWDF_OBJECT_ATTRIBUTES_V1_7;
typedef struct _WDF_OBJECT_CONTEXT_TYPE_INFO_V1_7 *PWDF_OBJECT_CONTEXT_TYPE_INFO_V1_7;
typedef const struct _WDF_OBJECT_CONTEXT_TYPE_INFO_V1_7 *PCWDF_OBJECT_CONTEXT_TYPE_INFO_V1_7;
typedef struct _WDF_PDO_EVENT_CALLBACKS_V1_7 *PWDF_PDO_EVENT_CALLBACKS_V1_7;
typedef const struct _WDF_PDO_EVENT_CALLBACKS_V1_7 *PCWDF_PDO_EVENT_CALLBACKS_V1_7;
typedef struct _WDF_QUERY_INTERFACE_CONFIG_V1_7 *PWDF_QUERY_INTERFACE_CONFIG_V1_7;
typedef const struct _WDF_QUERY_INTERFACE_CONFIG_V1_7 *PCWDF_QUERY_INTERFACE_CONFIG_V1_7;
typedef struct _WDF_REQUEST_PARAMETERS_V1_7 *PWDF_REQUEST_PARAMETERS_V1_7;
typedef const struct _WDF_REQUEST_PARAMETERS_V1_7 *PCWDF_REQUEST_PARAMETERS_V1_7;
typedef struct _WDF_REQUEST_COMPLETION_PARAMS_V1_7 *PWDF_REQUEST_COMPLETION_PARAMS_V1_7;
typedef const struct _WDF_REQUEST_COMPLETION_PARAMS_V1_7 *PCWDF_REQUEST_COMPLETION_PARAMS_V1_7;
typedef struct _WDF_REQUEST_REUSE_PARAMS_V1_7 *PWDF_REQUEST_REUSE_PARAMS_V1_7;
typedef const struct _WDF_REQUEST_REUSE_PARAMS_V1_7 *PCWDF_REQUEST_REUSE_PARAMS_V1_7;
typedef struct _WDF_REQUEST_SEND_OPTIONS_V1_7 *PWDF_REQUEST_SEND_OPTIONS_V1_7;
typedef const struct _WDF_REQUEST_SEND_OPTIONS_V1_7 *PCWDF_REQUEST_SEND_OPTIONS_V1_7;
typedef struct _WDF_TIMER_CONFIG_V1_7 *PWDF_TIMER_CONFIG_V1_7;
typedef const struct _WDF_TIMER_CONFIG_V1_7 *PCWDF_TIMER_CONFIG_V1_7;
typedef struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7 *PWDF_USB_REQUEST_COMPLETION_PARAMS_V1_7;
typedef const struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7 *PCWDF_USB_REQUEST_COMPLETION_PARAMS_V1_7;
typedef struct _WDF_USB_CONTINUOUS_READER_CONFIG_V1_7 *PWDF_USB_CONTINUOUS_READER_CONFIG_V1_7;
typedef const struct _WDF_USB_CONTINUOUS_READER_CONFIG_V1_7 *PCWDF_USB_CONTINUOUS_READER_CONFIG_V1_7;
...
typedef struct _WDF_USB_INTERFACE_SETTING_PAIR_V1_7 *PWDF_USB_INTERFACE_SETTING_PAIR_V1_7;
typedef const struct _WDF_USB_INTERFACE_SETTING_PAIR_V1_7 *PCWDF_USB_INTERFACE_SETTING_PAIR_V1_7;
typedef struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_7 *PWDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_7;
typedef const struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_7 *PCWDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_7;
typedef struct _WDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_7 *PWDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_7;
typedef const struct _WDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_7 *PCWDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_7;
typedef struct _WDF_USB_PIPE_INFORMATION_V1_7 *PWDF_USB_PIPE_INFORMATION_V1_7;
typedef const struct _WDF_USB_PIPE_INFORMATION_V1_7 *PCWDF_USB_PIPE_INFORMATION_V1_7;
typedef struct _WDF_WMI_PROVIDER_CONFIG_V1_7 *PWDF_WMI_PROVIDER_CONFIG_V1_7;
typedef const struct _WDF_WMI_PROVIDER_CONFIG_V1_7 *PCWDF_WMI_PROVIDER_CONFIG_V1_7;
typedef struct _WDF_WMI_INSTANCE_CONFIG_V1_7 *PWDF_WMI_INSTANCE_CONFIG_V1_7;
typedef const struct _WDF_WMI_INSTANCE_CONFIG_V1_7 *PCWDF_WMI_INSTANCE_CONFIG_V1_7;
typedef struct _WDF_WORKITEM_CONFIG_V1_7 *PWDF_WORKITEM_CONFIG_V1_7;
typedef const struct _WDF_WORKITEM_CONFIG_V1_7 *PCWDF_WORKITEM_CONFIG_V1_7;
...
} WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_7;
...
} WDF_REQUEST_FATAL_ERROR_INFORMATION_LENGTH_MISMATCH_DATA_V1_7, *PWDF_REQUEST_FATAL_ERROR_INFORMATION_LENGTH_MISMATCH_DATA_V1_7;
...
} WDF_QUEUE_FATAL_ERROR_DATA_V1_7, *PWDF_QUEUE_FATAL_ERROR_DATA_V1_7;
...
} WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_7, *PWDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_7;
...
} WDF_CHILD_ADDRESS_DESCRIPTION_HEADER_V1_7, *PWDF_CHILD_ADDRESS_DESCRIPTION_HEADER_V1_7;
...
} WDF_CHILD_RETRIEVE_INFO_V1_7, *PWDF_CHILD_RETRIEVE_INFO_V1_7;
...
} WDF_CHILD_LIST_CONFIG_V1_7, *PWDF_CHILD_LIST_CONFIG_V1_7;
...
} WDF_CHILD_LIST_ITERATOR_V1_7, *PWDF_CHILD_LIST_ITERATOR_V1_7;
...
} WDF_CLASS_EXTENSION_DESCRIPTOR_V1_7, *PWDF_CLASS_EXTENSION_DESCRIPTOR_V1_7;
...
} WDF_COMMON_BUFFER_CONFIG_V1_7, *PWDF_COMMON_BUFFER_CONFIG_V1_7;
...
} WDF_FILEOBJECT_CONFIG_V1_7, *PWDF_FILEOBJECT_CONFIG_V1_7;
...
} WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_7;
...
} WDF_DEVICE_POWER_NOTIFICATION_DATA_V1_7;
...
} WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA_V1_7;
...
} WDF_PNPPOWER_EVENT_CALLBACKS_V1_7, *PWDF_PNPPOWER_EVENT_CALLBACKS_V1_7;
...
} WDF_POWER_POLICY_EVENT_CALLBACKS_V1_7, *PWDF_POWER_POLICY_EVENT_CALLBACKS_V1_7;
...
} WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_7, *PWDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_7;
...
} WDF_DEVICE_STATE_V1_7, *PWDF_DEVICE_STATE_V1_7;
...
} WDF_DEVICE_PNP_CAPABILITIES_V1_7, *PWDF_DEVICE_PNP_CAPABILITIES_V1_7;
...
} WDF_DEVICE_POWER_CAPABILITIES_V1_7, *PWDF_DEVICE_POWER_CAPABILITIES_V1_7;
...
} WDF_DMA_ENABLER_CONFIG_V1_7, *PWDF_DMA_ENABLER_CONFIG_V1_7;
...
} WDF_DPC_CONFIG_V1_7, *PWDF_DPC_CONFIG_V1_7;
...
} WDF_DRIVER_CONFIG_V1_7, *PWDF_DRIVER_CONFIG_V1_7;
...
} WDF_DRIVER_VERSION_AVAILABLE_PARAMS_V1_7, *PWDF_DRIVER_VERSION_AVAILABLE_PARAMS_V1_7;
...
} WDF_FDO_EVENT_CALLBACKS_V1_7, *PWDF_FDO_EVENT_CALLBACKS_V1_7;
...
} WDF_INTERRUPT_CONFIG_V1_7, *PWDF_INTERRUPT_CONFIG_V1_7;
...
} WDF_IO_TARGET_OPEN_PARAMS_V1_7, *PWDF_IO_TARGET_OPEN_PARAMS_V1_7;
...
} WDFMEMORY_OFFSET_V1_7, *PWDFMEMORY_OFFSET_V1_7;
...
} WDF_MEMORY_DESCRIPTOR_V1_7, *PWDF_MEMORY_DESCRIPTOR_V1_7;
...
} WDF_OBJECT_ATTRIBUTES_V1_7, *PWDF_OBJECT_ATTRIBUTES_V1_7;
...
} WDF_PDO_EVENT_CALLBACKS_V1_7, *PWDF_PDO_EVENT_CALLBACKS_V1_7;
...
} WDF_QUERY_INTERFACE_CONFIG_V1_7, *PWDF_QUERY_INTERFACE_CONFIG_V1_7;
...
} WDF_REQUEST_PARAMETERS_V1_7, *PWDF_REQUEST_PARAMETERS_V1_7;
...
} WDF_REQUEST_COMPLETION_PARAMS_V1_7, *PWDF_REQUEST_COMPLETION_PARAMS_V1_7;
...
} WDF_REQUEST_REUSE_PARAMS_V1_7, *PWDF_REQUEST_REUSE_PARAMS_V1_7;
...
} WDF_REQUEST_SEND_OPTIONS_V1_7, *PWDF_REQUEST_SEND_OPTIONS_V1_7;
...
} WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7, *PWDF_USB_REQUEST_COMPLETION_PARAMS_V1_7;
...
} WDF_USB_CONTINUOUS_READER_CONFIG_V1_7, *PWDF_USB_CONTINUOUS_READER_CONFIG_V1_7;
...
} WDF_USB_DEVICE_INFORMATION_V1_7, *PWDF_USB_DEVICE_INFORMATION_V1_7;
...
} WDF_USB_INTERFACE_SETTING_PAIR_V1_7, *PWDF_USB_INTERFACE_SETTING_PAIR_V1_7;
...
} WDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_7, *PWDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_7;
...
} WDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_7, *PWDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_7;
...
} WDF_USB_PIPE_INFORMATION_V1_7, *PWDF_USB_PIPE_INFORMATION_V1_7;
...
} WDF_WMI_PROVIDER_CONFIG_V1_7, *PWDF_WMI_PROVIDER_CONFIG_V1_7;
...
} WDF_WMI_INSTANCE_CONFIG_V1_7, *PWDF_WMI_INSTANCE_CONFIG_V1_7;
...
} WDF_WORKITEM_CONFIG_V1_7, *PWDF_WORKITEM_CONFIG_V1_7;

// End of versioning of structures for wdfworkitem.h


#endif // _WDF_V1_7_TYPES_H_
