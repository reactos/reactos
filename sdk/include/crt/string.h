...
#define _WSTRING_DEFINED
  ...
  wcspbrk(
    ...
    extern "C++"
    _Check_return_
    inline wchar_t* __cdecl wcspbrk(_In_z_ wchar_t* _Str, _In_z_ wchar_t const* _Control)
    {
        return const_cast<wchar_t*>(wcspbrk(static_cast<wchar_t const*>(_Str), _Control));
    }
#endif // __cplusplus
