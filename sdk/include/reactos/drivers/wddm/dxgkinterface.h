...
typedef
NTSTATUS
DXGADAPTER_CREATESYNCHRONIZATIONOBJECT(_Inout_ PD3DKMT_CREATESYNCHRONIZATIONOBJECT unnamedParam1);

typedef DXGADAPTER_CREATESYNCHRONIZATIONOBJECT *PDXGADAPTER_CREATESYNCHRONIZATIONOBJECT;

typedef
NTSTATUS
DXGADAPTER_DESTROYALLOCATION(_In_ PD3DKMT_DESTROYALLOCATION unnamedParam1);

typedef DXGADAPTER_DESTROYALLOCATION *PDXGADAPTER_DESTROYALLOCATION;

typedef
NTSTATUS
DXGADAPTER_DESTROYCONTEXT(_In_ PD3DKMT_DESTROYCONTEXT unnamedParam1);

typedef DXGADAPTER_DESTROYCONTEXT *PDXGADAPTER_DESTROYCONTEXT;

typedef
NTSTATUS
DXGADAPTER_DESTROYDEVICE(_In_ PD3DKMT_DESTROYDEVICE unnamedParam1);

typedef DXGADAPTER_DESTROYDEVICE *PDXGADAPTER_DESTROYDEVICE;

typedef
NTSTATUS
DXGADAPTER_DESTROYOVERLAY(_In_ PD3DKMT_DESTROYOVERLAY unnamedParam1);

typedef DXGADAPTER_DESTROYOVERLAY *PDXGADAPTER_DESTROYOVERLAY;

typedef
NTSTATUS
DXGADAPTER_DESTROYSYNCHRONIZATIONOBJECT(_In_ PD3DKMT_DESTROYSYNCHRONIZATIONOBJECT unnamedParam1);

typedef DXGADAPTER_DESTROYSYNCHRONIZATIONOBJECT *PDXGADAPTER_DESTROYSYNCHRONIZATIONOBJECT;

typedef
NTSTATUS
DXGADAPTER_ESCAPE(_In_ PD3DKMT_ESCAPE unnamedParam1);

typedef DXGADAPTER_ESCAPE *PDXGADAPTER_ESCAPE;

typedef
NTSTATUS
DXGADAPTER_FLIPOVERLAY(_In_ PD3DKMT_FLIPOVERLAY unnamedParam1);

typedef DXGADAPTER_FLIPOVERLAY *PDXGADAPTER_FLIPOVERLAY;

typedef
NTSTATUS
DXGADAPTER_GETCONTEXTSCHEDULINGPRIORITY(_Inout_ PD3DKMT_GETCONTEXTSCHEDULINGPRIORITY unnamedParam1);

typedef DXGADAPTER_GETCONTEXTSCHEDULINGPRIORITY *PDXGADAPTER_GETCONTEXTSCHEDULINGPRIORITY;

typedef
NTSTATUS
DXGADAPTER_GETDEVICESTATE(_Inout_ PD3DKMT_GETDEVICESTATE unnamedParam1);

typedef DXGADAPTER_GETDEVICESTATE *PDXGADAPTER_GETDEVICESTATE;

typedef
NTSTATUS
DXGADAPTER_GETDISPLAYMODELIST(_Inout_ PD3DKMT_GETDISPLAYMODELIST unnamedParam1);

typedef DXGADAPTER_GETDISPLAYMODELIST *PDXGADAPTER_GETDISPLAYMODELIST;

typedef
NTSTATUS
DXGADAPTER_GETMULTISAMPLEMETHODLIST(_Inout_ PD3DKMT_GETMULTISAMPLEMETHODLIST unnamedParam1);

typedef DXGADAPTER_GETMULTISAMPLEMETHODLIST *PDXGADAPTER_GETMULTISAMPLEMETHODLIST;

typedef
NTSTATUS
DXGADAPTER_GETRUNTIMEDATA(_Inout_ PD3DKMT_GETRUNTIMEDATA unnamedParam1);

typedef DXGADAPTER_GETRUNTIMEDATA *PDXGADAPTER_GETRUNTIMEDATA;

typedef
NTSTATUS
DXGADAPTER_GETSCANLINE(_Inout_ PD3DKMT_GETSCANLINE unnamedParam1);

typedef DXGADAPTER_GETSCANLINE *PDXGADAPTER_GETSCANLINE;

typedef
NTSTATUS
DXGADAPTER_SIGNALSYNCHRONIZATIONOBJECT(_In_ PD3DKMT_SIGNALSYNCHRONIZATIONOBJECT unnamedParam1);

typedef DXGADAPTER_SIGNALSYNCHRONIZATIONOBJECT *PDXGADAPTER_SIGNALSYNCHRONIZATIONOBJECT;

typedef
NTSTATUS
DXGADAPTER_WAITFORVERTICALBLANKEVENT(_In_ PD3DKMT_WAITFORVERTICALBLANKEVENT unnamedParam1);

typedef DXGADAPTER_WAITFORVERTICALBLANKEVENT *PDXGADAPTER_WAITFORVERTICALBLANKEVENT;

typedef
NTSTATUS
DXGADAPTER_WAITFORSYNCHRONIZATIONOBJECT(_In_ PD3DKMT_WAITFORSYNCHRONIZATIONOBJECT unnamedParam1);

typedef DXGADAPTER_WAITFORSYNCHRONIZATIONOBJECT *PDXGADAPTER_WAITFORSYNCHRONIZATIONOBJECT;

typedef
NTSTATUS
DXGADAPTER_SETVIDPNSOURCEOWNER(_In_ PD3DKMT_SETVIDPNSOURCEOWNER unnamedParam1);

typedef DXGADAPTER_SETVIDPNSOURCEOWNER *PDXGADAPTER_SETVIDPNSOURCEOWNER;

typedef
NTSTATUS
DXGADAPTER_WAITFORIDLE(_In_ PD3DKMT_WAITFORIDLE unnamedParam1);

typedef DXGADAPTER_WAITFORIDLE *PDXGADAPTER_WAITFORIDLE;

typedef
NTSTATUS
DXGADAPTER_UPDATEOVERLAY(_In_ PD3DKMT_UPDATEOVERLAY unnamedParam1);

typedef DXGADAPTER_UPDATEOVERLAY *PDXGADAPTER_UPDATEOVERLAY;

typedef
NTSTATUS
DXGADAPTER_SETQUEUEDLIMIT(_In_ PD3DKMT_SETQUEUEDLIMIT unnamedParam1);

typedef DXGADAPTER_SETQUEUEDLIMIT *PDXGADAPTER_SETQUEUEDLIMIT;

typedef
NTSTATUS
DXGADAPTER_SETGAMMARAMP(_In_ PD3DKMT_SETGAMMARAMP unnamedParam1);

typedef DXGADAPTER_SETGAMMARAMP *PDXGADAPTER_SETGAMMARAMP;

typedef
NTSTATUS
DXGADAPTER_SETDISPLAYMODE(_In_ PD3DKMT_SETDISPLAYMODE unnamedParam1);

typedef DXGADAPTER_SETDISPLAYMODE *PDXGADAPTER_SETDISPLAYMODE;

typedef
NTSTATUS
DXGADAPTER_SETDISPLAYPRIVATEDRIVERFORMAT(_In_ PD3DKMT_SETDISPLAYPRIVATEDRIVERFORMAT unnamedParam1);
...
typedef
NTSTATUS
DXGADAPTER_UNLOCK(_In_ PD3DKMT_UNLOCK unnamedParam1);
...
typedef
NTSTATUS
DXGADAPTER_QUERYRESOURCEINFO(_Inout_ PD3DKMT_QUERYRESOURCEINFO unnamedParam1);

typedef DXGADAPTER_QUERYRESOURCEINFO *PDXGADAPTER_QUERYRESOURCEINFO;

typedef
NTSTATUS
DXGADAPTER_GETPRESENTHISTORY(_Inout_ PD3DKMT_GETPRESENTHISTORY unnamedParam1);

typedef DXGADAPTER_GETPRESENTHISTORY *PDXGADAPTER_GETPRESENTHISTORY;

typedef
NTSTATUS
DXGADAPTER_SETALLOCATIONPRIORITY(_In_ PD3DKMT_SETALLOCATIONPRIORITY unnamedParam1);

typedef DXGADAPTER_SETALLOCATIONPRIORITY *PDXGADAPTER_SETALLOCATIONPRIORITY;

typedef
NTSTATUS
DXGADAPTER_INVALIDATEACTIVEVIDPN(_In_ PD3DKMT_INVALIDATEACTIVEVIDPN unnamedParam1);

typedef DXGADAPTER_INVALIDATEACTIVEVIDPN *PDXGADAPTER_INVALIDATEACTIVEVIDPN;

typedef
NTSTATUS
DXGADAPTER_GETSHAREDPRIMARYHANDLE(_In_ PD3DKMT_GETSHAREDPRIMARYHANDLE unnamedParam1);

typedef DXGADAPTER_GETSHAREDPRIMARYHANDLE *PDXGADAPTER_GETSHAREDPRIMARYHANDLE;

typedef
NTSTATUS
DXGADAPTER_LOCK(_In_ PD3DKMT_LOCK unnamedParam1);

typedef DXGADAPTER_LOCK *PDXGADAPTER_LOCK;

typedef
NTSTATUS
DXGADAPTER_POLLDISPLAYCHILDREN(_In_ PD3DKMT_POLLDISPLAYCHILDREN unnamedParam1);

typedef DXGADAPTER_POLLDISPLAYCHILDREN *PDXGADAPTER_POLLDISPLAYCHILDREN;

typedef
NTSTATUS
DXGADAPTER_OPENRESOURCE(_Inout_ PD3DKMT_OPENRESOURCE unnamedParam1);

typedef DXGADAPTER_OPENRESOURCE *PDXGADAPTER_OPENRESOURCE;

typedef
NTSTATUS
DXGADAPTER_PRESENT(_In_ PD3DKMT_PRESENT unnamedParam1);

typedef DXGADAPTER_PRESENT *PDXGADAPTER_PRESENT;

typedef
NTSTATUS
DXGADAPTER_QUERYADAPTERINFO(_Inout_ PD3DKMT_QUERYADAPTERINFO unnamedParam1);

typedef DXGADAPTER_QUERYADAPTERINFO *PDXGADAPTER_QUERYADAPTERINFO;

typedef
NTSTATUS
DXGADAPTER_QUERYALLOCATIONRESIDENCY(_In_ PD3DKMT_QUERYALLOCATIONRESIDENCY unnamedParam1);

typedef DXGADAPTER_QUERYALLOCATIONRESIDENCY *PDXGADAPTER_QUERYALLOCATIONRESIDENCY;

typedef
NTSTATUS
DXGADAPTER_QUERYSTATISTICS(_Inout_ PD3DKMT_QUERYSTATISTICS unnamedParam1);
...
typedef
NTSTATUS
DXGADAPTER_RENDER(_In_ PD3DKMT_RENDER unnamedParam1);

typedef DXGADAPTER_RENDER *PDXGADAPTER_RENDER;

typedef
NTSTATUS
DXGADAPTER_SETCONTEXTSCHEDULINGPRIORITY(_In_ PD3DKMT_SETCONTEXTSCHEDULINGPRIORITY unnamedParam1);
