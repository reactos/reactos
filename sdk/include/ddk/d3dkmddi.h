...
#if (DXGKDDI_INTERFACE_VERSION >= DXGKDDI_INTERFACE_VERSION_WDDM2_1)
typedef VOID* DXGKCB_MULTIPLANEOVERLAYDISABLED;
typedef VOID* DXGKCB_MITIGATEDRANGEUPDATE;
typedef VOID* PDXGKDDI_CHECKMULTIPLANEOVERLAYSUPPORT3;
typedef VOID* PDXGKDDI_SETVIDPNSOURCEADDRESSWITHMULTIPLANEOVERLAY3;
typedef VOID* PDXGKDDI_POSTMULTIPLANEOVERLAYPRESENT;
typedef VOID* PDXGKDDI_VALIDATEUPDATEALLOCATIONPROPERTY;
typedef VOID* PDXGKDDI_CONTROLMODEBEHAVIOR;
typedef VOID* PDXGKDDI_UPDATEMONITORLINKINFO;
#endif

#if (DXGKDDI_INTERFACE_VERSION >= DXGKDDI_INTERFACE_VERSION_WDDM2_2)
typedef VOID* DXGKCB_INVALIDATEHWCONTEXT;
typedef VOID* DXGKCB_INDICATE_CONNECTOR_CHANGE;
typedef VOID* DXGKCB_UNBLOCKUEFIFRAMEBUFFERRANGES;
typedef VOID* PDXGKDDI_CREATEHWCONTEXT;
typedef VOID* PDXGKDDI_DESTROYHWCONTEXT;
typedef VOID* PDXGKDDI_CREATEHWQUEUE;
typedef VOID* PDXGKDDI_DESTROYHWQUEUE;
typedef VOID* PDXGKDDI_SUBMITCOMMANDTOHWQUEUE;
typedef VOID* PDXGKDDI_SWITCHTOHWCONTEXTLIST;
typedef VOID* PDXGKDDI_RESETHWENGINE;
typedef VOID* PDXGKDDI_CREATEPERIODICFRAMENOTIFICATION;
typedef VOID* PDXGKDDI_DESTROYPERIODICFRAMENOTIFICATION;
typedef VOID* PDXGKDDI_SETTIMINGSFROMVIDPN;
typedef VOID* PDXGKDDI_SETTARGETGAMMA;
typedef VOID* PDXGKDDI_SETTARGETCONTENTTYPE;
typedef VOID* PDXGKDDI_SETTARGETANALOGCOPYPROTECTION;
typedef VOID* PDXGKDDI_DISPLAYDETECTCONTROL;
typedef VOID* PDXGKDDI_QUERYCONNECTIONCHANGE;
typedef VOID* PDXGKDDI_GETMULTIPLANEOVERLAYCAPS;
typedef VOID* PDXGKDDI_GETPOSTCOMPOSITIONCAPS;
#endif

#if (DXGKDDI_INTERFACE_VERSION >= DXGKDDI_INTERFACE_VERSION_WDDM2_3)
typedef VOID* DXGKCB_SETPROTECTEDSESSIONSTATUS;
typedef VOID* PDXGKDDI_UPDATEHWCONTEXTSTATE;
typedef VOID* PDXGKDDI_CREATEPROTECTEDSESSION;
typedef VOID* PDXGKDDI_DESTROYPROTECTEDSESSION;
#endif
#endif // _D3DKMDDI_H_
