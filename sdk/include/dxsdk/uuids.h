...
/* ReactOS addition: upstream declares the SampleGrabber coclass in qedit.idl,
   which this tree does not have, so qedit gets its CLSID from here. Kept
   across the wine-10.1-dev resync of this file, and it has to sit inside
   the entry list -- OUR_GUID_ENTRY is #undef-ed below. */
