...
typedef enum _DWM_TAB_WINDOW_REQUIREMENTS {
    DWMTWR_NONE
...
typedef enum _DWMTRANSITION_OWNEDWINDOW_TARGET {
...
DWMAPI DwmShowContact(_In_ DWORD, _In_ DWM_SHOWCONTACT);
DWMAPI DwmTetherContact(DWORD, BOOL, POINT);
DWMPAI DwmTransitionOwnedWindow(HWND, DWMTRANSITION_OWNEDWINDOW_TARGET);
