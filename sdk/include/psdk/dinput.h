...
#ifndef E_PENDING
#define E_PENDING                       __MSABI_LONG(0x8000000AL)
#endif
#define DIERR_INSUFFICIENTPRIVS         __MSABI_LONG(0x80040200L)
#define DIERR_DEVICEFULL                __MSABI_LONG(0x80040201L)
#define DIERR_MOREDATA                  __MSABI_LONG(0x80040202L)
#define DIERR_NOTDOWNLOADED             __MSABI_LONG(0x80040203L)
#define DIERR_HASEFFECTS                __MSABI_LONG(0x80040204L)
#define DIERR_NOTEXCLUSIVEACQUIRED      __MSABI_LONG(0x80040205L)
#define DIERR_INCOMPLETEEFFECT          __MSABI_LONG(0x80040206L)
#define DIERR_NOTBUFFERED               __MSABI_LONG(0x80040207L)
#define DIERR_EFFECTPLAYING             __MSABI_LONG(0x80040208L)
#define DIERR_UNPLUGGED                 __MSABI_LONG(0x80040209L)
#define DIERR_REPORTFULL                __MSABI_LONG(0x8004020AL)
#define DIERR_MAPFILEFAIL               __MSABI_LONG(0x8004020BL)
