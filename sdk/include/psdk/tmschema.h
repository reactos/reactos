...
BEGIN_TM_CLASS_PARTS(AEROWIZARD)
    TM_PART(1, AW, TITLEBAR)
    TM_PART(2, AW, HEADERAREA)
    TM_PART(3, AW, CONTENTAREA)
    TM_PART(4, AW, COMMANDAREA)
    TM_PART(5, AW, BUTTON)
END_TM_CLASS_PARTS()

BEGIN_TM_PART_STATES(AEROWIZARD_TITLEBAR)
    TM_STATE(1, AW_S_TITLEBAR, ACTIVE)
    TM_STATE(2, AW_S_TITLEBAR, INACTIVE)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(AEROWIZARD_HEADERAREA)
    TM_STATE(1, AW_S_HEADERAREA, NOMARGIN)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(AEROWIZARD_CONTENTAREA)
    TM_STATE(1, AW_S_CONTENTAREA, NOMARGIN)
END_TM_PART_STATES()

/* TEXTSTYLE class */
BEGIN_TM_CLASS_PARTS(TEXTSTYLE)
    TM_PART(1, TEXT, MAININSTRUCTION)
    TM_PART(2, TEXT, INSTRUCTION)
    TM_PART(3, TEXT, BODYTITLE)
    TM_PART(4, TEXT, BODYTEXT)
    TM_PART(5, TEXT, SECONDARYTEXT)
    TM_PART(6, TEXT, HYPERLINKTEXT)
    TM_PART(7, TEXT, EXPANDED)
    TM_PART(8, TEXT, LABEL)
    TM_PART(9, TEXT, CONTROLLABEL)
END_TM_CLASS_PARTS()

BEGIN_TM_PART_STATES(TEXTSTYLE_HYPERLINKTEXT)
    TM_STATE(1, TS_HYPERLINK, NORMAL)
    TM_STATE(2, TS_HYPERLINK, HOT)
    TM_STATE(3, TS_HYPERLINK, PRESSED)
    TM_STATE(4, TS_HYPERLINK, DISABLED)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(TEXTSTYLE_CONTROLLABEL)
    TM_STATE(1, TS_CONTROLLABEL, NORMAL)
    TM_STATE(2, TS_CONTROLLABEL, DISABLED)
END_TM_PART_STATES()

/* TASKDIALOG class */
BEGIN_TM_CLASS_PARTS(TASKDIALOG)
    TM_PART(1, TDLG, PRIMARYPANEL)
    TM_PART(2, TDLG, MAININSTRUCTIONPANE)
    TM_PART(3, TDLG, MAINICON)
    TM_PART(4, TDLG, CONTENTPANE)
    TM_PART(5, TDLG, CONTENTICON)
    TM_PART(6, TDLG, EXPANDEDCONTENT)
    TM_PART(7, TDLG, COMMANDLINKPANE)
    TM_PART(8, TDLG, SECONDARYPANEL)
    TM_PART(9, TDLG, CONTROLPANE)
    TM_PART(10, TDLG, BUTTONSECTION)
    TM_PART(11, TDLG, BUTTONWRAPPER)
    TM_PART(12, TDLG, EXPANDOTEXT)
    TM_PART(13, TDLG, EXPANDOBUTTON)
    TM_PART(14, TDLG, VERIFICATIONTEXT)
    TM_PART(15, TDLG, FOOTNOTEPANE)
    TM_PART(16, TDLG, FOOTNOTEAREA)
    TM_PART(17, TDLG, FOOTNOTESEPARATOR)
    TM_PART(18, TDLG, EXPANDEDFOOTERAREA)
    TM_PART(19, TDLG, PROGRESSBAR)
    TM_PART(20, TDLG, IMAGEALIGNMENT)
    TM_PART(21, TDLG, RADIOBUTTONPANE)
END_TM_CLASS_PARTS()

BEGIN_TM_PART_STATES(TASKDIALOG_CONTENTPANE)
    TM_STATE(1, TDLGCPS, STANDALONE)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(TASKDIALOG_EXPANDOBUTTON)
    TM_STATE(1, TDLGEBS, NORMAL)
    TM_STATE(2, TDLGEBS, HOVER)
    TM_STATE(3, TDLGEBS, PRESSED)
    TM_STATE(4, TDLGEBS, EXPANDEDNORMAL)
    TM_STATE(5, TDLGEBS, EXPANDEDHOVER)
    TM_STATE(6, TDLGEBS, EXPANDEDPRESSED)
END_TM_PART_STATES()
