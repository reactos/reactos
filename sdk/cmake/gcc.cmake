...
function(set_subsystem MODULE SUBSYSTEM)
    if(REACTOS_LD_IS_LLD AND "${SUBSYSTEM}" STREQUAL "10")
        set(_subsystem efi_application)
    else()
        set(_subsystem ${SUBSYSTEM})
    endif()
    target_link_options(${MODULE} PRIVATE "-Wl,--subsystem,${_subsystem}:5.01")
endfunction()
...
function(set_module_type_toolchain MODULE TYPE)
    ...
    set(_reactos_crt_stack_probe_modules ntdll ntoskrnl ntkrnlmp)
    if(CMAKE_C_COMPILER_ID STREQUAL "Clang" AND NOT "${MODULE}" IN_LIST _reactos_crt_stack_probe_modules)
...
execute_process(COMMAND ${GXX_EXECUTABLE} ${CLANG_TARGET_ARGS} -print-file-name=libwinpthread.a OUTPUT_VARIABLE LIBWINPTHREAD_LOCATION)
...
execute_process(COMMAND ${GXX_EXECUTABLE} ${CLANG_TARGET_ARGS} -print-file-name=libmingwex.a OUTPUT_VARIABLE LIBMINGWEX_LOCATION)
...
execute_process(COMMAND ${GXX_EXECUTABLE} ${CLANG_TARGET_ARGS} -print-file-name=libgcc_eh.a OUTPUT_VARIABLE _LIBGCC_EH_PATH OUTPUT_STRIP_TRAILING_WHITESPACE)
