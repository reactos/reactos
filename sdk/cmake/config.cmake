...
set(TARGET_VERSION XP CACHE STRING "The Windows platform version to target. Valid values are win10 win8.1 win8 win7 vista xp. Defaults to xp.")
...
elseif(TARGET_VERSION STREQUAL "win8")
    set(SPEC_FILE_VERSION 0x602)
    set(TARGET_IE_VERSION_SYMBOL _WN32_IE_IE100)
    set(TARGET_NTDDI_VERSION_SYMBOL NTDDI_WIN8)
elseif(TARGET_VERSION STREQUAL "win7")
    set(SPEC_FILE_VERSION 0x601)
    set(TARGET_IE_VERSION_SYMBOL _WN32_IE_IE80)
    set(TARGET_NTDDI_VERSION_SYMBOL NTDDI_WIN7)
elseif(TARGET_VERSION STREQUAL "vista")
    set(SPEC_FILE_VERSION 0x600)
    set(TARGET_VERSION_SYMBOL _WIN32_WINNT_LONGHORN)
    set(TARGET_IE_VERSION_SYMBOL _WN32_IE_IE70)
    set(TARGET_NTDDI_VERSION_SYMBOL NTDDI_LONGHORN)
else()
    if(NOT TARGET_VERSION STREQUAL "xp" AND NOT TARGET_VERSION STREQUAL "")
        message(WARNING "Unrecognized target version; defaulting to Windows XP")
    endif()

    set(SPEC_FILE_VERSION 0x0502)
<<<<<<< HEAD
    set(TARGET_IE_VERSION_SYMBOL _WN32_IE_IE70)
    set(TARGET_VERSION_SYMBOL _WIN32_WINNT_WS03)
    set(TARGET_NTDDI_VERSION_SYMBOL NTDDI_WS03)
=======
    set(TARGET_IE_VERSION_SYMBOL _WIN32_IE_WS03SP1)
    set(TARGET_VERSION_SYMBOL _WIN32_WINNT_WS03)
    set(TARGET_NTDDI_VERSION_SYMBOL NTDDI_WS03SP1)
>>>>>>> fc8a434cc2 ([CMAKE] Parameterize target OS version)
endif()
