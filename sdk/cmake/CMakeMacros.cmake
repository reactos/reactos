...
function(enable_unity_build _target_name _pch _source_variable_name)
    set(_source_files ${${_source_variable_name}})
    list(REMOVE_ITEM _source_files ${_pch})
    ...
    if(_last_argument STREQUAL "UNITY_DEBUGCHANNELS_COMPAT")
        file(APPEND ${_temp_unity_build_file} "#define _UNITY_FORWARD_DEBUG_CHANNELS_\n")
        foreach(_source_file ${_source_files})
            list(FIND _source_files ${_source_file} _file_index)
            file(APPEND ${_temp_unity_build_file} "\n#define __wine_dbch___default __wine_dbch___default_${_file_index}\n")
            file(APPEND ${_temp_unity_build_file} "#include <${_source_file}>\n")
            file(APPEND ${_temp_unity_build_file} "#undef __wine_dbch___default\n")
        endforeach()
    else()
        foreach(_source_file ${_source_files})
            file(APPEND ${_temp_unity_build_file} "#include <${_source_file}>\n")
