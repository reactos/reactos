    ...
    _In_ PE100_ADAPTER Adapter)
{
    ...
    /* This also clears the wakeup filters on some chips */
    EeSoftReset(Adapter, FALSE);
...
EeBuildFrameSignature(
    ...
    _In_reads_bytes_(PatternSize) const UCHAR* PatternMask,
    _In_reads_bytes_opt_(PatternSize) const UCHAR* PatternData)
{
    ULONG i, j = 0, Crc = 0;
