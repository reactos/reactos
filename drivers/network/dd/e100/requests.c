    ...
    *BytesNeeded = 0;
    ...
    if (Adapter->Flags & E100_FLAG_CSUM_OFFLOAD)
    {
        ...
        else
        {
            ...
            // We need to know what revisions are actually affected.
            // A software workaround would be too expensive than not using
    ...
    _Out_ PULONG BytesNeeded)
{
    ...
    switch (Oid)
    {
        ...
        {
            static const CHAR VendorDesc[] = "Intel 8255x compatible Ethernet Controller";
            InfoPtr = VendorDesc;
