...
typedef struct _E100_COALESCE_BUFFER
{
    ...
    ULONG Flags;
#define E100_BUFFER_FLAG_HAS_MEMORY    0x00000001
...
typedef struct _E100_RX_CONTEXT
{
    ...
    ULONG RfdPhys;
    ULONG Flags;
#define E100_RX_FLAG_HAS_MEMORY 0x00000001
...
typedef struct _E100_SHARED_MEMORY_METADATA
{
    ULONG BlockSize;
    USHORT VirtOffset;
    USHORT PhysOffset;
#if DBG
    ULONG Signature;
#define E100_SHARED_MEMORY_SIGNATURE     0xBA5EBA5E
#endif
} E100_SHARED_MEMORY_METADATA, *PE100_SHARED_MEMORY_METADATA;
