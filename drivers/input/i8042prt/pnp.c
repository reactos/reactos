    ...
    IN PPORT_DEVICE_EXTENSION DeviceExtension)
{
    ...
    /* re-enable the mouse after disabling data reporting*/
    i8042IsrWritePort(DeviceExtension, MOU_ENABLE, CTRL_WRITE_MOUSE);
