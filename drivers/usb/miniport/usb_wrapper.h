...
void NTAPI RegisterPortDriver(PDRIVER_OBJECT, PUSBPORT_INTERFACE);

/*#ifndef _snprintf
int _snprintf(char * buf, size_t cnt, const char *fmt, ...);
#endif
#ifndef sprintf
int __dllimport sprintf(char * buf, const char *fmt, ...);
#endif
#ifndef swprintf
int __dllimport swprintf(wchar_t *buf, const wchar_t *fmt, ...);
#endif*/
