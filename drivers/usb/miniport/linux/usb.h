...
extern struct usb_device NTAPI *usb_alloc_dev(struct usb_device *parent, struct usb_bus *);
extern struct usb_device NTAPI *usb_get_dev(struct usb_device *dev);
extern void NTAPI usb_put_dev(struct usb_device *dev);
...
extern int NTAPI usb_disabled(void);
...
extern void NTAPI usb_init_urb(struct urb *urb);
extern struct urb NTAPI *usb_alloc_urb(int iso_packets, int mem_flags);
extern void NTAPI usb_free_urb(struct urb *urb);
#define usb_put_urb usb_free_urb
extern struct urb NTAPI *usb_get_urb(struct urb *urb);
extern int NTAPI usb_submit_urb(struct urb *urb, int mem_flags);
extern int NTAPI usb_unlink_urb(struct urb *urb);
