 ...
 */
void NTAPI usb_init_urb(struct urb *urb)
{
	if (urb) {
 ...
 */
struct urb NTAPI *usb_alloc_urb(int iso_packets, int mem_flags)
{
	struct urb *urb;
 ...
 * done elsewhere.
 */
void NTAPI usb_free_urb(struct urb *urb)
{
	if (urb)
 ...
 */
struct urb NTAPI * usb_get_urb(struct urb *urb)
{
	if (urb) {
 ...
 *
 */
int NTAPI usb_submit_urb(struct urb *urb, int mem_flags)
{
	int			pipe, temp, max;
 ...
 */
int NTAPI usb_unlink_urb(struct urb *urb)
{
