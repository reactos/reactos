...
extern void NTAPI usb_hcd_giveback_urb (struct usb_hcd *hcd, struct urb *urb, struct pt_regs *regs);
extern void NTAPI usb_bus_init (struct usb_bus *bus);
extern void usb_rh_status_dequeue (struct usb_hcd *hcd, struct urb *urb);

#ifdef CONFIG_PCI
struct pci_dev;
struct pci_device_id;
extern int NTAPI usb_hcd_pci_probe (struct pci_dev *dev,
				const struct pci_device_id *id);
extern void NTAPI usb_hcd_pci_remove (struct pci_dev *dev);
...
extern void NTAPI usb_hc_died (struct usb_hcd *hcd);

/* -------------------------------------------------------------------------- */

/* Enumeration is only for the hub driver, or HCD virtual root hubs */
extern int usb_new_device(struct usb_device *dev, struct device *parent);
extern void NTAPI usb_connect(struct usb_device *dev);
...
extern void NTAPI usb_claim_bandwidth (struct usb_device *dev, struct urb *urb,
		int bustime, int isoc);
extern void NTAPI usb_release_bandwidth (struct usb_device *dev, struct urb *urb,
		int isoc);
...
extern int NTAPI usb_check_bandwidth (struct usb_device *dev, struct urb *urb);
...
extern long NTAPI usb_calc_bus_time (int speed, int is_input,
			int isoc, int bytecount);

/*-------------------------------------------------------------------------*/

extern struct usb_bus NTAPI *usb_alloc_bus (struct usb_operations *);
extern void NTAPI usb_free_bus (struct usb_bus *);

extern void NTAPI usb_register_bus (struct usb_bus *);
extern void NTAPI usb_deregister_bus (struct usb_bus *);

extern int NTAPI usb_register_root_hub (struct usb_device *usb_dev,
