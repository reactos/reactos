 ...
 * separately managed.
 */
void NTAPI usb_bus_init (struct usb_bus *bus)
{
 ...
 */
struct usb_bus NTAPI *usb_alloc_bus (struct usb_operations *op)
{
	struct usb_bus *bus;
 ...
 * accessible.
 */
void NTAPI usb_free_bus (struct usb_bus *bus)
{
	if (!bus)
		return;
 ...
 */
void NTAPI usb_register_bus(struct usb_bus *bus)
{
	int busnum;
 ...
 */
void NTAPI usb_deregister_bus (struct usb_bus *bus)
{
 ...
 * usb device.
 */
int NTAPI usb_register_root_hub (struct usb_device *usb_dev, struct device *parent_dev)
{
	int retval;
 ...
 */
long NTAPI usb_calc_bus_time (int speed, int is_input, int isoc, int bytecount)
{
	unsigned long	tmp;
 ...
 */
int NTAPI usb_check_bandwidth (struct usb_device *dev, struct urb *urb)
{
 ...
 */
void NTAPI usb_claim_bandwidth (struct usb_device *dev, struct urb *urb, int bustime, int isoc)
{
 ...
 * periodic schedule.
 */
void NTAPI usb_release_bandwidth (struct usb_device *dev, struct urb *urb, int isoc)
{
 ...
 */
void NTAPI usb_hcd_giveback_urb (struct usb_hcd *hcd, struct urb *urb, struct pt_regs *regs)
{
	urb_unlink (urb);
 ...
 */
void NTAPI usb_hc_died (struct usb_hcd *hcd)
{
