...
#if (FX_CORE_MODE == FX_CORE_KERNEL_MODE)
    //
    // NOTE: WDF_REMOVE_LOCK_OPTION_ACQUIRE_FOR_IO contains in WDF 1.11
    //
    /*
...

{
    ...
    //
    // NOTE: Is WDFCXDEVICE_INIT in WDF 1.9 ?
    //
    //
    ...
    )
{
    ...
    {
        pPkgPdo->RegisterCallbacks((PWDF_PNPPOWER_EVENT_CALLBACKS)&DeviceInit->Pdo.EventCallbacks);
    }
    ...
    )
{
    ...
    if (NT_SUCCESS(status))
    {
        ...
        // WDF 1.9 FX_DRIVERS_GLOBALS not cotains RemoveLockOptionFlags
