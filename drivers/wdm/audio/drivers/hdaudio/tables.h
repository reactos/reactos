...
NTSTATUS NTAPI PropertyHandler_InputVolume(IN PPCPROPERTY_REQUEST PropertyRequest);
NTSTATUS NTAPI PropertyHandler_OutputVolume(IN PPCPROPERTY_REQUEST PropertyRequest);
NTSTATUS NTAPI PropertyHandler_InputMute(IN PPCPROPERTY_REQUEST PropertyRequest);
NTSTATUS NTAPI PropertyHandler_OutputMute(IN PPCPROPERTY_REQUEST PropertyRequest);
...
static PCPROPERTY_ITEM VolumeInProperty[] = 
{
    {
        &KSPROPSETID_Audio,
        KSPROPERTY_AUDIO_VOLUMELEVEL,
        KSPROPERTY_TYPE_GET | KSPROPERTY_TYPE_SET | KSPROPERTY_TYPE_BASICSUPPORT,
        PropertyHandler_InputVolume
    }
};

static PCPROPERTY_ITEM MuteInProperty[] = 
{
    {
        &KSPROPSETID_Audio,
        KSPROPERTY_AUDIO_MUTE,
        KSPROPERTY_TYPE_GET | KSPROPERTY_TYPE_SET | KSPROPERTY_TYPE_BASICSUPPORT,
        PropertyHandler_InputMute
    }
};
...
static PCAUTOMATION_TABLE VolumeInAutomationTable[] =
{
    {
...
static PCAUTOMATION_TABLE MuteInAutomationTable[] =
{
    {
        sizeof(PCPROPERTY_ITEM),
        1,
...
static PCPROPERTY_ITEM VolumeOutProperty[] = 
{
    {
        &KSPROPSETID_Audio,
        KSPROPERTY_AUDIO_VOLUMELEVEL,
        KSPROPERTY_TYPE_GET | KSPROPERTY_TYPE_SET | KSPROPERTY_TYPE_BASICSUPPORT,
        PropertyHandler_OutputVolume
    }
};

static PCPROPERTY_ITEM MuteOutProperty[] = 
{
    {
        &KSPROPSETID_Audio,
        KSPROPERTY_AUDIO_MUTE,
        KSPROPERTY_TYPE_GET | KSPROPERTY_TYPE_SET | KSPROPERTY_TYPE_BASICSUPPORT,
        PropertyHandler_OutputMute
    }
};

static PCAUTOMATION_TABLE VolumeOutAutomationTable[] =
{
    {
        sizeof(PCPROPERTY_ITEM),
        1,
...
static PCAUTOMATION_TABLE MuteOutAutomationTable[] =
{
    {
        sizeof(PCPROPERTY_ITEM),
        1,
...
static PCNODE_DESCRIPTOR TopoInNodes[] = {{0, VolumeInAutomationTable, &KSNODETYPE_VOLUME, &KSNODETYPE_MICROPHONE},
	                                      {0, MuteInAutomationTable, &KSNODETYPE_MUTE, &KSNODETYPE_MICROPHONE}};

static PCNODE_DESCRIPTOR TopoOutNodes[] = {{0, VolumeOutAutomationTable, &KSNODETYPE_VOLUME, &KSAUDFNAME_MASTER_VOLUME},
	                                       {0, MuteOutAutomationTable, &KSNODETYPE_MUTE, &KSAUDFNAME_MASTER_MUTE}};
...
static PCCONNECTION_DESCRIPTOR TopoInConnections[] = {{KSFILTER_NODE, 1, 0, 1}, {0, 0, 1, 1}, {1, 0, KSFILTER_NODE, 0}};
...
static PCPIN_DESCRIPTOR WaveInPins[] =
{
    ...
    {   // Pin 1 -- WaveIn Bridge
        ...
        {       // KsPinDescriptor
            ...
            0,                                          // MediumsCount
            NULL,                                       // Mediums
            SIZEOF_ARRAY(DataRangesBridge),             // DataRangesCount
...
static PCFILTER_DESCRIPTOR WaveInFilterDescription[] =
{
    ...
    SIZEOF_ARRAY(WaveInPins),           // PinCount
    WaveInPins,                         // Pins
    sizeof(PCNODE_DESCRIPTOR),          // NodeSize
    SIZEOF_ARRAY(AdcNode),              // NodeCount
    AdcNode,                            // Nodes
    SIZEOF_ARRAY(AdcConnections),       // ConnectionCount
...
static PCFILTER_DESCRIPTOR WaveOutFilterDescription[] =
{
    ...
    NULL,                               // AutomationTable
    sizeof(PCPIN_DESCRIPTOR),           // PinSize
    SIZEOF_ARRAY(WaveOutPins),          // PinCount
    WaveOutPins,                        // Pins
    sizeof(PCNODE_DESCRIPTOR),          // NodeSize
    SIZEOF_ARRAY(DacNode),              // NodeCount
    DacNode,                            // Nodes
    SIZEOF_ARRAY(DacConnections),       // ConnectionCount
...
static PCFILTER_DESCRIPTOR TopoInFilterDescription[] =
{
    ...
    sizeof(PCPIN_DESCRIPTOR),           // PinSize
    SIZEOF_ARRAY(TopoInPins),           // PinCount
    TopoInPins,                         // Pins
    sizeof(PCNODE_DESCRIPTOR),          // NodeSize
    SIZEOF_ARRAY(TopoInNodes),          // NodeCount
    TopoInNodes,                        // Nodes
    SIZEOF_ARRAY(TopoInConnections),    // ConnectionCount
...
static PCFILTER_DESCRIPTOR TopoOutFilterDescription[] =
{
    ...
    &TopologyAutomationTable,           // AutomationTable
    sizeof(PCPIN_DESCRIPTOR),           // PinSize
    SIZEOF_ARRAY(TopoOutPins),          // PinCount
    TopoOutPins,                        // Pins
    sizeof(PCNODE_DESCRIPTOR),          // NodeSize
    SIZEOF_ARRAY(TopoOutNodes),         // NodeCount
    TopoOutNodes,                       // Nodes
    SIZEOF_ARRAY(TopoOutConnections),   // ConnectionCount
