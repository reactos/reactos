...
{
    USHORT AddressSetup; // t1
    /* Register transfers (8-bit) */
    USHORT CmdActive;    // t2
    USHORT CmdRecovery;  // t2i
    /* PIO data transfers (16-bit) */
    USHORT DataActive;   // t2
    USHORT DataRecovery; // t2i
} ATA_TIMING, *PATA_TIMING;

#define SHARED_ADDR_TIMINGS  0x00000001
#define SHARED_CMD_TIMINGS   0x00000002
