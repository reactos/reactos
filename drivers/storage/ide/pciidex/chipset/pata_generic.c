    ...
    _In_ PCHANNEL_DATA_PATA ChanData)
{
    ...
    if (!(Controller->Flags & CTRL_FLAG_IS_SIMPLEX) && PciIdeControllerIsSimplex(IoBase))
    ...
    _In_ ULONG Channel)
{
    ...
    {
        //if (Controller->Flags & CTRL_FLAG_USE_TEST_FUNCTION) TODO Not used yet
        //{
    ...
    _Inout_ PATA_CONTROLLER Controller)
{
    ...
    INFO("Using generic PCI IDE minidriver\n");
