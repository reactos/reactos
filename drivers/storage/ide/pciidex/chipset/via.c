...
#define VT6421A_REG_SATA_CTRL             0x52
    ...
    _In_ PCM_RESOURCE_LIST ResourcesTranslated)
{
    ...
    /*
     * [BAR 0]: I/O ports at E150 [size=16]
     * [BAR 1]: I/O ports at E140 [size=16]
     * [BAR 2]: I/O ports at E130 [size=16]
     * [BAR 3]: I/O ports at E120 [size=16]
     * [BAR 4]: I/O ports at E100 [size=32]
     * [BAR 5]: I/O ports at E000 [size=256]
     */
    ...
    _In_ PPCI_COMMON_HEADER PciConfig)
{
    ...
    for (i = 0; i < RTL_NUMBER_OF(ViaBridgeList); ++i)
    {
        if ((PciConfig->DeviceID == ViaBridgeList[i].DeviceID) &&
            (PciConfig->RevisionID >= ViaBridgeList[i].RevisionID))
        {
