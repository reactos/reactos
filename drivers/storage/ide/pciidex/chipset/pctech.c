/*
 * PROJECT:     ReactOS Bus Port Driver
...
#define CONFIG_PREFETCH     0x00002000
    ...
    _In_ PATA_CONTROLLER Controller)
{
    ...
    PciRead(Controller, &ConfigReg, REG_CONFIG, sizeof(ConfigReg));
    ConfigReg &= ~CONFIG_PREFETCH;
    PciWrite(Controller, &ConfigReg, REG_CONFIG, sizeof(ConfigReg));
}
