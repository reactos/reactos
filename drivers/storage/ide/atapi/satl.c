...
const UCHAR AtapAtaCommandMap[12][2] =
{
    /* Write EXT                          Read EXT */
    ...
    _In_ PATA_DEVICE_REQUEST Request)
{
    ...
    /* The ABORT bit has low priority */
...
AtaReqBuildIdentifyCommand(
    ...
    _In_ PATA_DEVICE_REQUEST Request)
{
    Request->Flags = REQUEST_FLAG_DATA_IN | REQUEST_FLAG_SYNC_MODE | REQUEST_FLAG_EXCLUSIVE;
