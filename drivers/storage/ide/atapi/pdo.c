    ...
    _In_ PIO_STACK_LOCATION IoStack)
{
    ...
    switch (IoStack->Parameters.QueryId.IdType)
    {
        ...
        case BusQueryInstanceID:
        {
             ...
             * (for example, Miniscribe 8051A https://www.os2museum.com/wp/identify-ancient-drive/),
             * IDENTIFY DEVICE words 7-255 are reserved and filled with zeros.
             * The system will bugcheck in the PNP manager if we do not handle this correctly.
             */
            if (AtaPdoIsSerialNumberValid(DevExt))
            {
                /*
                 * Return the serial number in string form
                 * '42562d3131303066333036662020202020202020'.
                 */
