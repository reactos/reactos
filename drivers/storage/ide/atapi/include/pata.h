...
#define ATA_TIME_BUSY_ENUM      1000    ///< 10 ms
...
{
#if defined(_M_IX86)
    if ((PortData->PortFlags & PORT_FLAG_CBUS_IDE) && (PortData->Pata.LastTargetId != TargetId))
    {
        PortData->Pata.LastTargetId = TargetId;
        ATA_SELECT_BANK(TargetId >> 1);
    }
#endif
