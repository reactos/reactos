    ...
    _In_ PATAPORT_PORT_DATA PortData)
{
    ...
    for (i = 0; i < MAX_IDE_DEVICE; ++i)
    {
        ...
        DevExt = AtaFdoFindDeviceByPath(PortData->ChanExt,
        ...
        Success = AtaTimFindMode(DevExt->TransferModeSupportedBitmap,
                                 ...
                                 &BestMode);
        /*
         * For example, the first _GTM call on VPC 2007 will return
         ...
         *   53 = 0x0003 51 = 0x0200 64 = 0x0003 88 = 0x0000 62 = 0x0007
         *   63 = 0x0407 65 = 120    66 = 120    67 = 508    68 = 180
