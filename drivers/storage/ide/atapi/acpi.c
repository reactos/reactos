    ...
    _In_ ULONG OutputBufferLength)
{
    ...
    /* Submit a synchronous evaluation request */
    ...
    _In_ PIDENTIFY_DEVICE_DATA IdBlock2)
{
    ...
    InputBuffer = ExAllocatePoolUninitialized(PagedPool, InputSize, ATAPORT_TAG);
    if (!InputBuffer)
    {
    ...
    _In_ PATAPORT_DEVICE_EXTENSION DevExt)
{
    ...
    {
        OutputBuffer = ExAllocatePoolZero(PagedPool, OutputSize, ATAPORT_TAG);
        if (!OutputBuffer)
        {
