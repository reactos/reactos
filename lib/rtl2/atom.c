                     ...
                     PUSHORT AtomValue)
{
   ...
   DPRINT("RtlpCheckIntegerAtom(AtomName=%p AtomValue=%p)\n", AtomName, AtomValue);
                      ...
                      OUT PRTL_ATOM Atom)
{
   ...
   DPRINT("RtlAddAtomToAtomTable (AtomTable %p AtomName %p Atom %p)\n", AtomTable, AtomName, Atom);
   // if(AtomName) DPRINT("AtomName=%s\n", AtomName);	// crash, AtomName is not always a pointer
                         ...
                         OUT PRTL_ATOM Atom)
{
   ...
   DPRINT("RtlLookupAtomInAtomTable (AtomTable %p AtomName %p Atom %p)\n", AtomTable, AtomName, Atom);
