...
@define('PLUGIN_EVENT_STATISTICS_OUT_TOPTRACKBACK', 'Most frequently trackbacked entires');//translate
...
@define('PLUGIN_EVENT_STATISTICS_OUT_TRACKBACKS_PER_ARTICLE2', 'trackbacks/emtrada');
...
@define('PLUGIN_EVENT_STATISTICS_OUT_CHARS_PER_ARTICLE', 'characters por entrada');
@define('PLUGIN_EVENT_STATISTICS_OUT_CHARS_PER_ARTICLE2', 'Characters per entry/entrada');
