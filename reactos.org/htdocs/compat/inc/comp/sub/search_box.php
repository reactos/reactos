...
<?php /*
<p><label for="searchinput" accesskey="s">Search: </label></p><input name="bSearch" type="button" disabled="true" id="bSearch" value="Search" style="display: inline" /> 
<noscript>
Sorry, currently the search function is only usable with ECMAScript enabled! The noscript methode will be available soon!
</noscript> */ ?>
