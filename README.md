...
The main development is done on [GitHub](https://github.com/reactos/reactos). We have an [alternative mirror](https://git.reactos.org/?p=reactos.git) in case GitHub is down. An unoffical mirror is also avaible at [gitlab](https://gitlab.com/reactos-mirror/reactos).
