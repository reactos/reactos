...
#define REG_POLICY_ROOT                   TEXT("SOFTWARE\\Policies")
#define REG_POLICY_PARAMETERS             TEXT("SOFTWARE\\Policies\\SNMP\\Parameters")
#define REG_POLICY_VALID_COMMUNITIES      REG_POLICY_PARAMETERS TEXT("\\ValidCommunities")
#define REG_POLICY_TRAP_DESTINATIONS      REG_POLICY_PARAMETERS TEXT("\\TrapConfiguration")
#define REG_POLICY_PERMITTED_MANAGERS     REG_POLICY_PARAMETERS TEXT("\\PermittedManagers")
#define REG_KEY_SNMP_PARAMETERS         TEXT("SYSTEM\\CurrentControlSet\\Services\\SNMP\\Parameters")
#define REG_KEY_EXTENSION_AGENTS        REG_KEY_SNMP_PARAMETERS TEXT("\\ExtensionAgents")
#define REG_KEY_VALID_COMMUNITIES       REG_KEY_SNMP_PARAMETERS TEXT("\\ValidCommunities")
#define REG_KEY_TRAP_DESTINATIONS       REG_KEY_SNMP_PARAMETERS TEXT("\\TrapConfiguration")
#define REG_KEY_PERMITTED_MANAGERS      REG_KEY_SNMP_PARAMETERS TEXT("\\PermittedManagers")
#define REG_KEY_MIB2     REG_KEY_SNMP_PARAMETERS TEXT("\\RFC1156Agent")
