...
*/
UINT HrSystemFindNextInstance( IN ObjectIdentifier *FullOid , IN OUT ObjectIdentifier *instance )
{
...
*/
UINT HrSystemConvertInstance( IN ObjectIdentifier *oid_spec , IN OUT InstanceName *native_spec )
{
    //  Developer supplied code to convert instance identifer to native specification of instance names goes here.
    return SUCCESS ;
 ...
 *     This routine is used to free an ordered native representation of an instance name.
 *  Arguments:
 *     instance                Address to return the ordered native instance specification
*/
void HrSystemFreeInstance( IN OUT InstanceName *instance )
{
