...
// This class implements an an event source object.
// An event source corresponds to an application that can generate events.
// The event sources are enumerated from the registry in "SYSTEM\CurrentControlSet\Services\EventLogs" under each particular
// eventlog found there.

// An event source has an array of messages and an array of events associated with it.
...
//          An open registry key for the event log containing this event source.
//          This key points to somewhere in SYSTEM\CurrentControlSet\Services\EventLog
...
// Parameters:
//      CRegistryKey& regkeySource
//          An open registry key corresponding to this source in SYSTEM\CurrentControlSet\Services\EventLog\<event log>
