...
// This method returns an array of pointers to the messages currently selected in the CLcEvents list control. 
// These pointers are owned by g_aEventLogs and the caller should not delete them.
// Parameters:
//      None.
// Returns:
//      Nothing.
...
// CSource::OnFind
// This method is called when the "Find" button in the CEventTrap dialog is clicked.
// Parameters:
//      CWnd* pwndParent
//          Pointer to the parent window of the "find" dialog. 
//          This happens to be the CEventTrapDialog.
// Returns:
//      Nothing.
