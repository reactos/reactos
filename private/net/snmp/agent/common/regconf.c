...
//    DWORD dwTitle;
    ...
    *trapDestsLen = 0;
    ...
    if ((status = RegOpenKeyEx(HKEY_LOCAL_MACHINE, pszSnmpSrvTeKey, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult)) != ERROR_SUCCESS)
        {
    ...
    if ((status = RegOpenKeyEx(HKEY_LOCAL_MACHINE,  pszSnmpSrvTdKey, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult)) != ERROR_SUCCESS)
        {
    ...
    while((status = RegEnumKey(hkResult, iValue, value, MAX_PATH)) !=
        ...
        if ((status = RegOpenKeyEx(hkResult, value, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult2)) != ERROR_SUCCESS)
            {
...
//    DWORD dwTitle;
    ...
    *validCommsLen = 0;
    ...
    if ((status = RegOpenKeyEx(HKEY_LOCAL_MACHINE, pszSnmpSrvVcKey, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult)) != ERROR_SUCCESS)
        {
