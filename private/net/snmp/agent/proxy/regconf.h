...
#if 1
#define SNMP_REG_SRV_PARMROOT     TEXT("SYSTEM\\CurrentControlSet\\Services\\SNMP\\Parameters")
#else
#define SNMP_REG_SRV_PARMROOT     TEXT("SYSTEM\\CurrentControlSetA\\Services\\SNMP\\Parameters")
#endif
