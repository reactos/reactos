...
//    DWORD dwTitle;
    ...
    *extAgentsLen = 0;
    ...
    if ((status = RegOpenKeyEx(HKEY_LOCAL_MACHINE, pszSnmpSrvEaKey, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult)) != ERROR_SUCCESS)
        {
    ...
    while((status = RegEnumValue(hkResult, iValue, dummy, &dummySize,
        ...
        if ((status = RegOpenKeyEx(HKEY_LOCAL_MACHINE, value, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult2)) != ERROR_SUCCESS)
            {
...
//    DWORD dwTitle;
    ...
    *permitMgrsLen = 0;
    ...
    if ((status = RegOpenKeyEx(HKEY_LOCAL_MACHINE, pszSnmpSrvPmKey, 0, (KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_TRAVERSE), &hkResult)) != ERROR_SUCCESS)
        {
