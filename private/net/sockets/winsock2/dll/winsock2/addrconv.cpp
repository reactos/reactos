...
Abstract:
    This module contains the address conversion routines from the winsock2 API.
...
--*/
{
    ...
    __try {
        while (MoreFields) {
            ...
            // Process the charaters in the address string until a non digit charater is found.
            c = *cp;
            while (c) {
                if (isdigit(c)) {
...
Returns:
    ...
    The data should be copied before another WinSock call is made.
--*/
{
    PDPROCESS Process;
    PDTHREAD  Thread;
