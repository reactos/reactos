...
Abstract:
    This  module  contains  the  implementation  of  the  DTHREAD class used in winsock2 DLL.
...
PGETPROTO_INFO DTHREAD::GetProtoInfo()
/*++
Routine Description:
    Returns a pointer to the state structure used for the getprotobyXxx() APIs.
Return Value:
