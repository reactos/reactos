...
Abstract:
    ...
    This  module  provides macros to support a lexical-scope exception-handling mechanism.
    A brief comparison between this mechanism and the C++ exception mechanism is as follows:
    ...
    C++ exception mechanism:
        ...
        handles  all  types  of  exceptions  including  C  exceptions implicity thrown.
