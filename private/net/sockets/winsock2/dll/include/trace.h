...
"C"
#endif  // defined(__cplusplus)
LONG Ws2ExceptionFilter(LPEXCEPTION_POINTERS ExceptionPointers, LPSTR SourceFile, LONG LineNumber);
...
// This macro creates debug output depending on the debug mask "sev" and calls PrintDebugString output function.
// PrintDebugString makes the descision on whether the output goes into a file or to the aux device.
