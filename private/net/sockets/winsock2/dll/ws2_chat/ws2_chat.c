...
--*/
{
    ...
    if (GlobalFrameWindow == NULL) {
        ChatSysError("CreateWindow()", "WinMain()", TRUE);
    }
...
--*/
{
    ...
    case WM_CREATE:
        ...
        if (ClientWindow == NULL) {
            ChatSysError("CreateWindow()", "MainWndProc()", TRUE);
        }
...
--*/
{
    ...
    case WM_CREATE:
        ...
        ConnData->SocketEventObject = CreateEvent(NULL, FALSE, FALSE, NULL);
        ConnData->OutputEventObject = CreateEvent(NULL, FALSE, FALSE, NULL);
        ConnData->OutputQueue = QCreate();
        if (!ConnData->SocketEventObject || !ConnData->OutputEventObject || !ConnData->OutputQueue) {
            ChatSysError("CreateEvent() or QCreate()", "ConnWndProc()", TRUE);
        }
