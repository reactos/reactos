/*++
  ...
  Abstract:
    Header file containing definitions, function prototypes, and other stuff for internal use of the debug/trace dll.
...
BOOL DTTextOut(IN HWND   WindowHandle, IN HANDLE FileHandle, IN char   *String, IN DWORD  Style);
