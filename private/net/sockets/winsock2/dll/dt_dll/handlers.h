...
BOOL DTHandlerInit(OUT LPLPFNDTHANDLER HandlerFuncTable, int                 NumEntries);
...
BOOL CALLBACK DTHandler_listen(IN     va_list vl,
    IN OUT LPVOID  ReturnValue,
    IN     LPSTR   LibraryName,
    OUT    char    *Buffer,
    IN     int     Index,
...
BOOL CALLBACK DTHandler_WSAAccept(IN     va_list vl,
                                  IN OUT LPVOID  ReturnValue,
                                  IN     LPSTR   LibraryName,
                                  OUT    char    *Buffer,
                                  IN     int     Index,
...
BOOL CALLBACK DTHandler_inet_ntoa(IN     va_list vl,
    IN OUT LPVOID  ReturnValue,
    IN     LPSTR   LibraryName,
    OUT    char    *Buffer,
    IN     int     Index,
...
BOOL CALLBACK DTHandler_WSPListen(IN     va_list vl,
    IN OUT LPVOID  ReturnValue,
    IN     LPSTR   LibraryName,
    OUT    char    *Buffer,
    IN     int     Index,
...
BOOL CALLBACK DTHandler_NSPInstallServiceClass(IN     va_list vl,
                                               IN OUT LPVOID  ReturnValue,
                                               IN     LPSTR   LibraryName,
                                               OUT    char    *Buffer,
                                               IN     int     Index,
...
BOOL CALLBACK DTHandler_NSPRemoveServiceClass(IN     va_list vl,
                                              IN OUT LPVOID  ReturnValue,
                                              IN     LPSTR   LibraryName,
                                              OUT    char    *Buffer,
                                              IN     int     Index,
...
BOOL CALLBACK DTHandler_NSPGetServiceClassInfo(IN     va_list vl,
                                               IN OUT LPVOID  ReturnValue,
                                               IN     LPSTR   LibraryName,
                                               OUT    char    *Buffer,
                                               IN     int     Index,
