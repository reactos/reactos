...
int DICTIONARY::Insert(void * Key, void * Item)
{
    int iDictSlots;
    void * * NewDictKeys;
    void * * NewDictItems;
    ...
    NewDictKeys = (void * *) new unsigned char[sizeof(void *) * cDictSlots * 2];
    NewDictItems = (void * *) new unsigned char[sizeof(void *) * cDictSlots * 2];
...
void DICTIONARY::Update(void * Key, void * Item)
{
    int iDictSlots;
