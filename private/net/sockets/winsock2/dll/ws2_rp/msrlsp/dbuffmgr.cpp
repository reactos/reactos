...
/*++
Routine Description:
    DBUFFERMANAGER  object  constructor.
    Creates and returns a DBUFFERMANAGER object.
    Note that  the  DBUFFERMANAGER object has not been fully initialized.
    The "Initialize" member function must be the first member function called on the new DBUFFERMANAGER object.
Arguments:
    None
Return Value:
    None
...
INT DBUFFERMANAGER::Initialize()
/*++
Routine Description:
    The initialization routine for a buffer manager object.
...
/*++
Routine Description:
    DBUFFERMANAGER object destructor.
    This procedure has the responsibility to perform any required shutdown operations for the DBUFFERMANAGER object before the object memory is deallocated.
Arguments:
    None
Return Value:
    None
...
/*++
Routine Description:
    This routine allocates a set of WSABUF's to pass to the underlying service provider.
Arguments:
    ...
    InternalBufferCount - The pointer to a DWORD to revceive the number of WSABUFs pointed to by InternalBuffer.
Return Value:
    The  function returns NO_ERROR if successful.
    Otherwise it returns an appropriate WinSock error code if the initialization cannot be completed.
--*/
...
VOID DBUFFERMANAGER::FreeBuffer(IN LPWSABUF  InternalBuffer, IN DWORD     InternalBufferCount)
/*++
Routine Description:
...
Arguments:
    ...
    DestinationBufferCount - The number of WSABUFs pointed to by DestinationBuffer .
Return Value:
    The  function returns NO_ERROR if successful.
    Otherwise it returns an appropriate WinSock error code if the initialization cannot be completed.
--*/
