...
// Protocol catalog mutex name. This isn't really operating system specific, but it needs to go somewhere shared between WS2_32.DLL and WSOCK32.DLL (for Setup Migration).
#define CATALOG_MUTEX_NAME  "Winsock2ProtocolCatalogMutex"

// Winsock configuration registry root key name (lives under HKLM).
#define WINSOCK_REGISTRY_ROOT     "System\\CurrentControlSet\\Services\\WinSock2\\Parameters"
