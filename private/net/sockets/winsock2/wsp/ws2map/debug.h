...
Abstract:
    This module contains debug-specific definitions and declarations for the Winsock 2 to Winsock 1.1 Mapper Service Provider.
...
#if DBG
VOID SockInitializeDebugData(VOID);// Initialization.
#endif  // DBG
