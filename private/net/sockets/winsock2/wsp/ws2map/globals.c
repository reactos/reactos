...
Abstract:
    This module contains global variable definitions for the Winsock 2 to Winsock 1.1 Mapper Service Provider.
...
LIST_ENTRY SockGlobalSocketListHead = { NULL };// Linked list of all sockets created by this provider.
CRITICAL_SECTION SockGlobalLock = { NULL };// Critical section protecting global variables.
DWORD SockTlsSlot = TLS_OUT_OF_INDEXES;// TLS slot for per-thread data.
