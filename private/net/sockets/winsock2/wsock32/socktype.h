...
#define SockThreadProcessingGetXByY             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->ProcessingGetXByY )
#define SockThreadGetXByYCancelled             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->GetXByYCancelled )
#define SockThreadBlockingHook             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->BlockingHook )
#define SockDisableWinsNameResolution             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->DisableWinsNameResolution )
#define SockCreateOptions             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->CreateOptions )
#define SockThreadDnrErrorCode             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->DnrErrorCode )
#if DBG
#define SockIndentLevel             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->IndentLevel )
#endif
#define SockBigBufSize             ( ((PWINSOCK_TLS_DATA)GET_THREAD_DATA())->BigBufSize )
...
// Prototype for a post message routine.  This must have the same prototype as PostMessage().
