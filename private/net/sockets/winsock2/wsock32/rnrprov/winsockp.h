...
// do this so we can statically link with WS2_32.DLL, which also exports these names.
...
VOID WsExitApiCall (IN PCHAR RoutineName, IN INT ReturnCode, IN BOOLEAN Failed);
