...
#define DISPID_A_ROTATE                         (DISPID_A_FIRST+151)
#define DISPID_A_ZOOM                           (DISPID_A_FIRST+152)
...
//    DISPIDs for interface IHTMLViewServices2

#define DISPID_IHTMLVIEWSERVICES2_MOVEMARKUPPOINTERTOPOINTEX2     
#define DISPID_IHTMLVIEWSERVICES2_SETAPPHACKS                     
#define DISPID_IHTMLVIEWSERVICES2_GETAPPHACKS                     
