...
DELAY_LOAD_MAP_VOID(g_hinstSHELL32, SHELL32.DLL, _SHChangeNotify, SHChangeNotify, (LONG wEventId, UINT uFlags, LPCVOID dwItem1, LPCVOID dwItem2), (wEventId, uFlags, dwItem1, dwItem2));
...
DELAY_LOAD_ORD(g_hinstSHELL32, SHELL32.DLL, int, _Shell_GetCachedImageIndexW, 72, (LPVOID pszIconPath, int iIconIndex, UINT uIconFlags), (pszIconPath, iIconIndex, uIconFlags));
