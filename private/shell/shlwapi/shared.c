...
HANDLE SHAllocShared(
    ...
    hData = CreateFileMapping( (HANDLE)-1, NULL, PAGE_READWRITE,0, dwSize+sizeof(SHMAPHEADER),NULL);
    if (hData == NULL)
    {
        // DebugMsg...
        return NULL;
    ...
    hUsableData = SHMapHandle(hData, GetCurrentProcessId(), dwDestinationProcessId, FILE_MAP_ALL_ACCESS, DUPLICATE_SAME_ACCESS);
