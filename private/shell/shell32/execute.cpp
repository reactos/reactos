...
HWND CShellExecute::_GetConversationWindow(HWND hwndDDE)
{
    ...
    //  one that the conversation uses.  so we need to identify the process and use the process path for searching instead.
...
BOOL CShellExecute::_DDEExecute(BOOL fWillRetry, HWND hwndParent, int   nShowCmd, BOOL fWaitForDDE)
{
