...
LRESULT CFTPropDlg::OnInitDialog(WPARAM wParam, LPARAM lParam)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        _hThread = CreateThread(NULL, 0, _FillListViewWrapper, (LPVOID)this, 0, &dwThreadID);
    }
...
LRESULT CFTPropDlg::OnFinishInitDialog()
{
    ...
    else
    {
        ...
        _hThread = CreateThread(NULL, 0, _UpdateAllListViewItemImagesWrapper, (LPVOID)this, 0, &dwThreadID);
    }
