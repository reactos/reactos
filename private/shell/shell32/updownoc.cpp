...
HRESULT CUpDownOC::_CreateUpDownWindow(void)
{
    ...
    _hwndUpDown = CreateUpDownControl(dwStyle, 0, 0, (m_rcPos.right - m_rcPos.left), (m_rcPos.bottom - m_rcPos.top), m_hWnd, nID, HINST_THISDLL, NULL, _lMaxValue, _lMinValue, _lValue);
