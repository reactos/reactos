...
HRESULT InitializeFormatDlg(LPFORMATINFO pFormatInfo)
{
    ...
    if (FAILED(hr))
    {
        ...
        case ERROR_NOT_READY:
            ShellMessageBox(HINST_THISDLL, hDlg, MAKEINTRESOURCE(IDS_DRIVENOTREADY), NULL, MB_SETFOREGROUND | MB_ICONEXCLAMATION | MB_OK, pFormatInfo->wszDriveName[0]);
            break;
        case ERROR_ACCESS_DENIED:
            ShellMessageBox(HINST_THISDLL, hDlg, MAKEINTRESOURCE(IDS_ACCESSDENIED), NULL, MB_SETFOREGROUND | MB_ICONEXCLAMATION | MB_OK, pFormatInfo->wszDriveName[0]);
            break;
        case ERROR_WRITE_PROTECT:
            ShellMessageBox(HINST_THISDLL, hDlg, MAKEINTRESOURCE(IDS_WRITEPROTECTED), NULL, MB_SETFOREGROUND | MB_ICONEXCLAMATION | MB_OK, pFormatInfo->wszDriveName[0]);
            break;
        }
    }
        ...
        switch(CMD)
        {
            ...
            default:
                ...
                case IDOK:
                {
                    ...
                    pFormatInfo->hThread = CreateThread( NULL, 0, BeginFormat, (LPVOID) pFormatInfo, 0, &dwThreadID );
                    break;
                }
    ...
    case WM_COMMAND:
    {
        switch (ID)
        {
            ...
            case IDOK:
            {
                ...
                pChkDskInfo->hThread = CreateThread( NULL, 0, BeginChkDsk, (LPVOID) pChkDskInfo, 0, &dwThreadID );
                break;
            }
