...
public:
    void Fire_Emptied(long nReason)
    {
    ...
    void Fire_PropertyShow(BSTR FmtID, long nPropID, long nDataType)
    {
    ...
    void Fire_PropertyHide(BSTR FmtID, long nPropID, long nDataType)
    {
        VARIANTARG* pvars = new VARIANTARG[3];
        for (int i = 0; i < 3; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_PropertyGetFocus(BSTR FmtID, long nPropID, long nDataType)
    {
        VARIANTARG* pvars = new VARIANTARG[3];
        for (int i = 0; i < 3; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_PropertyKillFocus(BSTR FmtID, long nPropID, long nDataType)
    {
        VARIANTARG* pvars = new VARIANTARG[3];
        for (int i = 0; i < 3; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_FolderShow(long nFolderID)
    {
        VARIANTARG* pvars = new VARIANTARG[1];
        for (int i = 0; i < 1; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_FolderHide(long nFolderID)
    {
        VARIANTARG* pvars = new VARIANTARG[1];
        for (int i = 0; i < 1; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_FolderGetFocus(long nFolderID)
    {
        VARIANTARG* pvars = new VARIANTARG[1];
        for (int i = 0; i < 1; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_FolderKillFocus(long nFolderID)
    {
        VARIANTARG* pvars = new VARIANTARG[1];
        for (int i = 0; i < 1; i++)
            VariantInit(&pvars[i]);
    ...
    void Fire_PropertyDirty(BSTR FmtID, long nPropID, long nDataType, VARIANT_BOOL bDirty)
    {
    ...
    void Fire_DirtyCountChanged(long cDirtyCount, long cDirtyCountVis)
    {
