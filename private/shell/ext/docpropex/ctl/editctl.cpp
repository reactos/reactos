...
{
    ASSERT( hwndDrop );
    ULONG dwDirection = (m_nDropAnchor == DROPANCHOR_TOP) ? AW_VER_POSITIVE : AW_VER_NEGATIVE;
...
void CInPlaceDropWindow::NormalizeDropRect(IN OUT RECT& rcDrop, OUT OPTIONAL UINT* pnAnchorBorder ) const
{
