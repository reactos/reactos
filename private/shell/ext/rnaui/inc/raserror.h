...
#define ERROR_BAD_DEST_ADDRESS               (RASBASE+151)
#define ERROR_UNREACHABLE_DEST               (RASBASE+152)
#define ERROR_INCOMPATIBLE_DEST              (RASBASE+153)
#define ERROR_NETWORK_CONGESTION             (RASBASE+154)

#define RASBASEEND                           (RASBASE+154)
#else
