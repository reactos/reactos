...
void PageT1_OnInitDialog (HWND hDlg)
{
    ...
    else
    {
        ...
        GetPrivateProfileString(szGUID, TEXT("IconArea_Text"), TEXT("0x00000000"), szString, ARRAYSIZE(szString), g_szIniFile);
        LPSTR lpszString;
        CHAR szStr[MAX_PATH];
#ifdef UNICODE
        ...
        GetPrivateProfileString(szGUID, TEXT("IconArea_TextBackground"), TEXT("0xFFFFFFFF"), szString, ARRAYSIZE(szString), g_szIniFile);
        ...
        int ret = GetPrivateProfileString(szGUID, TEXT("IconArea_Image"), TEXT("default"), szString, ARRAYSIZE(szString), g_szIniFile);
