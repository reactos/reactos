...
class Provider : public IVirusScanEngine, public CComObjectRoot, public CComCoClass<Provider,&CLSID_Provider>
{
public:
    Provider();
...
DECLARE_REGISTRY_RESOURCEID(IDR_Provider)
      ...
      STDMETHODIMP ScanForVirus(HWND hWnd, STGMEDIUM *pstgMedium, LPWSTR pwszItemDescription, DWORD dwFlags, DWORD dwReserved, LPVIRUSINFO pVirusInfo);
