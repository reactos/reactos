...
STDMETHODIMP CMyDocsClassFactory::QueryInterface(REFIID riid, LPVOID* ppvObject)
{
    INTERFACES iface[] =
    {
...
STDMETHODIMP CMyDocsClassFactory::CreateInstance( IUnknown* pOuter, REFIID riid, LPVOID* ppvObject)
{
    HRESULT hr;
...
STDMETHODIMP CMyDocsClassFactory::LockServer(BOOL fLock)
{
