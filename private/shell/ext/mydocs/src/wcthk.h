...
/*
    ...
    of *characters*.  The third parameter to each macro is the length of each buffer, less the terminating null character.
    All strings must be null-terminated.
*/

/*
    Macros which convert between TCHARs and WCHARs, regardless of how TCHAR is defined for the current compile session.
    Useful for solving the Win95/OLE string incompatibility problem.
*/
...
/*
    Macros which convert between TCHARs and CHARs, regardless of how TCHAR is defined for the current compile session.
    Useful for solving the argv/TCHAR string incompatibility problem.
*/
