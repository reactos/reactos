...
CEnumFormatEtc::CEnumFormatEtc(UINT cFormats, LPFORMATETC prgFormats) : m_cRef(0),
        m_cFormats(0),
        m_iCurrent(0),
        m_prgFormats(NULL),
        m_hrCtor(NOERROR)
...
CEnumFormatEtc::CEnumFormatEtc(const CEnumFormatEtc& ef) : m_cRef(0), m_cFormats(0), m_iCurrent(0), m_prgFormats(NULL), m_hrCtor(NOERROR)
{
...
STDMETHODIMP CEnumFormatEtc::Next(DWORD cFormats, LPFORMATETC pFormats, LPDWORD pcReturned)
{
    HRESULT hr = S_OK;
    DWORD iFormats = 0;
    if (NULL == pFormats)
...
STDMETHODIMP CEnumFormatEtc::Skip(DWORD cFormats)
{
...
STDMETHODIMP CEnumFormatEtc::Clone(IEnumFORMATETC **ppvOut)
{
    HRESULT hr = NO_ERROR;
...
HRESULT CEnumFormatEtc::AddFormats(UINT cFormats, LPFORMATETC pFormats)
{
