...
#define DBGCREATEMASK(value)  (ULONGLONG)(value << 16)
...
// The single global variable DBGPARAMS is defined in debug.cpp
// so that these values can be set through the debugger at runtime.

extern DebugParams DBGPARAMS;


// Simple class to ensure that the debug environment is initialized.
...
class DebugTrace : public DebugInit
{
    public:
...
class DebugPrint : public DebugInit
{
    public:
...
class DebugAssert : public DebugInit
{
    public:
