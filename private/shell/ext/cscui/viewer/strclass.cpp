    ...
    )
{
    ...
    else
    {
        ...
        cchLoaded = ::FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_FROM_HMODULE,
                                    hInst,
                                    (DWORD)idFmt,
...
void CString::FormatSysError(UINT idSysError)
{
    LPTSTR pszBuffer = NULL;
    ::FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_ALLOCATE_BUFFER, NULL, idSysError, 0, (LPTSTR)&pszBuffer, 1, NULL);
