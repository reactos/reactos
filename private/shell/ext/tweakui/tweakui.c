...
*/
void PASCAL RunShellInf(HWND hwnd)
{
    TCH tszOut[1024];
    TweakUi_BuildPathToFile(BuildRundll(tszOut, c_tszI), GetWindowsDirectory, c_tszInfBsShellInf);
...
/*
 *    Somebody double-clicked our icon, but we aren't being run as a control panel.  Offer to install.
*/
void PASCAL TweakUi_OnBadRun(HWND hwnd)
{
