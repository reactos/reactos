    ...
    switch ( uMsg )
    {
        ...
        case WM_COMMAND:
        {
            switch ( LOWORD(wParam) )
            {
                ...
                {
                    EnableWindow(GetDlgItem(hDlg, IDC_FORMLIST), IsDlgButtonChecked(hDlg, IDC_DEFAULTFORM)== BST_CHECKED);
                    break;
                }
                case IDC_DEFAULTSCOPE:
                {
                    EnableWindow(GetDlgItem(hDlg, IDC_SCOPELOCN), IsDlgButtonChecked(hDlg, IDC_DEFAULTSCOPE)== BST_CHECKED);
                ...
                case IDC_SAVEWHERE:
                {
                    EnableWindow(GetDlgItem(hDlg, IDC_SAVELOCN),  IsDlgButtonChecked(hDlg, IDC_SAVEWHERE)== BST_CHECKED);
                    EnableWindow(GetDlgItem(hDlg, IDC_SAVEBROWSE), IsDlgButtonChecked(hDlg, IDC_SAVEWHERE)== BST_CHECKED);
                    break;
                }
                case IDC_SAVEONCLOSE:
                {
                    EnableWindow(GetDlgItem(hDlg, IDC_PERSISTDATA), IsDlgButtonChecked(hDlg, IDC_SAVEONCLOSE)== BST_CHECKED);
                    break;
                }
                case IDC_GETRESULTS:
                {
