...
HICON _SimulateScrapIcon(HICON hiconClass, UINT cxIcon)
{
    ...
    HICON hiconTemplate = (HICON)LoadImage(HINST_THISDLL, MAKEINTRESOURCE(IDI_SCRAP), IMAGE_ICON, cxIcon, cxIcon, LR_DEFAULTCOLOR);
    if (!hiconTemplate) {
        return NULL;
    }
    ICONINFO ii;
...
{
    //  This test code is unrelated to the scrap itself. It just verifies that CLSID_ShellLink is correctly registered.
