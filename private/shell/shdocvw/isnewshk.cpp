...
STDMETHODIMP Intshcut::GetFolder(LPSTR pszFolder, int cchFolder)
{
    HRESULT hr;
...
STDMETHODIMP Intshcut::GetName(LPSTR pszName, int cchBuf)
{
    HRESULT hr;
...
STDMETHODIMP Intshcut::GetExtension(LPSTR pszExtension, int cchBufMax)
{
    HRESULT hr;
