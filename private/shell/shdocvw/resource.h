...
// Icon IDs (the order of these IDs should be preserved across releases)


// *** READ THIS BEFORE MODIFYING ICONS ***
// ***
// *** The order of icons is important, as sometimes they are referenced by INDEX instead of by ID. 
// *** This means that technically, to maintain backward compat all icons, onced shipped, must stay there and stay
// *** in the same order.  Specifically, icon IDI_CHANNELSAPP (118)
// *** must be at index 18 as ie4 channels.scf references id.
// ***
// *** IE5 already ripped out a bunch of icons, and I'm putting back just enough to fix this bug.
...
// *** to add new ones, you should must add them after id 20786
