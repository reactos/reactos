...
HRESULT CDocObjectFolder::CreateViewObject(HWND hwnd, REFIID riid, void **ppvOut)
{
    ...
    {
#ifdef LIGHT_FRAMES
        hres = CoCreateInstance(CLSID_HTMLDocument, NULL, CLSCTX_INPROC_SERVER, riid, (void**)ppvOut);
#else
...
HRESULT CInternetFolder::_GetUIObjectFromShortcut(LPCITEMIDLIST pidl, REFIID riid, void **ppvOut)
{
        ...
        SUCCEEDED(StrRetToBuf(&str, pidl, sz, ARRAYSIZE(sz))))
    {
        ...
        hres = CoCreateInstance(CLSID_InternetShortcut, NULL, CLSCTX_INPROC_SERVER, IID_IUniformResourceLocator, (void **)&purl);
        if (SUCCEEDED(hres))
        {
...
HRESULT CInternetFolder::_InitHistoryStg(IUrlHistoryStg **pphist)
{
    ...
    if (!_phist)
    {
        hr = CoCreateInstance(CLSID_CUrlHistory, NULL, CLSCTX_INPROC_SERVER, IID_IUrlHistoryStg, (void **)&_phist);
    }
