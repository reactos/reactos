...
QueryParent:
        ...
        sNotify.ptCursor.x = (int)(short)LOWORD(lParam);
        sNotify.ptCursor.y = (int)(short)HIWORD(lParam);
...
BOOL WINAPI MakeDragList(HWND hLB)
{
  ...
  pDragProp->lpfnDefProc = (WNDPROC)SetWindowLong(hLB, GWL_WNDPROC, (LONG)DragListSubclassProc);
