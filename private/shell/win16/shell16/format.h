...
//    TrackLayout area as the structures are identical andinterchangeable up to that point.
...
// This structure contains extra goop of ours for format as well as the format engine's FMTINFOSTRUCT
...
// This structure contains extra goop of ours for CHKDSK as well as the FixDrive engine's DRVPARMSTRUCT
...
//   any removable drives which are indicated to be checked in the remaining bits in the DrivesToChk field.
...
// CHKDSK.C
WORD FAR  MyChkdskMessageBoxBuf(LPMYCHKINFOSTRUCT lpMyChkInf, LPSTR lpMsgBuf, WORD BoxStyle);
WORD FAR  MyChkdskMessageBox(LPMYCHKINFOSTRUCT lpMyChkInf, WORD MsgID, WORD BoxStyle);
