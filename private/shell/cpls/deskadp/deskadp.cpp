...
DWORD ApplyNowThd(LPVOID lpThreadParameter)
{
    ...
    // HACK:
    // We need to make a USER call before calling the desktop stuff so we can sure our threads internal data structure are associated with the default desktop.
