...
void FAR PASCAL Look_SelectElement(HWND hDlg, int iElement, DWORD dwFlags)
{
    ...
    EnableWindow(GetDlgItem(hDlg, IDC_GRADIENT), (bEnableGradient && g_bGradient));
    EnableWindow(GetDlgItem(hDlg, IDC_GRADIENTLABEL), (bEnableGradient && g_bGradient));
...
const static DWORD FAR aAppearanceHelpIds[] = {
 ...
 //       IDC_GRADIENT,       IDH_APPEAR_GRADIENTCOLOR,
 //       IDC_GRADIENTLABEL,  IDH_APPEAR_GRADIENTCOLOR,
