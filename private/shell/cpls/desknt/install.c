        ...
        if (InstallType == PREINSTALL)
        {
            ...
            if (pszSourceDirectory == NULL)
            {
                                         ...
                                         &pSourceListCount))
                {
                    ...
                    pszSourceDirectory = szSourceLocation;
    ...
    )
{
    ...
    err = InstallDriver(hwnd, PREINSTALL, pszSourceDirectory, pszModel, pszInf, ServiceName);
    return err;
}



DWORD PreInstallDriver(
    HWND    hwnd,
    LPCTSTR pszModel,
    LPCTSTR pszInf,
    LPTSTR  ServiceName
