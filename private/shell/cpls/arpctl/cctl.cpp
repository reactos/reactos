    ...
    )
{
    ...
    if (m_pam == NULL)
    {
        if (FAILED(CoCreateInstance(CLSID_ShellAppManager, NULL, CLSCTX_INPROC, IID_IShellAppManager, (void**)&m_pam)))
        {
...
CARPCtl::_CreateWorkerThread()
{
    ...
    m_hthreadWorker = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)_ThreadStartProcWrapper, (LPVOID)this, 0, &thid);
