...
BOOL SubscribeChannel(HWND hwnd, LPSTR szName, LPSTR szURL, BOOL bSilent)
{
    ...
    subsInfo.fChannelFlags |= CHANNEL_AGENT_PRECACHE_ALL | CHANNEL_AGENT_DYNAMIC_SCHEDULE;
    subsInfo.fTaskFlags = TASK_FLAG_START_ONLY_IF_IDLE | TASK_FLAG_RUN_IF_CONNECTED_TO_INTERNET;
