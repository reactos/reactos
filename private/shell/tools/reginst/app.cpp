...
Cond:    --
*/
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR pszCmdLine, int nCmdShow)
{
    HWND hwndStub;
    int nRet = 0;
    ...
    SetErrorMode(SEM_NOOPENFILEERRORBOX | SEM_FAILCRITICALERRORS);// turn off critical error stuff
