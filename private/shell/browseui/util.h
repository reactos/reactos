...
// similarily for MAKE_ANSIPTR_FROMWIDE.  note that the first param does not have to be declared, and no clean up must be done.
...
// This function scans the document for the given HTML tag and returns the result in a collection.
