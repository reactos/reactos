...
{
    // class factory will take care of denying aggregation and giving a null back on failure
...
STDMETHODIMP CGlobalFolderSettings::Set(const DEFFOLDERSETTINGS *pdfs, int cbDfs, UINT flags)
{
    ...
    // Preserve the dwDefRevCount, otherwise we'll never be able to tell if the structure has been revised!
