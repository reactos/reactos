...
HRESULT DeskBar_Create(IUnknown** ppunk, IUnknown** ppbs)
{
    ...
    *ppunk = NULL;
    ...
    IDeskBarClient *pdbc;
    hres = CoCreateInstance(CLSID_RebarBandSite, NULL, CLSCTX_INPROC_SERVER, IID_IDeskBarClient, (LPVOID*)&pdbc);
    if (SUCCEEDED(hres))
    {
...
HRESULT CDeskBar::QueryService(REFGUID guidService, REFIID riid, void **ppvObj)
{
    if (ppvObj)
        *ppvObj = NULL;
