...
Abstract:
    This module contains the private structure definitions and APIs used by the NT I/O system.
...
// BOOLEAN IopAcquireFastLock(IN PFILE_OBJECT FileObject)
// Routine Description:
...
VOID IopCheckBackupRestorePrivilege(
...
// VOID IopDequeueThreadIrp(IN PIRP Irp)
// Routine Description:
//     This routine dequeues the specified I/O Request Packet (IRP) from the thread IRP queue which it is currently queued.
...
// VOID IopInitializeIrp(IN OUT PIRP Irp, IN USHORT PacketSize, IN CCHAR StackSize)
// Routine Description:
//     Initializes an IRP.
// Arguments:
...
NTSTATUS IopLookupBusStringFromID (
    IN  HANDLE KeyHandle,
...
// VOID IopQueueThreadIrp(IN PIRP Irp)
// Routine Description:
...
// VOID IopReleaseFileObjectLock(IN PFILE_OBJECT FileObject)
// Routine Description:
//     This routine is invoked to release ownership of the file object lock.
// Arguments:
//     FileObject - Pointer to the file object whose ownership is to be released.
// Return Value:
//     None.
