    ...
    while (LineCount) {
        ...
        while (i) {
            ...
            *output1 = My_OutputLut[((ako0 * paNewVal0[0] + ako1 * paNewVal0[ein_regr] + ako2 * paNewVal0[ein_regg] +
            ...
            paNewVal0++;
            *output2 = My_OutputLut[((ako0 * paNewVal0[0] + ako1 * paNewVal0[ein_regr] + ako2 * paNewVal0[ein_regg] +
                                      ein_regb * paNewVal0[var_1_1_1]) >> LH_DATA_SHR) + (2 << LH_ADR_BREIT_AUS_LUT)] >> 8;
            if (LH_DATA_OUT_COUNT_4) {
                paNewVal0++;
                *output3 = My_OutputLut[((ako0 * paNewVal0[0] + ako1 * paNewVal0[ein_regr] + ako2 * paNewVal0[ein_regg] +
