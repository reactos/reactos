...
HWND CreateMDIWindowA(
    ...
    LPARAM lParam)
{
    return CreateWindowExA(WS_EX_MDICHILD, pClassName, pWindowName, dwStyle, x, y, nWidth, nHeight, hwndParent, NULL, hModule, (LPVOID)lParam);
}
...
HWND CreateMDIWindowW(
    ...
    LPARAM lParam)
{
    return CreateWindowExW(WS_EX_MDICHILD, pClassName, pWindowName, dwStyle, x, y, nWidth, nHeight, hwndParent, NULL, hModule, (LPVOID)lParam);
}
