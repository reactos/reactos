...
{
    /*
     * GDI may call during ChangeDisplaySettings, in which case the critical section will already be held.
     * GDI may also call any time its PDEV reference counts go to zero, in which case the critical section will not already be held.
     */
    BEGIN_REENTERCRIT();
