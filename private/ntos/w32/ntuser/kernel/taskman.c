...
/*
* This function puts this task to sleep and wakes the next (if any) deserving task.
...
rescan:
        ...
        if (Status == STATUS_WAIT_1) {
            ...
            /*
             * An alert was received.  This should only occur when the thread has been terminated.
             * ClientDeliverUserApc() delivers User-mode APCs by calling back to the client and immediately returning without doing anything:
