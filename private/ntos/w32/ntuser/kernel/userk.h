...
// BOOLEAN ProbeAndReadPoint(IN PPOINT Address)
...
// BOOLEAN ProbeAndReadRect(IN PRECT Address)
...
// BOOLEAN ProbeAndReadMessage(IN PMSG Address)
...
// BOOLEAN ProbeAndReadLargeString(IN PLARGE_STRING Address)
...
// BOOLEAN ProbeAndReadWindowPlacement(IN PWINDOWPLACEMENT Address)
...
// BOOLEAN ProbeAndReadMenuItem(IN PMENUITEMINFO Address)
...
// BOOLEAN ProbeAndReadMenuInfo(IN PMENUINFO Address)
...
// BOOLEAN ProbeAndReadScrollInfo(IN PSCROLLINFO Address)
...
// BOOLEAN ProbeAndReadPopupParams(IN PTPMPARAMS Address)
...
// BOOLEAN ProbeAndReadPaintStruct(IN PPAINTSTRUCT Address)
...
// BOOLEAN ProbeAndReadCreateStruct(IN PCREATESTRUCTW Address)
...
// BOOLEAN ProbeAndReadMDICreateStruct(IN PMDICREATESTRUCT Address)
...
// BOOLEAN ProbeAndReadCopyDataStruct(IN PCOPYDATASTRUCT Address)
...
// BOOLEAN ProbeAndReadCompareItemStruct(IN PCOMPAREITEMSTRUCT Address)
...
// BOOLEAN ProbeAndReadDeleteItemStruct(IN PDELETEITEMSTRUCT Address)
...
// BOOLEAN ProbeAndReadHelp(IN PHLP Address)
...
// BOOLEAN ProbeAndReadHelpInfo(IN PHELPINFO Address)
...
// BOOLEAN ProbeAndReadDrawItemStruct(IN PDRAWITEMSTRUCT Address)
...
// BOOLEAN ProbeAndReadHookInfo(IN PDEBUGHOOKINFO Address)
...
// BOOLEAN ProbeAndReadCBTActivateStruct(IN PCBTACTIVATESTRUCT Address)
...
// BOOLEAN ProbeAndReadKbdHook(IN PKBDHOOKSTRUCT Address)
...
// BOOLEAN ProbeAndReadMsllHook(IN PMSLLHOOKSTRUCT Address)
...
// BOOLEAN ProbeAndReadMouseHook(IN PMOUSEHOOKSTRUCTEX Address)
...
// BOOLEAN ProbeAndReadHTHook(IN PHTHOOKSTRUCT Address)
...
// BOOLEAN ProbeAndReadCBTCreateStruct(IN PCBT_CREATEWND Address)
...
// BOOLEAN ProbeAndReadTrackMouseEvent(IN LPTRACKMOUSEEVENT Address)
...
// BOOLEAN ProbeAndReadWindowPos(IN PWINDOWPOS Address)
...
// BOOLEAN ProbeAndReadCursorFind(IN PCURSORFIND Address)
...
// BOOLEAN ProbeAndReadSetClipBData(IN PSETCLIPBDATA Address)
...
// BOOLEAN ProbeAndReadBroadcastSystemMsgParams(IN LPBROADCASTSYSTEMMSGPARAMS Address)
...
// BOOLEAN ProbeAndReadCursorData(IN PCURSORDATA Address)
...
// BOOLEAN ProbeForReadUnicodeStringBuffer(IN UNICODE_STRING String)
...
#if DBG
    #define ValidateProcessSessionId(pEProcess)          UserAssert((pEProcess)->SessionId == gSessionId)
    #define ValidateThreadSessionId(pEThread)          UserAssert((pEThread)->ThreadsProcess->SessionId == gSessionId)
#else
