...
/*
* Sets the given window's menu to the menu specified by the pMenu parameter.  If pMenu is Null, the window's current menu is removed (but not destroyed).
*/
...
* o  Revalidation is not required in this routine: pwnd is used at the start to obtain pMenuState, and not used again.
*/
