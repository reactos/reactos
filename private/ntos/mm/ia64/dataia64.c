...
MMPTE ValidKernelPte = { MM_PTE_VALID_MASK | MM_PTE_CACHE | MM_PTE_WRITE_MASK | MM_PTE_EXECUTE_MASK | MM_PTE_ACCESS_MASK | MM_PTE_DIRTY_MASK | MM_PTE_EXC_DEFER};
MMPTE ValidKernelPteLocal = { MM_PTE_VALID_MASK | MM_PTE_CACHE | MM_PTE_WRITE_MASK | MM_PTE_ACCESS_MASK | MM_PTE_DIRTY_MASK | MM_PTE_EXC_DEFER};
MMPTE ValidUserPte = { MM_PTE_VALID_MASK | MM_PTE_CACHE | MM_PTE_WRITE_MASK | MM_PTE_OWNER_MASK | MM_PTE_ACCESS_MASK | MM_PTE_DIRTY_MASK | MM_PTE_EXC_DEFER};
MMPTE ValidPtePte = { MM_PTE_VALID_MASK | MM_PTE_CACHE | MM_PTE_WRITE_MASK | MM_PTE_ACCESS_MASK | MM_PTE_DIRTY_MASK  };
MMPTE ValidPdePde = { MM_PTE_VALID_MASK | MM_PTE_CACHE | MM_PTE_WRITE_MASK | MM_PTE_ACCESS_MASK | MM_PTE_DIRTY_MASK };
MMPTE ValidKernelPde = { MM_PTE_VALID_MASK | MM_PTE_CACHE | MM_PTE_WRITE_MASK | MM_PTE_ACCESS_MASK | MM_PTE_DIRTY_MASK };
MMPTE ValidKernelPdeLocal = { MM_PTE_VALID_MASK | MM_PTE_WRITE_MASK | MM_PTE_DIRTY_MASK };
...
MMPTE TransitionPde = { MM_PTE_TRANSITION_MASK | MM_READWRITE << MM_PROTECT_FIELD_SHIFT };
