...
//VOID MI_FLUSH_ENTIRE_SESSION_TB (IN ULONG Invalid, IN LOGICAL AllProcessors);

// Routine Description:

//    MI_FLUSH_ENTIRE_SESSION_TB flushes the entire TB on processors which support ASNs.
