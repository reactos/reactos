...
--*/
{
    ...
    // The first 1000 values are reserved for static definition.
    // This value can be increased with later releases with no adverse impact.
...
--*/
{
    ...
    // Establish an exception handler and attempt to write the Luid to the specified variable.
