...
Abstract:
    ...
    This module defines macros that provide a mode-independent interface for security test procedures.

    The mode must be specified by defining one, but not both, of:
...
PVOID ITstAllocatePool(IN ULONG NumberOfBytes)
{
    NTSTATUS Status;
