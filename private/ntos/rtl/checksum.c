...
Abstract:
    The module contains the code to translate an image directory type to the address of the data for that entry.
...
--*/
{
    ...
    // Compute the final checksum value as the sum of the paritial checksum and the file length.
