...
// PRANGE_LIST_ENTRY RtlpAllocateRangeListEntry(VOID)
...
// VOID RtlpFreeRangeListEntry(IN PRTLP_RANGE_LIST_ENTRY Entry)
#define RtlpFreeRangeListEntry(Entry)                                   \
