...
// This block of data needs to always be present because crashdumps need the information.
// Otherwise, things like PAGE_SIZE are not available in crashdumps, and extensions like !pool fail.
