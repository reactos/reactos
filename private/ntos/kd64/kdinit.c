...
/*++
Routine Description:
    We have to update this variable seperately since it is initialized at a later time by PS.  PS will call us to update the data block.
--*/
{
...
--*/
{
    ...
    // Note that if LoaderBlock == NULL, then KdInitSystem was called from BugCheck code. For this case the debugger is always enabled to report the bugcheck if possible.
    if (LoaderBlock != NULL) {
