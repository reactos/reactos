...
Abstract:
    ...
    If KeyPath is not present, it loads the hive file at \Registry\User\FileName
...
void processargs(int argc, char *argv[])
{
    ...
    if (argc == 3) {
        ...
        InitializeObjectAttributes( &FileAttributes, &RelativeName.RelativeName, OBJ_CASE_INSENSITIVE, RelativeName.ContainingDirectory, NULL );
