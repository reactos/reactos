...
;  VOID Ki386SetupAndExitToV86Code (VOID)
;  Routine Description:
;     This function sets up return trap frame, switch stack and
;     calls VdmStartExecution routine to put vdm context to
;     base trap frame and causes the system to execute in v86 mode by doing a KiExceptionExit.
;  Arguments:
;     BiosArguments - Supplies a pointer to a structure which contains the arguments for v86 int function.
;  Return Value:
;     None.
