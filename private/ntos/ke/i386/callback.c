...
--*/
{
    ...
    try {
        ...
        *UserStack = NewStack;
        ...
        Teb->NtTib.ExceptionList = ExceptionList;// Restore exception list.
...
--*/
{
    ...
    Status = KeUserModeCallback(ApiNumber, InputBuffer, InputLength, &ValueBuffer, &ValueLength);// Call out to user mode specifying the input buffer and API number.
