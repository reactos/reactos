...
--*/
{
    ...
    // Transfer the context information to the user stack, initialize the APC routine parameters, and modify the trap frame so execution will
    ...
    try {
        ...
        // Set the address of the user APC routine, the APC parameters, the new frame pointer, and the new stack pointer in the current trap
        // frame. Set the continuation address so control will be transfered to the user APC dispatcher.
