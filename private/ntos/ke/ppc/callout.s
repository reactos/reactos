...
// Arguments:
//    OutputBuffer (r.3) - Supplies a pointer to the variable that receivies the address of the output buffer.
//    OutputLength (r.4) - Supplies a pointer to a variable that receives the length of the output buffer.
// Return Value:
