...
//    OldIrql  (r4) - Supplies a pointer to a variable that receives the the previous IRQL value.
// Return Value:
//    None.
// Remarks:
//    In the UniProcessor version, we just raise IRQL, the lock address is never touched.
//    In the MultiProcessor version the spinlock is taken after raising IRQL.
...
// Arguments:
//    SpinLock (r3) - Supplies a pointer to the spinlock that is to be acquired.
// Return Value:
