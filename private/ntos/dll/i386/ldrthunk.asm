...
; VOID LdrInitializeThunk(IN PVOID NormalContext, IN PVOID SystemArgument1, IN PVOID SystemArgument2)
; Routine Description:
;    This function computes a pointer to the context record on the stack and jumps to the LdrpInitialize function with that pointer as its parameter.
; Arguments:
...
; VOID LdrpCallInitRoutine(IN PDLL_INIT_ROUTINE InitRoutine, IN PVOID DllHandle, IN ULONG Reason, IN PCONTEXT Context OPTIONAL)
; Routine Description:
;    This function calls an x86 DLL init routine.
;    It is robust against DLLs that don't preserve EBX or fail to clean up enough stack.
