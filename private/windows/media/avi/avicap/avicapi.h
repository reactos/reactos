...
BOOL capInternalGetDriverDesc (UINT wDriverIndex, LPTSTR lpszName, int cbName, LPTSTR lpszVer, int cbVer);
...
LONG FAR PASCAL LOADDS EXPORT CapWndProc (HWND hwnd, UINT msg, UINT wParam, LONG lParam);
 ...
 LPVOID AllocContigMem (DWORD   cbSize, LPDWORD phMemContig);
#endif
