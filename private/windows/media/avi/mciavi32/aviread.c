...
*/
HAVIRD avird_startread(AVIRD_FUNC func, DWORD dwInstanceData, long lFirstSize, int nFirst, int nBlocks)
{
    PAVIRD_HEADER phdr;
    PAVIRD_BUFFER pbuf;
    int i;
 ...
 * causes the worker thread to be woken up and to start filling the buffer again.
*/
...
*/
void avird_freebuffer(PAVIRD_BUFFER pbuf)
{
    HANDLE hmem;
