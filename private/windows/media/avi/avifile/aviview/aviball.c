...
PAVISTREAM FAR PASCAL NewBall(void)
{
    ...
    // Create a pointer to our private structure which will act as our PAVISTREAM
...
// if any, and use it to determine the length of movie they want. (Not supported by NewBall right now, but it could be).
HRESULT STDMETHODCALLTYPE AVIBallCreate(PAVISTREAM ps, LONG lParam1, LONG lParam2)
{
