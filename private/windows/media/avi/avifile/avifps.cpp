...
STDAPI DllGetClassObject(const CLSID FAR&    rclsid, const IID FAR&    riid, void FAR* FAR*    ppv)
{
    HRESULT    hresult;
    ...
    (RPCOLEMESSAGE FAR *pMessage, IRpcChannelBuffer FAR *pChannel)
{
        ...
        // format on output: marshalled IAVIStream pointer
    {
        ...
        CoMarshalInterface(pstm, IID_IAVIStream, ps, dwDestCtx, pvDestCtx, MSHLFLAGS_NORMAL);
