...
//  pfh = &AVIFFileHandler;
    ...
    if (FAILED(GetScode(hr = CoCreateInstance((REFCLSID) clsid, NULL, CLSCTX_INPROC, (REFIID) IID_IAVIFile, (void FAR* FAR*)ppfile)))) {
...
// We used to just fail if AVIFileInit wasn't called
    ...
    *ppfile = 0;
    ...
    if (FAILED(GetScode(hr = CoCreateInstance((REFCLSID) clsid, NULL, CLSCTX_INPROC, (REFIID) IID_IUnknown, (void FAR* FAR*)&punk)))) {
              ...
              CLSID FAR *pclsidHandler)
{
    ...
    if (FAILED(GetScode(hr = CoCreateInstance((REFCLSID) clsid, NULL, CLSCTX_INPROC, (REFIID) IID_IAVIStream, (void FAR* FAR*)ppavi))))
    return hr;
        ...
        CLSID FAR *pclsidHandler)
{
    ...
    *ppsCompressed = NULL;
    ...
    if (FAILED(GetScode(hr = CoCreateInstance((REFCLSID) clsid, NULL, CLSCTX_INPROC, (REFIID) IID_IAVIStream, (void FAR* FAR*)ppsCompressed))))
    return hr;  // !!! PropagateHResult?
