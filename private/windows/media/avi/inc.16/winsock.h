 ...
 * This file includes parts which are Copyright (c) 1982-1986 Regents of the University of California.
 * All rights reserved.
 ...
 *    New version from David Treadwell which adds extern "C" around __WSAFDIsSet() and removes "const" from buf param of WSAAsyncGetHostByAddr().  Added change log.
