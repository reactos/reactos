...

{
    ...
    Message = RetreiveAndFormatMessage(MSG_FILEERROR_DETAILS1, ErrorName, Params->Win32Error, FullPath, TargetPath);
    MyFree(ErrorName);
    return Message;
}


BOOL DoPresenceCheck(IN PPROMPTPARAMS Params, IN BOOL          AllowConnectAs)
/*++
Routine Description:
...

{
    ...
    Message = RetreiveAndFormatMessage(MSG_FILEERROR_DELETE, File, ErrorText, Win32ErrorCode);
