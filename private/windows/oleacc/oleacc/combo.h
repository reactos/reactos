...
// can simplify our life a lot by not deferring to CClient for things like the child count property. 
// We accept IDs for all relevant properties even if the ID is of a child object.
