...
//_WinStationCallback
typedef BOOLEAN   (*PWINSTATION_CALLBACK) (HANDLE hServer, ULONG SessionId, LPWSTR pPhoneNumber);
PWINSTATION_CALLBACK gpfnWinStationCallback;

//WinStationDisconnect

typedef BOOLEAN (*PWINSTATION_DISCONNECT) (HANDLE hServer, ULONG SessionId, BOOLEAN bWait);
...
typedef BOOLEAN (*PWINSTATION_NAME_FROM_SESSIONID) (HANDLE hServer, ULONG SessionId, PWINSTATIONNAMEW pWinStationName);
