...
//  InitializeAPIs()
//  Purpose:    initializes API structures for delay loaded modules
//  Parameters: none
//  Return:     none
...
//  Purpose:    initializes a CRITICAL_SECTION for synch'ing DLL loads
//  Parameters: none
//  Return:     none
...
//  CloseApiDLLsCritSec()
//  Purpose:    clean up CRITICAL_SECTION for synch'ing DLL loads
//  Parameters: none
//  Return:     none
...
PNETAPI32_API LoadNetAPI32 ()
{
    ...
    if (!pNetAPI32->hInstance) {
        DebugMsg((DM_WARNING, TEXT("LoadNetAPI32:  Failed to load netapi32 with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pNetAPI32->pfnDsRoleFreeMemory) {
        DebugMsg((DM_WARNING, TEXT("LoadNetAPI32:  Failed to find pfnDsRoleFreeMemory with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pNetAPI32->pfnNetApiBufferFree) {
        DebugMsg((DM_WARNING, TEXT("LoadNetAPI32:  Failed to find NetApiBufferFree with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pNetAPI32->pfnNetUserGetGroups) {
        DebugMsg((DM_WARNING, TEXT("LoadNetAPI32:  Failed to find NetUserGetGroups with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pNetAPI32->pfnNetUserGetInfo) {
        DebugMsg((DM_WARNING, TEXT("LoadNetAPI32:  Failed to find NetUserGetInfo with %d."), GetLastError()));
        goto Exit;
    }
...
PICMP_API LoadIcmp ()
{
    ...
    if (!pIcmp->hInstance) {
        DebugMsg((DM_WARNING, TEXT("LoadIcmp:  Failed to load icmp with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pIcmp->pfnIcmpCreateFile) {
        DebugMsg((DM_WARNING, TEXT("LoadIcmp:  Failed to find IcmpCreateFile with %d."), GetLastError()));
        goto Exit;
    }

    pIcmp->pfnIcmpCloseHandle = (PFNICMPCLOSEHANDLE) GetProcAddress (pIcmp->hInstance, "IcmpCloseHandle");

    if (!pIcmp->pfnIcmpCloseHandle) {
        DebugMsg((DM_WARNING, TEXT("LoadIcmp:  Failed to find IcmpCloseHandle with %d."), GetLastError()));
        goto Exit;
    }
    
    pIcmp->pfnIcmpSendEcho = (PFNICMPSENDECHO) GetProcAddress (pIcmp->hInstance, "IcmpSendEcho");

    if (!pIcmp->pfnIcmpSendEcho) {
        DebugMsg((DM_WARNING, TEXT("LoadIcmp:  Failed to find IcmpSendEcho with %d."), GetLastError()));
        goto Exit;
    }
...
//  Purpose:    Loads cmp.dll
//  Parameters: pWSock32 - pointer to a WSOCK32_API structure to initialize
//  Return:     TRUE if successful
//              FALSE if an error occurs
{
    BOOL bResult = FALSE;
    ...
    if ( pWSock32->hInstance ) {// module already loaded and initialized
        LeaveCriticalSection( &g_ApiDLLCritSec );
        return pWSock32;
    }
    ...
    if (!pWSock32->hInstance) {
        DebugMsg((DM_WARNING, TEXT("LoadWSock32:  Failed to load wsock32 with %d."), GetLastError()));
        goto Exit;
    }

    pWSock32->pfninet_addr = (LPFN_INET_ADDR) GetProcAddress (pWSock32->hInstance, "inet_addr");
    if (!pWSock32->pfninet_addr) {
        DebugMsg((DM_WARNING, TEXT("LoadWSock32:  Failed to find inet_addr with %d."), GetLastError()));
        goto Exit;
    }

    pWSock32->pfngethostbyname = (LPFN_GETHOSTBYNAME) GetProcAddress (pWSock32->hInstance, "gethostbyname");
    if (!pWSock32->pfngethostbyname) {
        DebugMsg((DM_WARNING, TEXT("LoadWSock32:  Failed to find gethostbyname with %d."), GetLastError()));
        goto Exit;
    }
...
//              FALSE if an error occurs
{
    ...
    if ( pDSApi->hInstance ) {// module already loaded and initialized
        LeaveCriticalSection( &g_ApiDLLCritSec );
        return pDSApi;
    }
    ...
    if (!pDSApi->hInstance) {
        DebugMsg((DM_WARNING, TEXT("LoadDSApi:  Failed to load ntdsapi with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pDSApi->pfnDsCrackNames) {
        DebugMsg((DM_WARNING, TEXT("LoadDSApi:  Failed to find DsCrackNames with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pDSApi->pfnDsFreeNameResult) {
        DebugMsg((DM_WARNING, TEXT("LoadDSApi:  Failed to find DsFreeNameResult with %d."), GetLastError()));
        goto Exit;
    }
...
//  Return:     pointer to SHELL32_API
{
    ...
    EnterCriticalSection( &g_ApiDLLCritSec );
    if ( pShell32Api->hInstance ) {// module already loaded and initialized
        LeaveCriticalSection( &g_ApiDLLCritSec );
        return pShell32Api;
    }
    ...
    if (!pShell32Api->hInstance) {
        DebugMsg((DM_WARNING, TEXT("LoadShlwapiApi:  Failed to load ntdsapi with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pShell32Api->pfnShChangeNotify) {
        DebugMsg((DM_WARNING, TEXT("LoadShlwapiApi:  Failed to find SHChangeNotify with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pShell32Api->pfnShGetSpecialFolderPath) {
        DebugMsg((DM_WARNING, TEXT("LoadShlwapiApi:  Failed to find SHGetSpecialFolderPath with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pShell32Api->pfnShGetFolderPath) {
        DebugMsg((DM_WARNING, TEXT("LoadShlwapiApi:  Failed to find SHGetFolderPath with %d."), GetLastError()));
        goto Exit;
    }
    ...
    if (!pShell32Api->pfnShSetFolderPath) {
        DebugMsg((DM_WARNING, TEXT("LoadShlwapiApi:  Failed to find SHSetFolderPath with %d."), GetLastError()));
        goto Exit;
    }
