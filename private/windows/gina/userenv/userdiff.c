        ...
        if (lResult == ERROR_SUCCESS) {
            ...
            switch (dwAction) {
                ...
                case 1: {
                   ...
                   lResult = RegQueryValueEx(hKeyEntry, UD_KEYNAME, NULL, &dwType, (LPBYTE)szSubKey, &dwSize);
                   if (lResult == ERROR_SUCCESS) {
                ...
                case 3: {
                   ...
                   RegSetValueEx(hKeyTemp, szValueName, 0, dwType, lpValueData, dwSize);// Set the new value
