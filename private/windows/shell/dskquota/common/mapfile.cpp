...
MappedFile::MappedFile(VOID) : m_hFile(INVALID_HANDLE_VALUE), m_hFileMapping(INVALID_HANDLE_VALUE), m_pbBase(NULL), m_llSize(0)
{
...
LONGLONG MappedFile::Size(VOID) const
{
...
HRESULT MappedFile::Open(LPCTSTR pszFile)
{
    ...
    m_hFile = CreateFile(pszFile, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
