...
/*  Function: ProgressDialog::SendToProgressBar [inline]
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
inline INT_PTR ProgressDialog::SendToProgressBar(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
/*  Function: ProgressDialog::ProgressDialog
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
ProgressDialog::ProgressDialog(UINT idDialogTemplate, UINT idProgressBar, UINT idTxtDescription, UINT idTxtFileName
...
/*  Function: ProgressDialog::Create
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
BOOL ProgressDialog::Create(HINSTANCE hInstance, HWND hwndParent)
{
    m_hWnd = CreateDialogParam(hInstance, MAKEINTRESOURCE(m_idDialogTemplate), hwndParent, DlgProc, (LPARAM)this);
    if (NULL != m_hWnd)
    {
...
/*  Function: ProgressDialog::Destroy
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
VOID ProgressDialog::Destroy(VOID)
{
...
/*  Function: ProgressDialog::DlgProc [static]
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
INT_PTR CALLBACK ProgressDialog::DlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
/*  Function: ProgressDialog::HandleMessage
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
INT_PTR ProgressDialog::HandleMessage(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    return FALSE;
}
...
/*  Function: ProgressDialog::OnInitDialog
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
INT_PTR ProgressDialog::OnInitDialog(HWND hwnd, WPARAM wParam, LPARAM lParam)
{
    return TRUE;
}
...
/*  Function: ProgressDialog::OnDestroy
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
INT_PTR ProgressDialog::OnDestroy(HWND hwnd)
{
    m_hWnd = NULL;
    return FALSE;
}
...
/*  Function: ProgressDialog::OnCancel
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
INT_PTR ProgressDialog::OnCancel(HWND hwnd, WPARAM wParam, LPARAM lParam)
{
    return FALSE;
}
...
/*  Function: ProgressDialog::FlushMessages
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
VOID ProgressDialog::FlushMessages(VOID)
{
    if (NULL != m_hWnd)
    {
        // Process messages for the dialog's parent and all of it's children.
        MSG msg;
        while (PeekMessage(&msg, NULL, 0, 0, PM_NOREMOVE) && WM_QUIT != msg.message)
        {
...
/*  Function: ProgressDialog::SetTitle
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
VOID ProgressDialog::SetTitle(LPCTSTR pszTitle)
{
...
/*  Function: ProgressDialog::SetDescription
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
VOID ProgressDialog::SetDescription(LPCTSTR pszDescription)
{
...
/*  Function: ProgressDialog::SetFileName
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
VOID ProgressDialog::SetFileName(LPCTSTR pszFileName)
{
    ...
    if (NULL != m_hWnd)
    {
        ...
        if (NULL != pszText)
        {
            ...
            DrawText(hdc, pszText, -1, &rc, DT_CENTER | DT_PATH_ELLIPSIS | DT_MODIFYSTRING);
...
/*  Function: ProgressDialog::ProgressBarInit
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
BOOL ProgressDialog::ProgressBarInit(UINT iMin, UINT iMax, UINT iStep)
{
    BOOL bResult = FALSE;
...
/*  Function: ProgressDialog::ProgressBarReset
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
UINT ProgressDialog::ProgressBarReset(VOID)
{
...
/*  Function: ProgressDialog::ProgressBarAdvance
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
UINT ProgressDialog::ProgressBarAdvance(UINT iDelta)
{
    UINT iReturn;
    if ((UINT)-1 == iDelta)
...
/*  Function: ProgressDialog::ProgressBarSetPosition
    ...
    05/28/97    Initial creation.                                    BrianAu
*/
UINT ProgressDialog::ProgressBarSetPosition(UINT iPosition)
{
