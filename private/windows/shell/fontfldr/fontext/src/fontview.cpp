                                             ...
                                             LPARAM lParam )
{
    ...
    case WM_INITDIALOG:
       ...
       CFontView* prv = (CFontView*)lParam;
        ...
        ExtractIconEx( TEXT( "SHELL32.DLL" ), IDI_X_LINK - 1, &hIcon, &hIconSmall, 1 );
...
#undef IDC_NUMITEMS
        ...
        SetWindowPos(prv->m_hwndCombo, prv->m_hwndList, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE);
                                          ...
                                          HWND FAR* phWnd )
{
...

    {
        ...
        if (NULL == g_hkcuExplorer)
            RegOpenKeyEx(HKEY_CURRENT_USER, REGSTR_PATH_EXPLORER, 0, KEY_READ, &g_hkcuExplorer);
