...
INT_PTR APIENTRY InstallPSDlg( HWND hDlg, UINT nMsg, WPARAM wParam, LPARAM lParam )
{
    ...
    case WM_INITDIALOG:
...

        {
            ...
            FormatMessage(FORMAT_MESSAGE_FROM_STRING | FORMAT_MESSAGE_ARGUMENT_ARRAY, szFormat, 0, 0, szTemp, ARRAYSIZE(szTemp), (va_list *)args);
        }
                             ...
                             BOOL   bInFontsDir )   // Files in fonts dir?
{
            ...
            == ERROR_SUCCESS )
    {
        ...
        lstrcpy( szTemp2, szDesc );
        RemoveDecoration( szTemp2, TRUE );
        if( RegSetValueEx( hkey, szTemp2, 0L, REG_MULTI_SZ, (LPBYTE) szTemp, dwSize ) != ERROR_SUCCESS )
        {
            goto WriteRegError;
        }
...
void STDCALL Progress( short PercentDone, void* UniqueValue )
{
    ...
    if( !bProgMsgDisplayed )
    {
        ...
        FormatMessage(FORMAT_MESSAGE_FROM_STRING | FORMAT_MESSAGE_ARGUMENT_ARRAY, szTemp2, 0, 0, szTemp, ARRAYSIZE(szTemp), (va_list *)args);
