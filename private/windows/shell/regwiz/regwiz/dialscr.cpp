...
BOOL DialupHelperClass::InvokeDialupSettings()
{
    ...
    **/
    ...
    fProcessStatus = CreateProcess(NULL, szCmdLine, NULL, NULL, FALSE, CREATE_DEFAULT_ERROR_MODE | CREATE_NEW_PROCESS_GROUP | NORMAL_PRIORITY_CLASS, NULL, NULL, &si, &pi);
...
DWORD  DialupHelperClass::CreateRasDialThread()
{
    ...
    m_hThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE) DialThread, NULL, 0, &dwTID);
    if (NULL == m_hThread)
    {
