...
/*
Puts up the dialog box with the given ID, and maintains control until the user dismisses it.
The ID of the control used for the dismissal will be returned as the function result.

Note: pass NULL for hwndParent if there is to be no parent window for the message dialog.
*/
{
    iShowTitle = REPLACE_TITLE;
    if (dlgID == IDD_INPUTPARAM_ERR || dlgID == IDD_ANOTHERCOPY_ERROR) {
