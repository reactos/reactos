...
#if 0
// Debugging code for IsUserLocal - prints out the SIDs that IsUserLocal gets.
...
*/
{
    ...
    else if (!AllocateAndInitializeSid(&NTAuthority, 1, SECURITY_INTERACTIVE_RID, 0, 0, 0, 0, 0, 0, 0, &sidInteractive))
    {
    ...
    else
    {
        ...
        if (GetTokenInformation(hToken, TokenGroups, ptokgrp, dwInfoSize, &dwInfoSize))
        {
