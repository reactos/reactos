...
//  LINKEDLIST is an aid for division, it contains foreward and reverse links to a list of NUMBERS.
...
// List of useful constants for evaluation, note this list needs to be initialized.
...
//   Defines for setting up taylor series expansions for infinite precision functions.
