...
//  ARGUMENTS:  x PRAT representation of number to take the inverse hyperbolic sine of
...
//  ARGUMENTS:  x PRAT representation of number to take the inverse hyperbolic cose of
...
//  ARGUMENTS:  x PRAT representation of number to take the inverse hyperbolic tangent of
