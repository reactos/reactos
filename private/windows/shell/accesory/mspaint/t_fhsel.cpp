...
void CFreehandSelectTool::OnPaintOptions(CDC* pDC, const CRect& paintRect, const CRect& optionsRect)
{
    g_selectTool.OnPaintOptions(pDC, paintRect, optionsRect);
}


void CFreehandSelectTool::OnClickOptions(CImgToolWnd* pWnd, const CRect& optionsRect, const CPoint& clickPoint)
{
...
void CFreehandSelectTool::OnEndDrag(CImgWnd* pImgWnd, MTI* pmti)
{
    ...
    if (pmti->ptDown.x == pmti->pt.x &&  pmti->ptDown.y == pmti->pt.y)
    {
