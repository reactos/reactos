                      ...
                      int nCmdShow)
{
    ...
    GetPrivateProfileString (szSection, szPosition, TEXT(""), szParseStr, 80, szIniFile);
    ...
    GetPrivateProfileString (szSection, szFontFileKey, szDfltFontFile, FontStruct.lfFaceName, 20, szIniFile);
