...
HCONV InitSysConv (HWND hwnd,HSZ hszApp,HSZ hszTopic,BOOL fLocal )
{
HCONV hConv = 0L;
PDATAREQ pDataReq;
#if DEBUG
...
if (DdeQueryString(idInst, hszApp, atchApp, CharSizeOf(atchApp), CP_WINANSI) && DdeQueryString(idInst, hszTopic, atchTopic, CharSizeOf(atchTopic), CP_WINANSI))
   {
