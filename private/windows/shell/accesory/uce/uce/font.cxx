...
//    DWORD dwIndex;
    ...
    Success = RegOpenKeyEx(HKEY_CURRENT_USER, EudcReg, 0, KEY_READ, &hKeyEUDC);
...
//    for (dwIndex=0; ;dwIndex++)
    {
        ...
        /*
        Success = RegEnumKeyEx( hKeyEUDC, dwIndex, szName, &cbName, NULL, NULL, NULL, &ft );
        ...
        */
        Success = RegOpenKeyEx( hKeyEUDC, szName, 0, KEY_READ, &hKey );
        if(Success != ERROR_SUCCESS)
        {
          RegCloseKey(hKeyEUDC);
          return TRUE;
