...
* Additional information such as restrictions, limitations, or special algorithms used if they are externally visible or effect proper use of the module.
*/
...
BOOL GetBitmapInfo(HWND hWnd)
{
   ...
   if (!(hHeader = GlobalAlloc(GHND, sizeof(BITMAPINFOHEADER) + 256L * sizeof(RGBQUAD))))
       return FALSE;
