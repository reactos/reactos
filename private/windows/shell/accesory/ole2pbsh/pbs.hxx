...
public:
    static LPTRAY Create(HINSTANCE hinst, HWND hwndParent, HWND hwndNotify, int iChild);
...
{
public:
    static LPTOOLTRAY Create(HINSTANCE hinst, HWND hwndParent, HWND hwndNotify, int iChild);
...
{
public:
    static LPCOLORTRAY Create(HINSTANCE hinst, HWND hwndParent, HWND hwndNotify, int iChild);
