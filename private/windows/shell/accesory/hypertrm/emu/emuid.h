...
// Interestingly, the RC compiler won't do integer math on RCDATA indentifiers so I have to hard code the numbers. 
// Actually, its worse than that, it can't even read 0x000 format numbers! 
// They have to be decimal.    Stupid!!!
