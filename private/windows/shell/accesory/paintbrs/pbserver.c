...
*/
OLESTATUS FAR PASCAL SrvrOpen(LPOLESERVER lpolesrvr, LHSERVERDOC lhdoc, POLESTR lpOLEdocname, LPOLESERVERDOC FAR *lplpoledoc)
{
    LPTSTR lpDocName;
    ...
    if (!(*lplpoledoc = (LPOLESERVERDOC)CreateDocFromFile((PPBSRVR)lpolesrvr, lpDocName, lhdoc, lpDocName))) {
...
OLESTATUS FAR PASCAL SrvrCreate(LPOLESERVER lpolesrvr, LHSERVERDOC lhdoc, POLESTR lpclassname, POLESTR lpdocname, LPOLESERVERDOC FAR *lplpoledoc)
{
    LPTSTR lpDocName;
    ...
    if (!(*lplpoledoc = (LPOLESERVERDOC)CreateNewDoc((PPBSRVR)lpolesrvr, lhdoc, lpDocName))){
        FreeOleString(lpDocName);
        DB_OUT("ERR SrvrCreate\n");
...
OLESTATUS FAR PASCAL SrvrCreateFromTemplate(LPOLESERVER lpolesrvr, LHSERVERDOC lhdoc, POLESTR lpclassname, POLESTR lpOLEdocname, POLESTR lpOLEtemplatename, LPOLESERVERDOC FAR *lplpoledoc)
{
    PPBDOC    pdoc;
