 ...
 * Start from one char after the beginning of the current selection if we are repeating a search.
 * If not found, search continues through the text in the consecutive cards.
 * If still not found, search continues from the beginning of the text in the current card. If still not found, then report failure.
*/
