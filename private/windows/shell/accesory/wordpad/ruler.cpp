...
// This source code is only intended as a supplement to the Microsoft Foundation Classes Reference
// and related electronic documentation provided with the library.
// See these sources for detailed information regarding the Microsoft Foundation Classes product.
...
void CRulerBar::DrawFace(CDC& dc)
{
    ...
    // Small fixup to account for the fact that the left border needs to merge with the window below the ruler.
