...
STDAPI DllRegisterServer(void)
{
    ...
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("CLSID\\{B222AAAA-8813-11cf-A54D-080036F12502}"), NULL, "", REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKeyCLSID, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    ...
    if (RegCreateKeyEx(hKeyCLSID, _T("DefaultIcon"), NULL, "", REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKeyInproc32, &dwDisposition)!=ERROR_SUCCESS)
    {
        RegCloseKey(hKeyCLSID);
        return E_UNEXPECTED;
    }
    ...
    //    @="NetClipFile"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T(".{B222AAAA-8813-11cf-A54D-080036F12502}"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    ...
    //    @="NetClipFile"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T(".{B222AAAA-8813-11cf-A54D-080036F12502}\\ShellNew"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    lstrcpy(szValue, _T(""));
    ...
    //    @="Remote Clipboard"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    ...
    //    @="{B222AAAA-8813-11cf-A54D-080036F12502}"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\CLSID"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    ...
    //    @="NetClipMenu"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\shellex\\ContextMenuHandlers"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    ...
    //    @="{B222AAAA-8813-11cf-A54D-080036F12502}"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\shellex\\ContextMenuHandlers\\NetClipMenu"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    lstrcpy(szValue, _T("{B222AAAA-8813-11cf-A54D-080036F12502}"));
    ...
    //    @="%1"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\DefaultIcon"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    ...
    //    @="{B222AAAA-8813-11cf-A54D-080036F12502}"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\shellex\\DropHandler"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    lstrcpy(szValue, _T("{B222AAAA-8813-11cf-A54D-080036F12502}"));
    ...
    //    @="%1"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\shellex\\IconHandler"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    lstrcpy(szValue, _T("{B222AAAA-8813-11cf-A54D-080036F12502}"));
    ...
    if (RegCreateKeyEx(HKEY_LOCAL_MACHINE, _T("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Shell Extensions\\Approved"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
    lstrcpy(szValue, _T("Remote Clipboard"));
    ...
    //    @="netclip.exe"
    if (RegCreateKeyEx(HKEY_CLASSES_ROOT, _T("NetClipFile\\shell\\open\\command"), NULL, _T(""), REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition)!=ERROR_SUCCESS)
    {
        return E_UNEXPECTED;
    }
