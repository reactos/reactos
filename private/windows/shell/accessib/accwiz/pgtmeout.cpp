...
CAccessTimeOutPg::CAccessTimeOutPg(LPPROPSHEETPAGE ppsp) : WizardPage(ppsp, IDS_WIZACCESSTIMEOUTTITLE, IDS_WIZACCESSTIMEOUTSUBTITLE)
{
...
CAccessTimeOutPg::~CAccessTimeOutPg(VOID)
{
...
LRESULT CAccessTimeOutPg::OnInitDialog(HWND hwnd, WPARAM wParam, LPARAM lParam)
{
...
LRESULT CAccessTimeOutPg::OnCommand(HWND hwnd, WPARAM wParam, LPARAM lParam)
{
    LRESULT lResult = 1;
...
LRESULT CAccessTimeOutPg::OnPSN_WizNext(HWND hwnd, INT idCtl, LPPSHNOTIFY pnmh)
{
