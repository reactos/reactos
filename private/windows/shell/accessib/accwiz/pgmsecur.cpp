...
CMouseCursorPg::CMouseCursorPg(LPPROPSHEETPAGE ppsp) : WizardPage(ppsp, IDS_MSEWIZMOUSECURSORTITLE, IDS_MSEWIZMOUSECURSORSUBTITLE)
{
...
CMouseCursorPg::~CMouseCursorPg(VOID)
{

}


LRESULT CMouseCursorPg::OnInitDialog(HWND hwnd, WPARAM wParam, LPARAM lParam)
{
...
LRESULT CMouseCursorPg::OnCommand(HWND hwnd, WPARAM wParam, LPARAM lParam)
{
    LRESULT lResult = 1;
