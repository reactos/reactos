...
INT_PTR CALLBACK EditStringValueDlgProc(HWND hWnd, UINT Message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case IDOK:
            ...
            lpEditValueParam->cbValueData = sizeof(TCHAR) * ((UINT) SendDlgItemMessage(hWnd, IDC_VALUEDATA, WM_GETTEXTLENGTH, 0, 0) + 1);
            GetDlgItemText(hWnd, IDC_VALUEDATA, (PTSTR) lpEditValueParam->pValueData, MAXDATA_LENGTH - 1);
            //  FALL THROUGH
        case IDCANCEL:
        ...
        break;
    case WM_HELP:
        WinHelp(((LPHELPINFO) lParam)->hItemHandle, g_pHelpFileName, HELP_WM_HELP, (ULONG_PTR) s_EditStringValueHelpIDs);
        break;
    case WM_CONTEXTMENU:
        WinHelp((HWND) wParam, g_pHelpFileName, HELP_CONTEXTMENU, (ULONG_PTR) s_EditStringValueHelpIDs);
        break;
    default:
        return FALSE;
    }
