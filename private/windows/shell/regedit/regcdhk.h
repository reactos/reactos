...
//  TRUE if registry operation should be applied to the entire registry or to only start at g_SelectedPath.
...
UINT_PTR CALLBACK RegCommDlgHookProc(HWND hWnd, UINT Message, WPARAM wParam, LPARAM lParam);
