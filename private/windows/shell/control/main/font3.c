...
// We are installing font
    ...
    lRet = RegOpenKeyEx (HKEY_LOCAL_MACHINE, szFontsKey, 0, KEY_READ | KEY_WRITE, &hkey);
...
BOOL NextDropFont (WORD wCount, HANDLE *lphDrop, LPTSTR szDir, LPTSTR szFile, LPTSTR szDesc)
{
    LPTSTR lpTemp;
...
/* Create Ini file mapping */
    ...
    RegOpenKeyEx( HKEY_LOCAL_MACHINE , WIN_INI_KEY , 0 , KEY_ALL_ACCESS , &hKeyMap);
    RegSetValueEx( hKeyMap , szKey , 0 , REG_SZ , szData , ByteCountOf(lstrlen(szData) + 1));
    RegCloseKey( hKeyMap );
...
/* Create key */
    ...
    RegCreateKeyEx( HKEY_LOCAL_MACHINE , szKey , 0 , NULL , 0 , KEY_ALL_ACCESS , NULL , &hKey , &dwRet);
...
/* Install bitmap font */
    ...
    /* Check the key is "Mode" ? */
        ...
        /* Write Mode information into registry */
            ...
            RegSetValueEx( hKey , szToken , 0 , REG_SZ , szData , ByteCountOf(lstrlen(szData) + 1));
    ...
    /* Now , pbNow point the information of Build font file */
        ...
        /* Write registry */
            RegSetValueEx( hKey , szData , 0 , REG_SZ , szToken , ByteCountOf(lstrlen(szToken) + 1));
            break;
        }
        case TT_INSTALL_FAIL :
        case TT_INSTALL_CANCEL :
...
/* Create value name */
   ...
   RegOpenKeyEx( HKEY_LOCAL_MACHINE , WIN_INI_KEY , 0 , KEY_ALL_ACCESS , &hKey);
...
/* Create key name */
   ...
   RegOpenKeyEx( HKEY_LOCAL_MACHINE , szKey , 0 , KEY_ALL_ACCESS , &hKey);
