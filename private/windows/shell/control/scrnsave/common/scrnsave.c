...
// This window procedure takes care of important stuff before calling the consumer's ScreenSaverProc.
// This helps to prevent us from getting hosed by wacky consumer code.
