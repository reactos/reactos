...
LRESULT APIENTRY ScreenSaverProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        if (!fChildPreview) {
             ...
             */
            hwndLogon = CreateWindowEx( WS_EX_TOPMOST, TEXT("LOGON"), NULL, WS_VISIBLE | WS_POPUP, 50, 50, cxhwndLogon, cyhwndLogon, hMainWindow, NULL, hInst, NULL);
    ...
    case WM_USER:
        ...
        SetWindowPos(hwndLogon, NULL, 0, 0, 0, 0, SWP_SHOWWINDOW | SWP_NOSIZE | SWP_NOMOVE | SWP_NOZORDER);
        break;
    case WM_PAINT:
...
BOOL APIENTRY ScreenSaverConfigureDialog(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    TCHAR ach1[256];
    TCHAR ach2[256];
