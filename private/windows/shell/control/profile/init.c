...
BOOL CheckProfileType (void)
{
    ...
    lResult = RegOpenKeyEx (HKEY_CURRENT_USER, szProfileRegInfo, 0, KEY_ALL_ACCESS, &hKey);
    ...
    lResult = RegQueryValueEx (hKey, szProfileType, NULL, &dwType, (LPBYTE) szTempBuffer, &dwMaxBufferSize);
