...
BOOL CreateLink(LPWIZDATA lpwd)
{
    ...
    if (lpwd->lpszOriginalName)
    {
        ...
        // Now get rid of this in case we fail later and then re-enter this routine later.
...
ExitNoFree:
    ...
    {
        ShellMessageBox(hInstance, lpwd->hwnd, MAKEINTRESOURCE(IDS_NOSHORTCUT), 0, MB_OK | MB_ICONEXCLAMATION);
    }
