...
Abstract:
    This module contains the class factory implmentation for the published app query form.
...
// IUnknown
STDMETHODIMP CPublishedApplicationQueryFormClassFactory::QueryInterface(REFIID riid, PVOID *ppvInterface)
/*++
Routine Description:
...
STDMETHODIMP_(ULONG) CPublishedApplicationQueryFormClassFactory::AddRef(VOID)
/*++
Routine Description:
...
STDMETHODIMP_(ULONG) CPublishedApplicationQueryFormClassFactory::Release(VOID)
/*++
Routine Description:
...
// IClassFactory
STDMETHODIMP CPublishedApplicationQueryFormClassFactory::CreateInstance(IUnknown *pUnkOuter, REFIID riid, PVOID * ppvInterface)
/*++
Routine Description:
...
STDMETHODIMP CPublishedApplicationQueryFormClassFactory::LockServer(BOOL fLock)
/*++
Routine Description:
    This is the LockServer function for the class factory.  It doesn't do anything.
Arguments:
