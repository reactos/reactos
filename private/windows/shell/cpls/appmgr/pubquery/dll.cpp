...
Abstract:
    This module contains the dll entrypoints for the published app query form.
...
STDAPI_(BOOL) DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID Reserved)
/*++
Routine Description:
...
/*++
Routine Description:
    This function returns the class factory of the published application query form.
Arguments:
