...
// IUnknown
STDMETHODIMP CPublishedApplicationQuery::QueryInterface(REFIID riid, PVOID *ppvInterface)
/*++
Routine Description:
    This is the query interface function for the query.
    We don't use the standard query interface, because this lets us construct the interfaces on the fly
Arguments:
...
STDMETHODIMP_(ULONG) CPublishedApplicationQuery::AddRef(VOID)
/*++
Routine Description:
...
STDMETHODIMP_(ULONG) CPublishedApplicationQuery::Release(VOID)
/*++
Routine Description:
