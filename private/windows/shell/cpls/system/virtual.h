...
BOOL APIENTRY VirtualMemDlg(IN HWND hDlg, IN UINT message, IN DWORD wParam, IN LONG lParam);
BOOL VirtualInitStructures(void);
void VirtualFreeStructures(void);
INT VirtualMemComputeAllocated(IN HWND hWnd);
...
INT GetFreeSpaceMB(IN INT iDrive);
