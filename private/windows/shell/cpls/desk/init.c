...
// Marks code that will need to be modified if this module is ever incorporated into MAIN.CPL instead of being a separate applet.
#define NOTINMAIN
...
LONG APIENTRY CPlApplet(HWND  hwnd, WORD  message, DWORD wParam, LONG  lParam)
{
    LPCPLINFO lpCPlInfo;
