...
INT_PTR CALLBACK SaveAsDlgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
/*
*  PARAMETERS:
...
INT_PTR CALLBACK PowerSchemeDlgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
/*
*  DESCRIPTION:
