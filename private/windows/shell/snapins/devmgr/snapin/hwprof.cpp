...
BOOL CHwProfileList::GetFirst(CHwProfile** pphwpf, PVOID&  Context)
{
    ASSERT(pphwpf);
...
BOOL CHwProfileList::GetNext(CHwProfile** pphwpf, PVOID&  Context)
{
    ASSERT(pphwpf);
...
BOOL CHwProfileList::GetCurrentHwProfile(CHwProfile** pphwpf)
{
    ASSERT(pphwpf);
...
ULONG CHwProfileList::IndexToHwProfile(int HwProfileIndex)
{
...
CHwProfile::CHwProfile(int Index, PHWPROFILEINFO phwpfInfo, CDevice* pDevice, DWORD Flags)
{
    m_Index = Index;
