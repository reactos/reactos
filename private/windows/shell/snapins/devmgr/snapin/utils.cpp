...
BOOL CSafeRegistry::Open(HKEY hKeyAncestor, LPCTSTR KeyName, REGSAM Access)
{
    DWORD LastError;
    ...
    )
{
    ...
    DWORD Disposition;
    DWORD LastError;
    LastError = ::RegCreateKeyEx(hKeyAncestor, KeyName, 0, TEXT(""), Options, Access, pSecurity, &m_hKey, &Disposition);
    SetLastError(LastError);
...
BOOL CSafeRegistry::SetValue(LPCTSTR ValueName, DWORD Type, const PBYTE pData, DWORD DataLen)
{
    ASSERT(m_hKey);
    DWORD LastError;
