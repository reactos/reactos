...
int WINAPI DevicePropertiesA(HWND hwndParent, LPCSTR MachineName, LPCSTR DeviceID, BOOL ShowDeviceTree);
int  WINAPI DevicePropertiesW(HWND hwndParent, LPCWSTR MachineName, LPCWSTR DeviceID, BOOL ShowDeviceTree);
...
UINT WINAPI DeviceProblemTextA(HMACHINE hMachine, DEVNODE DevNode, ULONG ProblemNumber, LPSTR Buffer, UINT   BufferSize);
UINT WINAPI DeviceProblemTextW(HMACHINE hMachine, DEVNODE DevNode, ULONG ProblemNumber, LPWSTR Buffer, UINT   BufferSize);
...
void ReportCmdLineError(HWND hwndParent, int  ErrorStringID, LPCTSTR Caption = NULL);
BOOL AddPageCallback(HPROPSHEETPAGE hPage, LPARAM lParam);
int PropertyRunDeviceTree(HWND hwndParent, LPCTSTR MachineName, LPCTSTR DeviceID);
int DeviceProperties(HWND hwndParent, LPCTSTR MachineName, LPCTSTR DeviceID, BOOL ShowDeviceTree);
...
int WINAPI DeviceTroubleshootingA(HWND hwndParent, LPCSTR  MachineName, LPGUID  pClassGuid, LPCSTR  DeviceId);
int WINAPI DeviceTroubleshootingW(HWND hwndParent, LPCWSTR MachineName, LPGUID  pClassGuid, LPCWSTR DeviceId);
int WINAPI DeviceTroubleshooting(HWND hwndParent, LPCTSTR MachineName, LPGUID  pClassGuid, LPCTSTR DeviceId);
int DeviceAdvancedPropertiesA(HWND hwndParent, LPCSTR MachineName, LPCSTR DeviceId);
int DeviceAdvancedPropertiesW(HWND hwndParent, LPCWSTR MachineName, LPCWSTR DeviceId);
int DeviceAdvancedProperties(HWND hwndParent, LPCTSTR MachineName, LPCTSTR DeviceId);
int WINAPI DeviceProblemWizardA(HWND      hwndParent, LPCSTR    MachineName, LPCSTR    DeviceId);
int WINAPI DeviceProblemWizardW(HWND    hwndParent, LPCWSTR MachineName, LPCWSTR DeviceId);
...
CTString::CTString(LPCWSTR pWString)
{
    m_pTString = NULL;
    m_Allocated = FALSE;
#ifdef UNICODE
...
CTString::CTString(LPCSTR pAString)
{
    m_pTString = NULL;
    m_Allocated = FALSE;
#ifndef UNICODE
