...
** CopyLZFile() were intended for different purposes, but they were confused and misused so much they were made identical.
*/
...
LONG  APIENTRY LZCopy(HFILE doshSource, HFILE doshDest)
{
   ...
   FreeGlobalBuffers(pLZI);// Free global buffers.
   return(lRetVal);
}