...
STDMETHODIMP CShare::QueryInterface(IN REFIID riid, OUT LPVOID* ppvObj)
{
...
STDMETHODIMP CShareCopyHook::QueryInterface(IN REFIID riid, OUT LPVOID* ppvObj)
{
...
STDMETHODIMP_(ULONG) CShareCopyHook::AddRef(VOID)
{
    InterlockedIncrement((LONG*)&g_ulcInstancesShare);
    InterlockedIncrement((LONG*)&_uRefs);
...
STDMETHODIMP_(ULONG) CShareCopyHook::Release(VOID)
{
    InterlockedDecrement((LONG*)&g_ulcInstancesShare);
    ULONG cRef = InterlockedDecrement((LONG*)&_uRefs);
...
STDAPI DllCanUnloadNow(VOID)
{
    ...
    if (0 == g_ulcInstancesShare && 0 == g_ulcInstancesShareCopyHook && 0 == g_NonOLEDLLRefs)
    {
        return S_OK;
    }
    else
