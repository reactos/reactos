...

{
    ...
    if (NT_SUCCESS(Status)) {
        ...
        UserClassesString.MaximumLength = UsersHive.Length + sizeof(REG_USER_CLASSES_PREFIX) + sizeof(REG_USER_CLASSES_SUFFIX);
        ...
        if (UserClassesString.Buffer) {
            ...
            if (NT_SUCCESS(Status)) {
                Status = RtlAppendUnicodeToString(&UserClassesString, REG_USER_CLASSES_SUFFIX);
            }
            ...
            if (NT_SUCCESS(Status)) {
                ...
                InitializeObjectAttributes(
                    ...
                    NULL);
                Status = NtOpenKey(phkResult, samDesired, &Obja);
            }
        } else {
