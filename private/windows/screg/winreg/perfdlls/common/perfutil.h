...
Abstract:
    This file supports routines used to parse and create Performance Monitor Data Structures.
    It actually supports Performance Object types with multiple instances
...
// performance data instance (PERF_INSTANCE_DEFINITION) as described in winperf.h
...
#define REALLOCMEM(heap, flags, pointer, newsize) HeapReAlloc (heap, flags, pointer, newsize)
