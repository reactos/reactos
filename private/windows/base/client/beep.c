...
VOID NotifySoundSentry(VOID)
{
...
#else
    BASE_API_MSG m;
    PBASE_SOUNDSENTRY_NOTIFICATION_MSG e = (PBASE_SOUNDSENTRY_NOTIFICATION_MSG)&m.u.SoundSentryNotification;
    ...
    if (e->VideoMode == 0) {
        CsrClientCallServer((PCSR_API_MSG)&m, NULL, CSR_MAKE_API_NUMBER( BASESRV_SERVERDLL_INDEX, BasepSoundSentryNotification ), sizeof( *e ));
    }
#endif
}