...
NTSTATUS CsrBasepCreateProcess(PBASE_CREATEPROCESS_MSG a)
{
    ...
    CsrClientCallServer( (PCSR_API_MSG)&m, NULL, CSR_MAKE_API_NUMBER( BASESRV_SERVERDLL_INDEX, BasepCreateProcess), sizeof( m.u.CreateProcess ));
