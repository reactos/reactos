...
BOOL SCHSetKeyParam(IN Context_t *pContext, IN Key_t *pKey, IN DWORD dwParam, IN PBYTE pbData);
BOOL SCHGetKeyParam(Key_t *pKey, DWORD dwParam, PBYTE pbData);
BOOL SChGenMasterKey(Key_t *pKey, PSCH_HASH pSChHash);
BOOL SecureChannelDeriveKey(Hash_t *pHash, ALG_ID Algid, DWORD dwFlags, HCRYPTKEY *phKey);
