...
INT W32EnumFontFunc(LPENUMLOGFONT pEnumLogFont, LPNEWTEXTMETRIC pNewTextMetric, INT nFontType, PFNTDATA pFntData)
{
    INT    iReturn;
    PARM16 Parm16;
    ...
    //  ORin DEVICE_FONTTYPE bit if the fonttype is truetype and  the Compataibility flag GACF_CALLTTDEVICE is set.
