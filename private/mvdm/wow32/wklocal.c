...
ULONG FASTCALL WK32LocalAlloc(PVDMFRAME pFrame)
{
    ...
    ul = GETHLOCAL16(LocalAlloc(WORD32(parg16->f1), WORD32(parg16->f2)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalCompact(PVDMFRAME pFrame)
{
    ...
    ul = GETWORD16(LocalCompact(WORD32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalFlags(PVDMFRAME pFrame)
{
    ...
    ul = GETWORD16(LocalFlags(HLOCAL32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalFree(PVDMFRAME pFrame)
{
    ...
    ul = GETHLOCAL16(LocalFree(HLOCAL32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalHandle(PVDMFRAME pFrame)
{
    ...
    ul = GETHLOCAL16(LocalHandle((LPSTR) WORD32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
#ifdef API16
    ul = GETBOOL16(LocalInit(WORD32(parg16->f1), WORD32(parg16->f2), WORD32(parg16->f3)));
#else
    ul = 0;
#endif
...
ULONG FASTCALL WK32LocalLock(PVDMFRAME pFrame)
{
    ...
    ul = GETNPSTRBOGUS(LocalLock(HLOCAL32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
#ifdef API16
    ul = GETPROC16(LocalNotify(PROC32(parg16->f1)));
#else
    ul = 0;
#endif
...
ULONG FASTCALL WK32LocalReAlloc(PVDMFRAME pFrame)
{
    ...
    ul = GETHLOCAL16(LocalReAlloc(HLOCAL32(parg16->f1), WORD32(parg16->f2), WORD32(parg16->f3)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalShrink(PVDMFRAME pFrame)
{
    ...
    ul = GETWORD16(LocalShrink(HLOCAL32(parg16->f1), WORD32(parg16->f2)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalSize(PVDMFRAME pFrame)
{
    ...
    ul = GETWORD16(LocalSize(HLOCAL32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}
...
ULONG FASTCALL WK32LocalUnlock(PVDMFRAME pFrame)
{
    ...
    ul = GETBOOL16(LocalUnlock(HLOCAL32(parg16->f1)));
    FREEARGPTR(parg16);
    RETURN(ul);
}