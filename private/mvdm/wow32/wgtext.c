...
ULONG FASTCALL WG32ExtTextOut(PVDMFRAME pFrame)
{
    ...
    ul = GETBOOL16(ExtTextOut(HDC32(parg16->f1), INT32(parg16->f2), INT32(parg16->f3), (WORD32(parg16->f4) & (ETO_CLIPPED|ETO_OPAQUE)), &t5, pstr6, WORD32(parg16->f7), (LPINT)p8));
...
ULONG FASTCALL WG32GetTextExtent(PVDMFRAME pFrame)
{
    ...
    if (GETDWORD16(GetTextExtentPoint(HDC32(parg16->f1), pstr2, INT32(parg16->f3), &size4)))
    {
...
ULONG FASTCALL WG32GetTextMetrics(PVDMFRAME pFrame)
{
    ...
    ul = GETBOOL16(GetTextMetrics(HDC32(parg16->f1), &t2));
