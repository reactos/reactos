...
typedef SQLRETURN                       (SQL_API *td_SQLSetStmtOption)(SQLHSTMT        hstmt, SQLUSMALLINT    fOption, SQLUINTEGER     vParam);
typedef SQLRETURN                       (SQL_API *td_SQLExecDirect)(SQLHSTMT        hstmt, SQLCHAR FAR     *szSqlStr, SQLINTEGER      cbSqlStr);
typedef SQLRETURN                       (SQL_API *td_SQLFetch)(SQLHSTMT        hstmt);
typedef SQLRETURN                       (SQL_API *td_SQLFreeConnect)(SQLHDBC         hdbc);
typedef SQLRETURN                       (SQL_API *td_SQLFreeEnv)(SQLHENV         henv);
typedef SQLRETURN                       (SQL_API *td_SQLFreeStmt)(SQLHSTMT        hstmt, SQLUSMALLINT    fOption);
typedef SQLRETURN                       (SQL_API *td_SQLTransact)(SQLHENV         henv, SQLHDBC         hdbc, SQLUSMALLINT    fType);
...
typedef SQLRETURN                       (SQL_API *td_SQLAllocConnect)(SQLHENV         henv, SQLHDBC FAR     *phdbc);
typedef SQLRETURN                       (SQL_API *td_SQLAllocEnv)(SQLHENV FAR     *phenv);
typedef SQLRETURN                       (SQL_API *td_SQLAllocStmt)(SQLHDBC         hdbc, SQLHSTMT FAR    *phstmt);
...
typedef SQLRETURN                       (SQL_API *td_SQLDisconnect)(SQLHDBC         hdbc);
    ...
    public:
        ...
        SQLRETURN                   SQLError(SQLHENV henv, SQLHDBC hdbc, SQLHSTMT hstmt, SQLCHAR FAR *szSqlState,
                                             ...
                                             SQLSMALLINT cbErrorMsgMax, SQLSMALLINT FAR *pcbErrorMsg)
                                                { return((*fp_SQLError)(henv, hdbc, hstmt, szSqlState, pfNativeError, szErrorMsg, cbErrorMsgMax, pcbErrorMsg)); }
        SQLRETURN                   SQLGetData(SQLHSTMT hstmt, SQLUSMALLINT icol, SQLSMALLINT fCType,
                                               SQLPOINTER rgbValue, SQLINTEGER cbValueMax, SQLINTEGER FAR *pcbValue)
                                                { return((*fp_SQLGetData)(hstmt, icol, fCType, rgbValue, cbValueMax, pcbValue)); }
