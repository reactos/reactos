...
PSUBAUTHENTICATION_DLL ReferenceSubAuth (IN ULONG DllNumber, OUT PNTSTATUS SubStatus)
{
    LONG RegStatus;
    ...
    *SubStatus = STATUS_SUCCESS;
    ...
    if ( SubAuthenticationDll == NULL ) {
        ...
        *SubStatus = RtlIntegerToChar(
        ...
        SubAuthenticationDll = RtlAllocateHeap(MspHeap, 0, sizeof(SUBAUTHENTICATION_DLL));
        if ( SubAuthenticationDll == NULL ) {
...
BOOLEAN Msv1_0SubAuthenticationPresent(IN ULONG DllNumber)
/*++
Routine Description:
