...
Abstract:
    This file contains the some of the machine independent portions of the execution model.
    The machine dependent portions are in other files.
...
DWORD64 SwGetModuleBase(LPVOID  lpvhpid, DWORD64 ReturnAddress)
{
    HLLI        hlli  = 0;
    HMDI        hmdi  = 0;
    LPMDI       lpmdi = NULL;
...
// TLS
XOSD InitTLS (HPRC hprc, HTHD hthd)
{
    LPPRC   lpprc = (LPPRC) LLLock ( hprc );
    LPTHD   lpthd = (LPTHD) LLLock ( hthd );
    ADDR    addr  = {0};
