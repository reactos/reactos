...
__inline BOOL Is64PtrSE(ULONG64 p64)
/*++
Description:
...
__inline void String32To64(PSTRING32 p32, PSTRING64 p64)
{
...
__inline void AnsiString32To64(PANSI_STRING32 p32, PANSI_STRING64 p64)
{
    p64->Length = p32->Length;
    p64->MaximumLength = p32->MaximumLength;
    COPYSE(p64, p32, Buffer);
...
__inline void UnicodeString32To64(PUNICODE_STRING32 p32, PUNICODE_STRING64 p64)
{
    p64->Length = p32->Length;
    p64->MaximumLength = p32->MaximumLength;
    COPYSE(p64, p32, Buffer);
...
__inline VOID ExceptionDebugInfo32To64(LPEXCEPTION_DEBUG_INFO32 e32, LPEXCEPTION_DEBUG_INFO64 e64)
{
...
__inline VOID ExceptionDebugInfo64To32(LPEXCEPTION_DEBUG_INFO64 e64, LPEXCEPTION_DEBUG_INFO32 e32)
{
...
__inline VOID CreateThreadDebugInfo32To64(LPCREATE_THREAD_DEBUG_INFO32 c32, LPCREATE_THREAD_DEBUG_INFO64 c64)
{
...
__inline VOID CreateThreadDebugInfo64To32(LPCREATE_THREAD_DEBUG_INFO64 c64, LPCREATE_THREAD_DEBUG_INFO32 c32)
{
...
__inline VOID CreateProcessDebugInfo32To64(LPCREATE_PROCESS_DEBUG_INFO32 c32, LPCREATE_PROCESS_DEBUG_INFO64 c64)
{
    c64->hFile = c32->hFile;
...
__inline VOID CreateProcessDebugInfo64To32(LPCREATE_PROCESS_DEBUG_INFO64 c64, LPCREATE_PROCESS_DEBUG_INFO32 c32)
{
    c32->hFile = c64->hFile;
...
__inline VOID ExitThreadDebugInfo32To64(LPEXIT_THREAD_DEBUG_INFO32 e32, LPEXIT_THREAD_DEBUG_INFO64 e64)
{
    e64->dwExitCode = e32->dwExitCode;
}


__inline VOID ExitThreadDebugInfo64To32(LPEXIT_THREAD_DEBUG_INFO64 e64, LPEXIT_THREAD_DEBUG_INFO32 e32)
{
...
__inline VOID ExitProcessDebugInfo32To64(LPEXIT_PROCESS_DEBUG_INFO32 e32, LPEXIT_PROCESS_DEBUG_INFO64 e64)
{
    e64->dwExitCode = e32->dwExitCode;
}


__inline VOID ExitProcessDebugInfo64To32(LPEXIT_PROCESS_DEBUG_INFO64 e64, LPEXIT_PROCESS_DEBUG_INFO32 e32)
{
    e32->dwExitCode = e64->dwExitCode;
}
...
__inline VOID LoadDllDebugInfo32To64(LPLOAD_DLL_DEBUG_INFO32 l32, LPLOAD_DLL_DEBUG_INFO64 l64)
{
    l64->hFile = l32->hFile;
...
__inline VOID LoadDllDebugInfo64To32(LPLOAD_DLL_DEBUG_INFO64 l64, LPLOAD_DLL_DEBUG_INFO32 l32)
{
    l32->hFile = l64->hFile;
...
__inline VOID UnloadDllDebugInfo32To64(LPUNLOAD_DLL_DEBUG_INFO32 u32, LPUNLOAD_DLL_DEBUG_INFO64 u64)
{
    u64->lpBaseOfDll = SE32To64(u32->lpBaseOfDll);
}


__inline VOID UnloadDllDebugInfo64To32(LPUNLOAD_DLL_DEBUG_INFO64 u64, LPUNLOAD_DLL_DEBUG_INFO32 u32)
{
...
__inline VOID OutputDebugStringInfo32To64(LPOUTPUT_DEBUG_STRING_INFO32 o32, LPOUTPUT_DEBUG_STRING_INFO64 o64)
{
...
__inline VOID OutputDebugStringInfo64To32(LPOUTPUT_DEBUG_STRING_INFO64 o64, LPOUTPUT_DEBUG_STRING_INFO32 o32)
{
...
__inline VOID RipInfo32To64(LPRIP_INFO32 r32, LPRIP_INFO64 r64)
{
...
__inline VOID RipInfo64To32(LPRIP_INFO64 r64, LPRIP_INFO32 r32)
{
...
__inline VOID DebugEvent32To64(LPDEBUG_EVENT32 d32, LPDEBUG_EVENT64 d64)
{
...
__inline VOID DebugEvent64To32(LPDEBUG_EVENT64 d64, LPDEBUG_EVENT32 d32)
{
...
__inline void Curdir32To64(PCURDIR32 p32, PCURDIR64 p64)
{
...
__inline void DriveLetterCurdir32To64(PRTL_DRIVE_LETTER_CURDIR32 p32, PRTL_DRIVE_LETTER_CURDIR64 p64)
{
    p64->Flags = p32->Flags;
    p64->Length = p32->Length;
...
__inline void UserProcessParameters32To64(PRTL_USER_PROCESS_PARAMETERS32 p32, PRTL_USER_PROCESS_PARAMETERS64 p64)
{
    int i;
...
__inline void LdrDataTableEntry32To64(PLDR_DATA_TABLE_ENTRY32 pLdr32, PLDR_DATA_TABLE_ENTRY64 pLdr64)
{
