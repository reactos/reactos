...
INT_PTR WINAPI DlgFindNext(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CONTEXTMENU:
        ...
        return TRUE;
    case WM_ACTIVATE:
        if (wParam != 0 && (HWND) lParam == hwndFrame && !frMem.firstFindNextInvoc && hwndActiveEdit) {
    ...
    case WM_COMMAND:
        ...
        case IDCANCEL:
            ...
            return TRUE;
        case IDOK:
            frMem.exitModelessFind = (!FindNext(hDlg, frMem.line, frMem.rightCol, FALSE, TRUE, FALSE) || frMem.allFileDone || frMem.hadError);
            return TRUE;
