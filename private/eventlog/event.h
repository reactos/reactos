...
Abstract:
    ...
    Contains the common data structures that should be put in one place in the tree.
...
// RPC definition of the SID structure.
// Note the use of the [size_is()] qualifier to specify the number of elements in the variable size imbedded SubAuthorityCount array at runtime.

// BUGBUG - This is stolen from samrpc.idl, and should really be placed in a common place for all to use.
