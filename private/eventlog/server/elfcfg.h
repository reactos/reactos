...
// Maximum size for the buffer that will read the key values from the registry.
...
#define     REG_EVENTLOG_NODE_PATH              L"\\Registry\\Machine\\System\\CurrentControlSet\\Services\\Eventlog"

//SS: start of changes for replicated event logging across the cluster
#define     REG_CLUSSVC_NODE_PATH              L"\\Registry\\Machine\\System\\CurrentControlSet\\Services\\ClusSvc"

//SS: end of changes for replicated event logging across the cluster

// String defines for the values for each of the configured pieces of information in the eventlog\logfiles node.
// These exist per logfile.
