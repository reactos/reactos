...
// The amount of time to wait for a DHCP response after a request has been sent.
...
#define DHCP_MESSAGE_FIXED_PART_SIZE (sizeof(DHCP_MESSAGE) - sizeof(OPTION))
#define DHCP_MIN_SEND_RECV_PK_SIZE   (DHCP_MESSAGE_FIXED_PART_SIZE + 64)
...
#ifndef CHICAGO
VOID DhcpPrintTrace(IN LPSTR Format, ...);
...
VOID
//extern "C"
DhcpPrintRoutine(IN DWORD DebugFlag, IN LPSTR Format, ...)
{
