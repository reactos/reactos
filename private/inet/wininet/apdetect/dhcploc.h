...
Abstract:
    This module contains various declarations for implementation specific "stuff".
...
// A block NT specific context information, appended the the DHCP work context block.
...
EXTERN HANDLE DhcpGlobalTerminateEvent;// To signal to stop the service.
EXTERN BOOL DhcpGlobalMultiHomedHost;// multi home flag.
...
// a named event that notifies the ip address changes to external apps.
