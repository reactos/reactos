...
HRESULT AddDOCExpandoProperty(BSTR bstrAttribName, IHTMLDocument2 *pDoc, IDispatch *pDispToAdd)
{
    HRESULT hr;
...
HRESULT STDMETHODCALLTYPE ExpandoDocument::QueryInterface(REFIID riid, void **ppv)
{
    *ppv = NULL;
...
ULONG STDMETHODCALLTYPE ExpandoDocument::AddRef()
{
    return InterlockedIncrement(&_refcount);
}

ULONG STDMETHODCALLTYPE ExpandoDocument::Release()
{
...
HRESULT STDMETHODCALLTYPE ExpandoDocument::GetTypeInfoCount(/* [out] */ UINT __RPC_FAR *pctinfo)
{
...
{
    return _dispatchImpl::Invoke(&s_dispatchinfoEXP, this, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
}


//// ISupportErrorInfo

HRESULT STDMETHODCALLTYPE ExpandoDocument::InterfaceSupportsErrorInfo(REFIID riid)
{
...
void ExpandoDocument::setErrorInfo(WCHAR * szDescription)
{
    _dispatchImpl::setErrorInfo(szDescription);
}


HRESULT STDMETHODCALLTYPE ExpandoDocument::get_url(/* [out][retval] */ BSTR __RPC_FAR *urlString)
{
    Assert(_bURL);
