    ...
    TRY
    {
        if (pRemoveNode)
        {
            ...
            TRY
            {
                ...
                _pDocument->NotifyListener(XML_REASON_NodeRemoved, XML_PHASE_DidEvent, pRemoveNode, this, pNodeBefore);
            }
            CATCH
            {
                // notify the listener that we failed to remove the node
                _pDocument->NotifyListener(XML_REASON_NodeRemoved, XML_PHASE_FailedToDo, pRemoveNode, this, pNodeBefore);
                Exception::throwAgain();
            }
            ENDTRY
        }
