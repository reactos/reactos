...
HRESULT FireEventThroughCP(DISPID dispid, PCPNODE pConnections, LONG_PTR *plSpinLock, ...);
HRESULT FireEventWithNoArgsThroughCP(DISPID dispid, PCPNODE pConnections, ULONG_PTR *plSpinLock);
void ReleaseCPNODEList(PCPNODE pRootNode);
HRESULT FireEventThroughInvoke0(VARIANT *pvarRes, IDispatch *pDisp, IDispatch *pSelf, ...);
