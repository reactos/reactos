...
public class XMLDSO extends Applet
{
    ...
    /**
     * The init method looks for a URL PARAM and loads this url if specified. 
     * Otherwise it looks for inline XML from inside the APPLET tag that created this XMLDSO object. 
     * It does this using the ID parameter of the APPLET tag to lookup the actual applet object in 
     * the page, using JSObject, an then getting the altHtml member of this object.  
     * Note: it is ok to not have a URL or any inline XML.
     */
    public void init()
    {   
        super.init();
