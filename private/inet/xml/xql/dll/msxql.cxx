...
EXTERN_C void Runtime_init()
{
    ...
    TlsInit();// init TLS storage manager
...
{
    ClearReferences();// free global references
    Base::checkZeroCountList();// delete any objects on the zero list now.
    TlsExit();// free TLS manager
