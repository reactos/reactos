...
*/
IfAction * IfAction::newIfAction(TemplateAction * tmpl, Element * e, bool fIsWhen)
{
...
void IfAction::execute(int state, Processor * xtl)
{
    VARIANT var;
...
void IfAction::compileQuery(Processor * xtl, String * language)
{
