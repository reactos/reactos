...
*/
void EvalAction::execute(int state, Processor * xtl)
{
    VARIANT var;
    HRESULT hr;
    String * text;
...
*/
bool EvalAction::compile(Processor * xtl, String * defaultLang)
{
