...
void CSafeControl::CloneBase(void *pvClone)
{
...
void CSafeControl::setSite(IUnknown* u)
{
...
void CSafeControl::getSite(REFIID riid, void** pUnk)
{
    if (!_pSite)
        *pUnk=null;
    else
...
void CSafeControl::SetBaseURLFromSite(IUnknown* pSite)
{
...
void CSafeControl::getSecureBaseURL()
{
    if (!_dwSafetyOptions)
    {
        return;
...
HRESULT CSafeControl::SetSecureBaseURLFromSite(IUnknown* pSite)
{
...
void CSafeControl::getInterfaceSafetyOptions(REFIID riid, DWORD *pdwSupportedOptions, DWORD *pdwEnabledOptions)
{
...
void CSafeControl::setInterfaceSafetyOptions(REFIID riid, DWORD dwOptionSetMask, DWORD dwEnabledOptions)
{
