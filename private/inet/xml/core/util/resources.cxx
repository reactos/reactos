...
Resources::FormatSystemMessage( long errorid )
{
    ...
    DWORD rc = ::FormatMessageA( FORMAT_MESSAGE_FROM_SYSTEM, NULL, errorid, MAKELANGID(LANG_NEUTRAL, SUBLANG_DEFAULT), // Default language
        buffer, size, NULL);
    ...
    if (rc <= 0)
    {
        ...
        rc = ::FormatMessageA( FORMAT_MESSAGE_FROM_HMODULE, h, errorid, MAKELANGID(LANG_NEUTRAL, SUBLANG_DEFAULT), // Default language
            buffer, size, NULL);
    }
    if (rc <= 0)
    {
