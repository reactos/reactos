...
__page_map_t * __cdecl __sbh_find_block(__sbh_heap_t * pheap, void *, __sbh_region_t **, __sbh_page_t **);
void      __cdecl __sbh_free_block(__sbh_heap_t * pheap, __sbh_region_t *, __sbh_page_t *, __page_map_t *);
...
int       __cdecl __sbh_resize_block(__sbh_region_t *, __sbh_page_t *, __page_map_t *, size_t);
