...
HRESULT __stdcall CClassFactory::QueryInterface(REFIID riid, void** ppv)
{
    STACK_ENTRY;
...
HRESULT __stdcall CClassFactory::CreateInstance(IUnknown *pUnkOuter, REFIID iid, void **ppvObj)
{
    STACK_ENTRY;
