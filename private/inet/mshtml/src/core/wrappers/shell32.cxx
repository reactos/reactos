...
UINT WINAPI ExtractIconExW(LPCWSTR lpszFile, int nIconIndex, HICON FAR *phiconLarge, HICON FAR *phiconSmall, UINT nIcons)
{
    static DYNPROC s_dynprocExtractIconExW = { NULL, &g_dynlibSHELL32, "ExtractIconExW" };
    ...
    return (*(UINT (APIENTRY *)(LPCWSTR, int, HICON FAR *, HICON FAR *, UINT))s_dynprocExtractIconExW.pfn)(lpszFile, nIconIndex, phiconLarge, phiconSmall, nIcons);
}

HICON WINAPI ExtractIconW(HINSTANCE hInst, LPCWSTR lpszExeFileName, UINT nIconIndex)
{
    static DYNPROC s_dynprocExtractIconW = { NULL, &g_dynlibSHELL32, "ExtractIconW" };
    ...
    return (*(HICON (APIENTRY *)(HINSTANCE, LPCWSTR, UINT))s_dynprocExtractIconW.pfn) (hInst, lpszExeFileName, nIconIndex);
}
...
{
    static DYNPROC s_dynprocFileDownload = { NULL, &g_dynlibSHDOCVW, "DoFileDownload" };
