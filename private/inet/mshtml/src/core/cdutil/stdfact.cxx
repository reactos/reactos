...
//  Notes:      Since class factories based on this class are global static objects, this method doesn't serve much purpose.
...
//  Synopsis:   Method of IClassFactory interface.
STDMETHODIMP CStaticCF::CreateInstance(IUnknown *pUnkOuter, REFIID iid, void **ppv)
{
    HRESULT hr;
    IUnknown *pUnk = 0;
...
//  Synopsis:   Method of IUnknown interface
STDMETHODIMP_(ULONG) CDynamicCF::AddRef()
{
    return ++_ulRefs;
}
...
//  Synopsis:   Method of IUnknown interface
STDMETHODIMP_(ULONG) CDynamicCF::Release()
{
    if (--_ulRefs == 0)
    {
...
STDMETHODIMP CStaticCF3::QueryInterface(REFIID iid, LPVOID FAR* ppv)
{
    *ppv = NULL;
...
STDMETHODIMP CStaticCF3::CreateInstance(IUnknown *pUnkOuter, REFIID iid, void **ppv)
{
...
STDMETHODIMP CStaticCF3::CreateInstanceWithContext(IUnknown *punkContext, IUnknown *pUnkOuter, REFIID iid, void **ppv)
{
    HRESULT hr;
    IUnknown *pUnk = 0;
