...
BOOL TagProhibitedContainer(ELEMENT_TAG tag1, ELEMENT_TAG tag2)
{
    ...
    return phpc1 && phpc1->_atagProhibitedContainers && IsEtagInSet(tag2, phpc1->_atagProhibitedContainers);
}
...
BOOL TagEndContainer(ELEMENT_TAG tag1, ELEMENT_TAG tag2)
{
    ...
    return phpc1 && phpc1->_atagEndContainers && IsEtagInSet(tag2, phpc1->_atagEndContainers);
}
...
BOOL TagHasNoEndTag(ELEMENT_TAG tag)
{
    ...
    return  !phpc || phpc->_scope == SCOPE_EMPTY  ||  !ptd || ptd->HasFlag( TAGDESC_NEVERSAVEEND );
}