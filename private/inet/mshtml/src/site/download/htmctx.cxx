...
//  Synopsis:   Listen to the beginning of OPTION tags and eat leading whitespace
HRESULT CHtmSelectParseCtx::BeginElement(CTreeNode **ppNodeNew, CElement *pel, CTreeNode *pNodeCur, BOOL fEmpty)
{
...
//  Synopsis:   Listen to the end of OPTION tags, sets up the space-eating for symmetry's sake
HRESULT CHtmSelectParseCtx::EndElement(CTreeNode **ppNodeNew, CTreeNode *pNodeCur, CTreeNode *pNodeEnd)
{
    HRESULT hr;
...
//  Synopsis:   Listen for the space context passing in text, forward it to the root
HRESULT CHtmSelectParseCtx::AddWord(CTreeNode *pNode, TCHAR *pch, ULONG cch, BOOL fAscii)
{
    HRESULT hr;
...
//  Synopsis:   Listen for the space context passing in space, forward a single space to the root
HRESULT CHtmSelectParseCtx::AddSpace(CTreeNode *pNode)
{
    HRESULT hr;
