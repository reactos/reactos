...
EXTERN_C const IID IID_ITextStory;
  ...
  interface  ITextStory : public IUnknown
    {
    public:
        virtual HRESULT  STDMETHODCALLTYPE GetLength(long __RPC_FAR *pcpMac ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE GetRunLimits(long cp , long __RPC_FAR *pcpFirst , long __RPC_FAR *pcpLim ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE GetPapLimits(long cp , long __RPC_FAR *pcpFirst , long __RPC_FAR *pcpLim ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE FetchText(long cp , wchar_t __RPC_FAR *pchBuffer , int cchBuffer , int __RPC_FAR *pcchFetch ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE FetchTextProperties(long cp , long propertyGroup , ITextPropertyList __RPC_FAR *__RPC_FAR *pptpl ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE IsNestedLayoutAtCp(DWORD dwCookieTP , long cp ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE GetNestedObjectMargins(DWORD dwCookieTP , long cp , RECT __RPC_FAR *rcMargins ) = 0;
        ...
        virtual HRESULT  STDMETHODCALLTYPE GetHtmlDoc(IHTMLDocument2 __RPC_FAR *__RPC_FAR *ppDoc ) = 0;
        virtual HRESULT  STDMETHODCALLTYPE GetCurrentElement(IHTMLElement __RPC_FAR *__RPC_FAR *ppElement ) = 0;
    };
