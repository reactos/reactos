...
CCodeLoad::BindToObject()
{
        ...
        pinfo->pchMimeType)                           // there is MimeType
    {
        ...
        if (!(pDoc->_dwLoadf & DLCTL_NO_DLACTIVEXCTLS))
        {
            ...
            hr =  THR(CoGetClassObjectFromURL(pinfo->clsid,
                        pinfo->pchSourceUrl,
                        pinfo->dwMajorVer,
                        pinfo->dwMinorVer,
                        pinfo->pchMimeType,
        ...
        else
        {
            ...
            if (pSafetyProvider) {
                ...
                hr = THR(CoGetClassObject(pinfo->clsid, CLSCTX_INPROC_SERVER | CLSCTX_INPROC_HANDLER | CLSCTX_LOCAL_SERVER, NULL, IID_IClassFactory, (void **)&pCF));
            }
        }
    }
    else
