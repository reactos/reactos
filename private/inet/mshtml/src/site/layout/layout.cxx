                           ...
                           DWORD  dwFlags)
{
    ...
    if (_pElementOwner == pElement)
    {
        ...
        else
        {
            ...
            GetRect(prcBound, dwFlags & RFE_SCREENCOORD ? COORDSYS_GLOBAL : COORDSYS_PARENT);
        }
...
//  Notes:
_htmlComponent CLayout::ComponentFromPoint(long x, long y)
{
    if (_pDispNode)
    {
        CPoint pt(x, y);
        _pDispNode->TransformPoint(&pt, COORDSYS_GLOBAL, COORDSYS_CONTAINER);
