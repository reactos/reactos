...
//  Synopsis:   Class deconstructor which releases the CDoc reference and decrements the object count
//  Returns:    no return value
...
//  Member:     TridentOSP::find(long iRowStart, long iColumn, VARIANT val, OSPFIND findflags, OSPCOMP compType, long *piRowFound)
//  Synopsis:   Unimplemented.
//  Returns:    HRESULT
HRESULT STDMETHODCALLTYPE
