...
HRESULT CRowPosition::FireRowPositionChange(DBREASON eReason, DBEVENTPHASE ePhase, BOOL fCantDeny, int *piProgress)
{
    ...
    for (;;)
    {
        aaidx = FindNextAAIndex(DISPID_A_ROWPOSITIONCHANGESINK, CAttrValue::AA_Internal, aaidx);
    ...
    for (i = 0; i != cRows; i++)
    {
        ...
        else
        {
            ...
            case (DBEVENTPHASE_ABOUTTODO):
                ...
                pCRP->_pRowset->GetData(pCRP->_hRow, pCRP->_hAccessorBookmark, &pCRP->_Bookmark);
                break;
