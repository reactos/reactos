...
//  Note:       If the dispidMember passed to Invoke is DISPID_UNKNOWN we'll return VT_EMPTY.
//               This allow VBScript/JavaScript to test isnull( ) or comparision to null.
HRESULT CElementCollectionBase::InvokeEx(
                DISPID          dispidMember,
                LCID            lcid,
                WORD            wFlags,
                DISPPARAMS *    pdispparams,
...
HRESULT CCollectionCache::GetDispID(long lIndex, BSTR bstrName, DWORD grfdex, DISPID *pid)
...
//              collection the returned dispid is DISPID_UNKNOWN with a result of S_OK. 
//              Then on the invoke if DISPID_UNKNOWN is encountered we'll return VT_EMPTY. 
//              This allow VBScript/JavaScript to test isnull( ) or comparision to null.
{
    HRESULT     hr = E_FAIL;
    long        lIdx = 0;
