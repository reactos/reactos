...
void CCellRangeParser::Normalize(LPCTSTR szRange)
{
    TCHAR       c, cAppnd;
    int         i;
...
BOOL CCellRangeParser::GetColumn(int *pnCurIndex, long *pnCol)
{
    int nVal;
...
BOOL CCellRangeParser::GetNumber(int *pnCurIndex, long *pnRow)
{
    int nVal;
  ...
  *pnRow = nVal - 1;// Adjust for the fact that first row is row 1 and return the value
