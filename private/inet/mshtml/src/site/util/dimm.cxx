...
HRESULT EnsureLoadedDIMM()
{
    ...
    {
        hr = CoCreateInstance(CLSID_CActiveIMM, NULL, CLSCTX_INPROC_SERVER, IID_IActiveIMMApp, (void**)&s_pActiveIMM);
    }
    else
    {
        hr = CoCreateInstance(CLSID_CActiveIMM, NULL, CLSCTX_INPROC_SERVER, IID_IActiveIMMAppPostNT4, (void**)&s_pActiveIMM);
    }
