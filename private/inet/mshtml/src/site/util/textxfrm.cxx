...
//    Note:     Will assert unless a transform is needed.  (This is for optimization.)
const TCHAR * TransformText(CStr &str, const TCHAR * pch, LONG cchIn, BYTE bTextTransform, TCHAR chPrev )
{
    HRESULT hr = S_OK;
