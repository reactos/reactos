...
RetrieveDocument(TCHAR *pchFileName, IDispatch *pDisp, CDocSvr **ppDoc)
{
    ...
    hr = THR(CoCreateInstance(CLSID_HTMLServerDoc, NULL, CLSCTX_INPROC_SERVER, IID_IUnknown, (void **)&pUnk));
    if (hr)
        goto Cleanup;
    ...
    *ppDoc = pDoc;
    ...
    if (!pDocSvrToClone)
    {
        ...
        hr = THR(CoCreateInstance(CLSID_HTMLServerDoc, NULL, CLSCTX_INPROC_SERVER, IID_IUnknown, (void **)&pUnk2));
        if (hr)
            goto Cleanup;
