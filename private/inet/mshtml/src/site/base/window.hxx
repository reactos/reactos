...
//  Purpose:    The screen object.  Referenced off the window object but implemented as a subobject of CDoc.
{
...
public:
    ...
    static const CLASSDESC                    s_classdesc;// Static members
};
...
//  Purpose:    The navigator object.  Referenced off the window object but implemented as a subobject of CDoc.
{
...
public:
    ...
    NV_DECLARE_TEAROFF_METHOD(GetMemberProperties, getmemberproperties, (DISPID id, DWORD grfdexFetch, DWORD *pgrfdex));
    NV_DECLARE_TEAROFF_METHOD(GetMemberName, getmembername, (DISPID id, BSTR *pbstrName));
    NV_DECLARE_TEAROFF_METHOD(GetNextDispID, getnextdispid, (DWORD grfdex, DISPID id, DISPID *prgid));
...
public:
    ...
    STDMETHOD(showModelessDialog)(BSTR strUrl, VARIANT * pvarArgIn, VARIANT * pvarOptions, IHTMLWindow2 ** ppDialog);
...
public:
    ...
    HRESULT FindProxy(IHTMLWindow2 *pWindowIn, BYTE *pbSID, DWORD cbSID, BOOL fTrust, IHTMLWindow2 **ppProxyOut);
    HRESULT AddTuple(IHTMLWindow2 *pWindow, BYTE *pbSID, DWORD cbSID, BOOL fTrust, IHTMLWindow2 *pProxy);
