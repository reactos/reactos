...
const CServer::CLASSDESC CDoc::s_classdesc =
{
    {                                            // _classdescBase
        ...
        SERVERDESC_ACTIVATEONDRAG | SERVERDESC_SUPPORT_DRAG_DROP | SERVERDESC_HAS_MENU | SERVERDESC_HAS_TOOLBAR,
...
CDoc::EnsureBackupUIHandler()
{
    ...
    hr = THR(CoCreateInstance(CLSID_DocHostUIHandler, NULL, CLSCTX_INPROC_SERVER, IID_IDocHostUIHandler, (void**)&_pBackupHostUIHandler));
   ...
   CDoc::GetActiveXSafetyProvider(IActiveXSafetyProvider **ppProvider)
{
    ...
    hr = CoCreateInstance(CLSID_IActiveXSafetyProvider, NULL, CLSCTX_INPROC_SERVER, IID_IActiveXSafetyProvider, (void **)&_pActiveXSafetyProvider);
    *ppProvider = _pActiveXSafetyProvider;
...
CDoc::GetHTMLEditor( BOOL fForceCreate /* = TRUE */ )
{
    ...
    if( fForceCreate )
    {
        ...
        hr = ::CoCreateInstance(CLSID_HTMLEditor, NULL, CLSCTX_INPROC_SERVER, IID_IHTMLEditor , (void**) &_pIHTMLEditor );
        if( FAILED( hr ) || _pIHTMLEditor == NULL )
            goto Error;
