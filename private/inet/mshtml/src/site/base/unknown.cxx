...
HRESULT CUnknownElement::InternalSetTagName(CHtmTag *pht)
{
    HRESULT     hr;
    LPCTSTR     pchTagName;
    CStr        cstrTagName;
...
HRESULT CUnknownElement::CreateElement(CHtmTag *pht, CDoc *pDoc, CElement **ppElement)
{
    Assert(ppElement);
...
HRESULT CUnknownElement::Init2(CInit2Context * pContext)
{
    HRESULT     hr;
