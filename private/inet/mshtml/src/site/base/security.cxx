...
BEGIN_TEAROFF_TABLE_(COmLocationProxy, IDispatchEx)
    ...
    TEAROFF_METHOD(COmLocationProxy, GetIDsOfNames, getidsofnames, (REFIID riid, LPOLESTR *prgpsz, UINT cpsz, LCID lcid, DISPID *prgid))
    ...
    DWORD mshlflags)
{
    ...
    //  Marshal _pWindow
    hr = THR(CoMarshalInterface(pStm, IID_IHTMLWindow2, _pWindow, dwDestContext, pvDestContext, mshlflags));
    if (hr)
        goto Cleanup;
...
//  Synopsis:   Per IDispatch
HRESULT COmLocationProxy::GetIDsOfNames(
    REFIID                riid,
    LPOLESTR *            rgszNames,
    UINT                  cNames,
    LCID                  lcid,
...
//  Synopsis:   Per IHTMLLocation
HRESULT COmLocationProxy::put_hostname(BSTR bstr)
{
...
//  Synopsis:   Per IHTMLLocation
HRESULT COmLocationProxy::get_hostname(BSTR *bstr)
{
