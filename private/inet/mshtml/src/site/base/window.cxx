...
HRESULT COmWindow2::QueryService(REFGUID guidService, REFIID riid, void **ppvObject)
{
    ...
    *ppvObject = NULL;
    ...
    hr = THR_NOTRACE(_pDoc->QueryService(guidService, riid, ppvObject));
...
//  Synopsis:   Per IDispatch
STDMETHODIMP COmWindow2::GetIDsOfNames(
    REFIID                riid,
    LPOLESTR *            rgszNames,
    UINT                  cNames,
    LCID                  lcid,
    ...
    IHTMLWindow2** pomWindowResult)
{
    ...
    {
#ifdef NO_MARSHALLING
        hr = THR(CoCreateInternetExplorer( IID_IWebBrowserApp, CLSCTX_LOCAL_SERVER, (void **) &pBrowser ));
#else
        hr = THR(CoCreateInstance(CLSID_InternetExplorer, NULL, CLSCTX_LOCAL_SERVER, IID_IWebBrowserApp, (void **)&pBrowser));
#endif
        if (hr)
        {
