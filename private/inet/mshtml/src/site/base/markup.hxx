...
public:
    ...
    NV_DECLARE_TEAROFF_METHOD(OwningDoc, owningdoc, (IHTMLDocument2 * * ppDoc ) );


    // IMarkupTextFrags methods
    NV_DECLARE_TEAROFF_METHOD(GetTextFragCount, gettextfragcount, (long *pcFrags) );
    NV_DECLARE_TEAROFF_METHOD(GetTextFrag, gettextfrag, (long iFrag, BSTR* pbstrFrag, IMarkupPointer* pPointerFrag ) );
    NV_DECLARE_TEAROFF_METHOD(RemoveTextFrag, removetextfrag, (long iFrag) );
    NV_DECLARE_TEAROFF_METHOD(
        InsertTextFrag, inserttextfrag, (long iFrag, BSTR bstrInsert, IMarkupPointer* pPointerInsert ) );
    NV_DECLARE_TEAROFF_METHOD(
        FindTextFragFromMarkupPointer, findtextfragfrommarkuppointer, (IMarkupPointer* pPointerFind, long* piFrag, BOOL* pfFragFound ) );
