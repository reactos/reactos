...
int CISCList::FillList()
{
    ...
    {
        hr = CoCreateInstance(CLSID_InputSequenceCheckerContainer, NULL, CLSCTX_INPROC_SERVER | CLSCTX_NO_CODE_DOWNLOAD, IID_IUnknown, (void**)&pUnk);
    }
    else
    {
        hr = CoCreateInstance(CLSID_InputSequenceCheckerContainer, NULL, CLSCTX_INPROC_SERVER, IID_IUnknown, (void**)&pUnk);
    }
