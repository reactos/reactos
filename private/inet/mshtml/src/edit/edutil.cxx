...
//  Synopsis:   indents a selected range of text by inserting a BLOCKQUOTE or a list appropriately
//  Returns:    HRESULT             S_OK if succesfull or an error
HRESULT IndentSelection()
{
    HRESULT                    hr     = S_OK;
    ...
    hr = _punkContext->QueryInterface( IID_IHTMLDocument2, (void**)&pDoc);
    if (hr)
        goto Cleanup;
...
HRESULT FetchMarkupServices( IMarkupServices ** pMarkupServices )
{
    IHTMLDocument2  *  pDoc = NULL;
...
HRESULT EdUtil::CopyAttributes( IHTMLViewServices *pViewSrv, IHTMLElement * pSrcElement, IHTMLElement * pDestElement, BOOL fCopyId)
{
