...
HRESULT CIndentCommand::MergeBlockquotesHelper(CBlockPointer *pbpBlock, Direction dir)
{
    HRESULT             hr;
...
HRESULT CIndentCommand::CreateBlockquote(CBlockPointer *pbpContext, IHTMLElement **ppElement)
{
    HRESULT             hr;
    SP_IHTMLElement     spElement;
...
HRESULT CAlignCommand::SetElementAlignment(IHTMLElement *pElement, BSTR szAlign /* = NULL */)
{
    HRESULT         hr;
    ELEMENT_TAG_ID  tagId;
    BOOL            fLayout;
    ...
    // the element itself.  However, we want to align the element.  So, fail the call with S_FALSE.
    IFR(GetViewServices()->IsSite(pElement, &fLayout, NULL, NULL, NULL));
    if (fLayout)
        return S_FALSE;
