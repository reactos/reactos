...
//  Contents:   CPadMessage's implementation of IDocHostUIHandler and IDocHostShowUI
...
{
    if (!_hMenuCtx) {
        _hMenuCtx = LoadMenu(g_hInstResource, MAKEINTRESOURCE(IDR_HTMLPAD_CONTEXT_MENU));
        if (!_hMenuCtx)
            goto Error;
    }
