...
STDMETHODIMP CCSSFilterDispatchSink::GetIDsOfNames(REFIID riid , LPOLESTR *rgszNames, UINT cNames, LCID lcid, DISPID *rgDispId)
{
    Assert( rgDispId );
...
STDMETHODIMP CCSSFilterIntDispatch::GetIDsOfNames(REFIID riid , LPOLESTR *rgszNames, UINT cNames, LCID lcid, DISPID *rgDispId)
{
    HRESULT hr;
