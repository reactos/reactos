...
CEvent::CEvent()
{
    ...
    // a FAIL in the Init of the calling class unless the event class is initialized with the correct IID.
...
//      wFlags          flags describing context in which call to Invoke() was made.
//      pDispParams     arguments passed in.
//      pVarResult      pointer to location to store result in : set to NULL if user doesnt want returned value.
