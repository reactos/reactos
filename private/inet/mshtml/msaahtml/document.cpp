    ...
    : CTridentAO(pAOParent, this, nTOMIndex, nChildID, hWnd)
{
    ...
    m_lRole = ROLE_SYSTEM_PANE;// set the default role
...
//        This method expects that the dispatch member called is a property-get taking no arguments and returning a long.
//    PARAMETERS:
