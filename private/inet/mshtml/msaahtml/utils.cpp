...
//  Synopsis : helper function to retrieve a bstr from the resource string table
HRESULT GetResourceStringValue(UINT idr, BSTR * pbstr )
{
    ...
    *pbstr = NULL;
    ...
    if (MultiByteToWideChar(CP_ACP, 0, (LPCSTR)&chBuffer, -1, (LPWSTR)&awch, ARRAY_SIZE(awch)))
    {
