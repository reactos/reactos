...
//                CWindowAO implements the root window accessible object for the Trident MSAA Registered Handler.
//                This object contains the CImplAccHandler, which implements the IAccHandler interface.
...
public:
    ...
    // derived classes that cache Trident iface pointers need to override this method and call down to the base class's method
    ...
    // object not an element object, so return the IHTMLElement* of the CWindowAO's document child.
...
protected:
    ...
    // this macro declares a public Notify() method that is implemented in window.cpp
