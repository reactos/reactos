...
HRESULT VariantChangeTypeSpecial(VARIANT *pvargDest, VARIANT *pVArg, VARTYPE vt, IServiceProvider *pSrvProvider = NULL, WORD wFlags = 0);
...
STDMETHODIMP GetHTMLWindow(IElementBehaviorSite * pSite, IHTMLWindow2 **ppWindow);
