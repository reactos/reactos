...
//    LPWSTR pwszDownLoadPage = NULL;
    ...
    if ((lResult = RegOpenKeyExA( HKEY_LOCAL_MACHINE, REGKEY_ACTIVESETUP, 0, KEY_READ, &hkeyActiveSetup)) != ERROR_SUCCESS)
    {
        hr = HRESULT_FROM_WIN32(lResult);
        goto Exit;
    }

    if (lResult = SHQueryValueEx(hkeyActiveSetup, pszSETUPPAGE, NULL, &dwType, wszDownLoadPageReg, &dwSize) != ERROR_SUCCESS)
    {
        hr = HRESULT_FROM_WIN32(lResult);
        goto Exit;
    }
