...
*/
    ...
    if (!g_fWriteToStdOut)
    {
        ...
        GetPrivateProfileString(szFileNames, "DifferenceFile", NULL, g_szDiffFileName, BUFFER_SIZE(g_szDiffFileName) - 1, pszDirectory);
        ...
        {
            GetPrivateProfileString(szFileNames, "AdditionsFile", NULL, g_szNewFileName, BUFFER_SIZE(g_szNewFileName) - 1, pszDirectory);
    ...
    while (dwBuffSize < dwBuffSizeOld - 2)
    {
        ...
        dwBuffSize = GetPrivateProfileString(szMethodAttr, NULL, "none", g_pszMethodAttr, dwBuffSize, pszDirectory);
