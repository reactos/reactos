...
Abstract:
    This module contains the private RPC runtime APIs for use by the stubs and by support libraries.
...
RPC_STATUS RPC_ENTRY
I_RpcGetThreadWindowHandle(OUT HWND *WindowHandle) ;
...
RPC_STATUS RPC_ENTRY
I_RpcSetWMsgEndpoint (IN WCHAR __RPC_FAR * Endpoint) ;
#endif
