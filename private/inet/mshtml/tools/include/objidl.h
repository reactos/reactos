...
EXTERN_C const IID IID_IMarshal;
    ...
    typedef struct IMarshalVtbl
    {
        ...
        ULONG ( STDMETHODCALLTYPE __RPC_FAR *AddRef )(IMarshal __RPC_FAR * This);
        ULONG ( STDMETHODCALLTYPE __RPC_FAR *Release )(IMarshal __RPC_FAR * This);
...
void __RPC_FAR *STDMETHODCALLTYPE IMalloc_Alloc_Proxy(IMalloc __RPC_FAR * This, /* [in] */ ULONG cb);
...
void STDMETHODCALLTYPE IMalloc_HeapMinimize_Proxy(IMalloc __RPC_FAR * This);
