 ...
 * in the page. The last field (typed as an array of paragraphs) is the allocation area.
 */
typedef struct {
 ...
 * consists of a single region, described by the statically allocated decriptor __small_block_heap (declared below).
 */
