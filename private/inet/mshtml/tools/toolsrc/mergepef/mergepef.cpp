...
void ProcessListFile(char* szListFile)
{
    ...
    vhInListFileMap = CreateFileMapping(vhListFile, NULL, PAGE_READONLY, 0, dwFileSize, NULL);
...
DWORD CbAppendPef(char* szInputFile)
{
    ...
    vhInFile = CreateFile(szInputFile, GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
    if (INVALID_HANDLE_VALUE == vhInFile)
    ...
    vhInFileMap = CreateFileMapping(vhInFile, NULL, PAGE_READONLY, 0, dwFileSize, NULL);
