...
HRESULT CDetailFrame::CreateInstance (CDoc * pDoc, CSite * pParent, OUT CBaseFrame **ppFrame, HROW hrow)
{
    ...
    if (_apNode[NEXT_NODE])
    {
        ...
        if (pDetailFrame->_rcl[eLeft] != _rcl[eLeft] || pDetailFrame->_rcl.Size() != _rcl.Size())
        {
            // Assert (FALSE);
            EmptyRecycle();
            goto NewInstance;
