...
{
    return ps->TestClassFlag(CSite::SITEDESC_TEMPLATE) && ps->TestClassFlag(CSite::SITEDESC_DATAFRAME);
}
...
class CAryPly : public CDataAry<PLY>
{
public:
    ~CAryPly();
...
class CArySelector : public CPtrAry<SelectUnit *>
{
public:
    ~CArySelector();
    ...
    HRESULT      Append(SelectUnit *pSU) { return CPtrAry<SelectUnit *>::Append(pSU); }
