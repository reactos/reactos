...
public:
    ...
    STDMETHOD(CreateInstance)(CLSID clsid, IUnknown * punkOuter, REFIID riid, DWORD dwClsCtx, void ** ppvObj);
    STDMETHOD(GetTypeLibOfClsid)(CLSID clsid, ITypeLib ** ptlib);
    STDMETHOD(GetClassObjectOfClsid)(REFCLSID rclsid, DWORD dwClsCtx, LPVOID lpReserved, REFIID riid, void ** ppcClassObject);
