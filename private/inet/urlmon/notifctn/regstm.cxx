                       ...
                       : CMemStream(fForceNewStream)
{
    ...
    lRes = RegCreateKeyEx(hBaseKey, pszRegKey, 0, NULL, 0, HKEY_READ_WRITE_ACCESS, NULL, &_hKey, &dwDisposition);
    ...
    if (!fForceNewStream)
    {
        ...
        else
        {
            ...
            lRes = RegQueryValueEx(_hKey, _pszSubKey, NULL, &dwType, (BYTE *)pData, &dwSize);
            GlobalUnlock(hGlobal);
