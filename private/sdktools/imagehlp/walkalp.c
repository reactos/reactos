...
Routine Description:
    ...
    This function mirrors RtlLookupFunctionEntry with changes required to make it work from a separate process and capable of searching 32- or 64-bit function tables
