...
technique CTSB
{
    pass P0
    {
        ...
        asm
        {
            ...
            mov     r0.r, r0.r  // set red
            mov     r0.g, r1.g  // set green
            mov     r0.b, r2.b  // set blue

            mul     r0.rgb, r0, c2    // multiply glyph alphas by brush alpha
            mul     r0.a, r1.g, c2.r  // set final alpha to the green channel alpha to match greyscale behavior
...
technique GSSB
{
    pass P0
    {
        ...
        asm
        {
            ...
            mul     r0.a, r0.r, c2.a  // multiply by alpha
...
technique CTTB
{
    pass P0
    {
        ...
        asm
        {
            ...
            texld r1, t1, s1      // fetch the alpha (rgb)

            mul_sat r0, r0, c5.a    // combine brush color with effect alpha

            mul_sat r1, r0, r1.r    // combine alphas
...
technique GSTB
{
    pass P0
    {
        ...
        asm
        {
            ...
            texld r0, t1, s1      // fetch the alpha (rgb)

            mul_sat r2, r2, c5.a    // combine brush color with effect alpha

            mul_sat r1, r2, r0.r    // combine alphas
