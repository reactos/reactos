...
@ stdcall -version=0x600+ D3DKMTCheckExclusiveOwnership()
@ stdcall -version=0x600+ D3DKMTCheckMonitorPowerState(ptr)
@ stdcall -version=0x600+ D3DKMTCheckOcclusion(ptr)
@ stdcall -version=0x600+ D3DKMTCloseAdapter(ptr)
@ stdcall -version=0x600+ D3DKMTCreateAllocation(ptr)
@ stdcall -version=0x600+ D3DKMTCreateContext(ptr)
@ stdcall -version=0x600+ D3DKMTCreateDCFromMemory(ptr)
@ stdcall -version=0x600+ D3DKMTCreateDevice(ptr)
@ stdcall -version=0x600+ D3DKMTCreateOverlay(ptr)
@ stdcall -version=0x600+ D3DKMTCreateSynchronizationObject(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyAllocation(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyContext(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyDCFromMemory(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyDevice(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyOverlay(ptr)
@ stdcall -version=0x600+ D3DKMTDestroySynchronizationObject(ptr)
@ stdcall -version=0x600+ D3DKMTEscape(ptr)
@ stdcall -version=0x600+ D3DKMTFlipOverlay(ptr)
@ stdcall -version=0x600+ D3DKMTGetContextSchedulingPriority(ptr)
@ stdcall -version=0x600+ D3DKMTGetDeviceState(ptr)
@ stdcall -version=0x600+ D3DKMTGetDisplayModeList(ptr)
@ stdcall -version=0x600+ D3DKMTGetMultisampleMethodList(ptr)
@ stdcall -version=0x600+ D3DKMTGetPresentHistory(ptr)
@ stdcall -version=0x600+ D3DKMTGetProcessSchedulingPriorityClass(ptr ptr)
@ stdcall -version=0x600+ D3DKMTGetRuntimeData(ptr)
@ stdcall -version=0x600+ D3DKMTGetScanLine(ptr)
@ stdcall -version=0x600+ D3DKMTGetSharedPrimaryHandle(ptr)
@ stdcall -version=0x600+ D3DKMTInvalidateActiveVidPn(ptr)
@ stdcall -version=0x600+ D3DKMTLock(ptr)
@ stdcall -version=0x600+ D3DKMTOpenAdapterFromDeviceName(ptr)
@ stdcall -version=0x600+ D3DKMTOpenAdapterFromGdiDisplayName(ptr)
@ stdcall -version=0x600+ D3DKMTOpenAdapterFromHdc(ptr)
@ stdcall -version=0x600+ D3DKMTOpenResource(ptr)
@ stdcall -version=0x600+ D3DKMTPollDisplayChildren(ptr)
@ stdcall -version=0x600+ D3DKMTPresent(ptr)
@ stdcall -version=0x600+ D3DKMTQueryAdapterInfo(ptr)
@ stdcall -version=0x600+ D3DKMTQueryAllocationResidency(ptr)
@ stdcall -version=0x600+ D3DKMTQueryResourceInfo(ptr)
@ stdcall -version=0x600+ D3DKMTQueryStatistics(ptr)
@ stdcall -version=0x600+ D3DKMTReleaseProcessVidPnSourceOwners(ptr)
@ stdcall -version=0x600+ D3DKMTRender(ptr)
@ stdcall -version=0x600+ D3DKMTSetAllocationPriority(ptr)
@ stdcall -version=0x600+ D3DKMTSetContextSchedulingPriority(ptr)
@ stdcall -version=0x600+ D3DKMTSetDisplayMode(ptr)
@ stdcall -version=0x600+ D3DKMTSetDisplayPrivateDriverFormat(ptr)
@ stdcall -version=0x600+ D3DKMTSetGammaRamp(ptr)
@ stdcall -version=0x600+ D3DKMTSetProcessSchedulingPriorityClass(ptr ptr)
@ stdcall -version=0x600+ D3DKMTSetQueuedLimit(ptr)
@ stdcall -version=0x600+ D3DKMTSetVidPnSourceOwner(ptr)
@ stdcall -version=0x600+ D3DKMTSharedPrimaryLockNotification(ptr)
@ stdcall -version=0x600+ D3DKMTSharedPrimaryUnLockNotification(ptr)
@ stdcall -version=0x600+ D3DKMTSignalSynchronizationObject(ptr)
@ stdcall -version=0x600+ D3DKMTUnlock(ptr)
@ stdcall -version=0x600+ D3DKMTUpdateOverlay(ptr)
