...
NTSTATUS
WINAPI
D3DKMTCreateSynchronizationObject(_Inout_ PD3DKMT_CREATESYNCHRONIZATIONOBJECT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTDestroyAllocation(_In_ PD3DKMT_DESTROYALLOCATION unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTDestroyContext(_In_ PD3DKMT_DESTROYCONTEXT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTDestroyDevice(_In_ PD3DKMT_DESTROYDEVICE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTDestroyOverlay(_In_ PD3DKMT_DESTROYOVERLAY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTDestroySynchronizationObject(_In_ PD3DKMT_DESTROYSYNCHRONIZATIONOBJECT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTEscape(_In_ PD3DKMT_ESCAPE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTFlipOverlay(_In_ PD3DKMT_FLIPOVERLAY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetContextSchedulingPriority(_Inout_ PD3DKMT_GETCONTEXTSCHEDULINGPRIORITY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetDeviceState(_Inout_ PD3DKMT_GETDEVICESTATE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetDisplayModeList(_Inout_ PD3DKMT_GETDISPLAYMODELIST unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetMultisampleMethodList(_Inout_ PD3DKMT_GETMULTISAMPLEMETHODLIST unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetPresentHistory(_Inout_ PD3DKMT_GETPRESENTHISTORY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetRuntimeData(_In_ PD3DKMT_GETRUNTIMEDATA unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetScanLine(_In_ PD3DKMT_GETSCANLINE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTGetSharedPrimaryHandle(_Inout_ PD3DKMT_GETSHAREDPRIMARYHANDLE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTInvalidateActiveVidPn(_In_ PD3DKMT_INVALIDATEACTIVEVIDPN unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTLock(_Inout_ PD3DKMT_LOCK unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTOpenAdapterFromDeviceName(_Inout_ PD3DKMT_OPENADAPTERFROMDEVICENAME unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTOpenAdapterFromGdiDisplayName(_Inout_ PD3DKMT_OPENADAPTERFROMGDIDISPLAYNAME unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTOpenAdapterFromHdc(_Inout_ PD3DKMT_OPENADAPTERFROMHDC unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTOpenResource(_Inout_ PD3DKMT_OPENRESOURCE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTPollDisplayChildren(_In_ PD3DKMT_POLLDISPLAYCHILDREN unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTPresent(_In_ PD3DKMT_PRESENT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTQueryAdapterInfo(_Inout_ PD3DKMT_QUERYADAPTERINFO unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTQueryAllocationResidency(_In_ PD3DKMT_QUERYALLOCATIONRESIDENCY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTQueryResourceInfo(_Inout_ PD3DKMT_QUERYRESOURCEINFO unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTQueryStatistics(_Inout_ PD3DKMT_QUERYSTATISTICS unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTRender(_In_ PD3DKMT_RENDER unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetAllocationPriority(_In_ PD3DKMT_SETALLOCATIONPRIORITY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetContextSchedulingPriority(_In_ PD3DKMT_SETCONTEXTSCHEDULINGPRIORITY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetDisplayMode(_In_ PD3DKMT_SETDISPLAYMODE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetDisplayPrivateDriverFormat(_In_ PD3DKMT_SETDISPLAYPRIVATEDRIVERFORMAT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetGammaRamp(_In_ PD3DKMT_SETGAMMARAMP unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetQueuedLimit(_Inout_ PD3DKMT_SETQUEUEDLIMIT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSetVidPnSourceOwner(_In_ PD3DKMT_SETVIDPNSOURCEOWNER unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSharedPrimaryLockNotification(_In_ PD3DKMT_SHAREDPRIMARYLOCKNOTIFICATION unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSharedPrimaryUnLockNotification(_In_ PD3DKMT_SHAREDPRIMARYUNLOCKNOTIFICATION unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTSignalSynchronizationObject(_In_ PD3DKMT_SIGNALSYNCHRONIZATIONOBJECT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTUnlock(_In_ PD3DKMT_UNLOCK unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTUpdateOverlay(_In_ PD3DKMT_UPDATEOVERLAY unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTWaitForIdle(_In_ PD3DKMT_WAITFORIDLE unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTWaitForSynchronizationObject(_In_ PD3DKMT_WAITFORSYNCHRONIZATIONOBJECT unnamedParam1)
{
...
NTSTATUS
WINAPI
D3DKMTWaitForVerticalBlankEvent(_In_ PD3DKMT_WAITFORVERTICALBLANKEVENT unnamedParam1)
{
