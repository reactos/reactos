...
#define DF_DIALOGACTIVE 0x4000 // MenuOS
...
//// MenuOS see 43396, Fixes setting focus on Open and Close dialogs to the FileName edit control in OpenOffice.
//// This now breaks test_SaveRestoreFocus.
            //DEFDLG_SaveFocus( hwnd );
////
        }
//// MenuOS Rev 30613 & 30644
...
/*
 * @implemented Modified for MenuOS. Do not Port Sync!!!
 */
BOOL
WINAPI
EndDialog(
...
{
	HWND hwndCtrl;
	if ( hDlg == HWND_TOPMOST || hDlg == HWND_BROADCAST ) return 0; // MenuOS
...
SetDlgItemTextA(
  ...
  LPCSTR lpString)
{
  HWND hwndCtrl = GetDlgItem( hDlg, nIDDlgItem ); // MenuOS Themes
