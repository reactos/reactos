...
DEFINE_IME_ENTRY(DWORD, CtfImeInquireExW, (LPIMEINFO lpIMEInfo, LPVOID lpszWndClass, DWORD dwSystemInfoFlags, HKL hKL), TRUE)
DEFINE_IME_ENTRY(DWORD, CtfImeSelectEx, (HIMC hIMC, BOOL fSelect, HKL hKL), TRUE)
