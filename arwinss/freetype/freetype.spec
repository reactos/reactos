@ cdecl FTC_CMapCache_Lookup()
@ cdecl FTC_CMapCache_New()
@ cdecl FTC_ImageCache_Lookup()
@ cdecl FTC_ImageCache_LookupScaler()
@ cdecl FTC_ImageCache_New()
@ cdecl FTC_Manager_Done()
@ cdecl FTC_Manager_LookupFace()
@ cdecl FTC_Manager_LookupSize()
@ cdecl FTC_Manager_New()
@ cdecl FTC_Manager_RemoveFaceID()
@ cdecl FTC_Manager_Reset()
@ cdecl FTC_Node_Unref()
@ cdecl FTC_SBitCache_Lookup()
@ cdecl FTC_SBitCache_LookupScaler()
@ cdecl FTC_SBitCache_New()
...
@ cdecl FT_FloorFix()
@ cdecl FT_Get_Advance()
@ cdecl FT_Get_Advances()
@ cdecl FT_Get_BDF_Charset_ID()
@ cdecl FT_Get_BDF_Property()
@ cdecl FT_Get_CMap_Format()
@ cdecl FT_Get_CMap_Language_ID()
@ cdecl FT_Get_Char_Index()
@ cdecl FT_Get_Charmap_Index()
@ cdecl FT_Get_CID_From_Glyph_Index()
@ cdecl FT_Get_CID_Is_Internally_CID_Keyed()
@ cdecl FT_Get_CID_Registry_Ordering_Supplement()
@ cdecl FT_Get_First_Char()
@ cdecl FT_Get_FSType_Flags()
@ cdecl FT_Get_Glyph()
