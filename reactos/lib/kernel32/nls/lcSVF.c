...
CONST WCHAR *__LC_SVF0[]=
{
   NULL, 
   (CONST WCHAR[]) { '0', '8', '1', 'd', 0 }, 
   (CONST WCHAR[]) { 'S', 'w', 'e', 'd', 'i', 's', 'h', ' ', '(', 'F', 'i', 'n', 'l', 'a', 'n', 'd', ')', 0 }, 
   (CONST WCHAR[]) { 'S', 'V', 'F', 0 }, 
...
CONST WCHAR *__LC_SVFdl[]=
{
   (CONST WCHAR[]) { '\'', 'd', 'e', 'n', ' ', '\'', 'd', ' ', 'M', 'M', 'M', 'M', ' ', 'y', 'y', 'y', 'y', 0, 0 }, 
   NULL
};

CONST WCHAR *__LC_SVFt[]=
{
