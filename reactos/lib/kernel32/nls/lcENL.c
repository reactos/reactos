...
CONST WCHAR *__LC_ENL0[]=
{
   NULL, 
   (CONST WCHAR[]) { '2', '8', '0', '9', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', ' ', '(', 'B', 'e', 'l', 'i', 'z', 'e', ')', 0 }, 
   (CONST WCHAR[]) { 'E', 'N', 'L', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', 0 }, 
   (CONST WCHAR[]) { '5', '0', '1', 0 }, 
   (CONST WCHAR[]) { 'B', 'e', 'l', 'i', 'z', 'e', 0 }, 
   (CONST WCHAR[]) { 'B', 'L', 'Z', 0 }, 
   (CONST WCHAR[]) { 'B', 'e', 'l', 'i', 'z', 'e', 0 }, 
   (CONST WCHAR[]) { 'E', 'N', 'G', 0 }, 
   (CONST WCHAR[]) { '5', '0', '1', 0 }, 
