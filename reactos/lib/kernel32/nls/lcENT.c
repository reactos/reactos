...
CONST WCHAR *__LC_ENT0[]=
{
   NULL, 
   (CONST WCHAR[]) { '2', 'c', '0', '9', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', ' ', '(', 'T', 'r', 'i', 'n', 'i', 'd', 'a', 'd', ')', 0 }, 
   (CONST WCHAR[]) { 'E', 'N', 'T', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', 0 }, 
   (CONST WCHAR[]) { '1', 0 }, 
   (CONST WCHAR[]) { 'T', 'r', 'i', 'n', 'i', 'd', 'a', 'd', ' ', 'y', ' ', 'T', 'o', 'b', 'a', 'g', 'o', 0 }, 
   (CONST WCHAR[]) { 'T', 'T', 'O', 0 }, 
   (CONST WCHAR[]) { 'T', 'r', 'i', 'n', 'i', 'd', 'a', 'd', ' ', 'y', ' ', 'T', 'o', 'b', 'a', 'g', 'o', 0 }, 
   (CONST WCHAR[]) { 'E', 'N', 'G', 0 }, 
   (CONST WCHAR[]) { '1', 0 }, 
