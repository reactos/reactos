...
CONST WCHAR *__LC_ENS0[]=
{
   NULL, 
   (CONST WCHAR[]) { '1', 'c', '0', '9', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', ' ', '(', 'S', 'o', 'u', 't', 'h', ' ', 'A', 'f', 'r', 'i', 'c', 'a', ')', 0 }, 
   (CONST WCHAR[]) { 'E', 'N', 'S', 0 }, 
...
CONST WCHAR *__LC_ENSds[]=
{
   (CONST WCHAR[]) { 'y', 'y', '/', 'M', 'M', '/', 'd', 'd', 0, 0 }, 
   NULL
};

CONST WCHAR *__LC_ENSdl[]=
{
   (CONST WCHAR[]) { 'd', 'd', ' ', 'M', 'M', 'M', 'M', ' ', 'y', 'y', 'y', 'y', 0, 0 }, 
   NULL
};

CONST WCHAR *__LC_ENSt[]=
{
