...
CONST WCHAR *__LC_ENJ0[]=
{
   NULL, 
   (CONST WCHAR[]) { '2', '0', '0', '9', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', ' ', '(', 'J', 'a', 'm', 'a', 'i', 'c', 'a', ')', 0 }, 
   (CONST WCHAR[]) { 'E', 'N', 'J', 0 }, 
   (CONST WCHAR[]) { 'E', 'n', 'g', 'l', 'i', 's', 'h', 0 }, 
   (CONST WCHAR[]) { '1', 0 }, 
   (CONST WCHAR[]) { 'J', 'a', 'm', 'a', 'i', 'c', 'a', 0 }, 
   (CONST WCHAR[]) { 'J', 'A', 'M', 0 }, 
   (CONST WCHAR[]) { 'J', 'a', 'm', 'a', 'i', 'c', 'a', 0 }, 
   (CONST WCHAR[]) { '2', '0', '0', '9', 0 }, 
   (CONST WCHAR[]) { '1', 0 }, 
...
CONST WCHAR *__LC_ENJds[]=
{
   (CONST WCHAR[]) { 'd', 'd', '/', 'M', 'M', '/', 'y', 'y', 'y', 'y', 0, 0 }, 
   NULL
};

CONST WCHAR *__LC_ENJdl[]=
{
