        ...
        IN INT namelen)
{
    ...
    if ((ErrorCode = WsApiProlog(&Process, &Thread)) == ERROR_SUCCESS)
    {
        ...
        if (Socket = WsSockGetSocket(s))
        {
            ...
            {
                /* Make the call */
                Status = Socket->Provider->lpWSPConnect(s,
                                                        name,
                                                        namelen,
                                                        NULL,
                                                        NULL,
       ...
       IN INT backlog)
{
    ...
    if ((ErrorCode = WsQuickProlog()) == ERROR_SUCCESS)
    {
        ...
        {
            /* Make the call */
            Status = Socket->Provider->lpWSPListen(s,
                                                   backlog,
                                                   &ErrorCode);
            /* Deference the Socket Context */
            WsSockDereference(Socket);
            ...
            IN OUT INT FAR* namelen)
{
    ...
    if ((ErrorCode = WsQuickProlog()) == ERROR_SUCCESS)
    {
        ...
        {
            /* Make the call */
            Status = Socket->Provider->lpWSPGetPeerName(s,
                                                        name,
                                                        namelen,
                                                        &ErrorCode);
            /* Deference the Socket Context */
            ...
            IN OUT INT FAR* namelen)
{
    ...
    if ((ErrorCode = WsQuickProlog()) == ERROR_SUCCESS)
    {
        ...
        {
            /* Make the call */
            Status = Socket->Provider->lpWSPGetSockName(s,
                                                        name,
                                                        namelen,
                                                        &ErrorCode);
           ...
           IN OUT INT FAR* optlen)
{
    ...
    if ((ErrorCode = WsApiProlog(&Process, &Thread)) == ERROR_SUCCESS)
    {
        ...
        if (Socket = WsSockGetSocket(s))
        {
            ...
            /* Make the call */
            Status = Socket->Provider->lpWSPGetSockOpt(s,
                                                       level,
                                                       optname,
                                                       optval,
                                                       optlen,
           ...
           IN INT optlen)
{
    ...
    if ((ErrorCode = WsApiProlog(&Process, &Thread)) == ERROR_SUCCESS)
    {
        ...
        {
            /* Make the call */
            Status = Socket->Provider->lpWSPSetSockOpt(s,
                                                       level,
                                                       optname,
                                                       optval,
                                                       optlen,
         ...
         IN INT how)
{
    ...
    if ((ErrorCode = WsQuickProlog()) == ERROR_SUCCESS)
    {
        ...
        {
            /* Make the call */
            Status = Socket->Provider->lpWSPShutdown(s, how, &ErrorCode);
                       ...
                       OUT LPDWORD lpdwFlags)
{
    ...
    if ((ErrorCode = WsQuickProlog()) == ERROR_SUCCESS)
    {
        ...
        {
            /* Make the call */
            Status = Socket->Provider->lpWSPGetOverlappedResult(s,
                                                                lpOverlapped,
                                                                lpcbTransfer,
                                                                fWait,
                                                                lpdwFlags,
