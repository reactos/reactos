               ...
               IN LPWSAPROTOCOL_INFOW ProtocolInfo)
{
    ...
    RtlZeroMemory(&Provider->lpWSPAccept, sizeof(WSPPROC_TABLE));
    ...
    (*WSPStartupProc)(VersionRequested,
                      ...
                      ProtocolInfo,
                      UpcallTable,
                      (LPWSPPROC_TABLE)&Provider->lpWSPAccept);
               ...
               IN LPINT lpErrNo)
{
    ...
    if (Provider->DllHandle)
    {
        ...
        WSPCleanup = InterlockedExchangePointer((PVOID*)&Provider->lpWSPCleanup,
                                                NULL);
