                    ...
                    IN OUT  LPDWORD lpdwAddressStringLength)
{
    ...
    {
        /* Call the provider */
        Status = CatalogEntry->Provider->lpWSPAddressToString(lpsaAddress,
                                                              dwAddressLength,
                                                              &CatalogEntry->
                                                              ProtocolInfo,
                                                              UnicodeString,
...
INT
WSAAPI
WSALookupServiceBeginA(IN LPWSAQUERYSET lpqsRestrictions,
                    ...
                    IN OUT  LPINT lpAddressLength)
{
    ...
    {
        /* Call the provider */
        Status = CatalogEntry->Provider->lpWSPStringToAddress(UnicodeString,
                                                              AddressFamily,
                                                              &CatalogEntry->
                                                              ProtocolInfo,
                                                              lpAddress,
                    ...
                    IN OUT LPINT lpAddressLength)
{
    ...
    {
        /* Call the provider */
        Status = CatalogEntry->Provider->lpWSPStringToAddress(AddressString,
                                                              AddressFamily,
                                                              &CatalogEntry->
                                                              ProtocolInfo,
                                                              lpAddress,
