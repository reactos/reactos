/* $Id: mminit.c,v 1.39 2002/09/07 15:13:00 chorns Exp $
 *
...
PVOID MiHighestUserAddress = NULL; 
PVOID * MmHighestUserAddress = &MiHighestUserAddress; 
ULONG MiUserProbeAddress = 0;
ULONG * MmUserProbeAddress = &MiUserProbeAddress;
 ...
 */
{
    ...
    */
   MiUserProbeAddress = (ULONG)0x7fff0000;
   MiHighestUserAddress = (PVOID)0x7ffeffff;
