...
clean: $(MK_REGTESTS_CLEAN) $(SUBDIRS:%=%_clean)
	$(HALFVERBOSEECHO) [CLEAN]   *.o $(MK_PCHNAME) $(MK_BASENAME).sym $(MK_BASENAME).a \
        $(MK_RESOURCE) $(MK_FULLNAME) $(MK_NOSTRIPNAME) $(MK_CLEANFILES) $(MK_CLEANDEPS) \
        $(MK_BASENAME).map junk.tmp base.tmp temp.exp $(MK_RC_BINARIES) $(MK_SPECDEF) \
        $(MK_STUBS_SRC) $(MK_GENERATED_MAKEFILE) $(TARGET_CLEAN)
