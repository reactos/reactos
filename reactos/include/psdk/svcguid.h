...
#define SVCID_TCP_RR(Port, Type) { (0x0009 << 16) | (Port), 0, Type, { 0xC0,0,0,0,0,0,0,0x46 } }

#define SVCID_DNS(Type) SVCID_TCP_RR(53, Type)
...
#define SVCID_TCP(Port) SVCID_TCP_RR(Port, 0)
...
#define SVCID_UDP_RR(Port, Type) { (0x000A << 16) | (Port), 0, Type, { 0xC0,0,0,0,0,0,0,0x46 } }
#define SVCID_UDP(Port) SVCID_UDP_RR(Port, 0)
