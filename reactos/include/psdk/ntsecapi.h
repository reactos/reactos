...
#define MAX_RECORDS_IN_FOREST_TRUST_INFO 4000
  ...
  NTSTATUS NTAPI LsaLookupPrivilegeName(LSA_HANDLE PolicyHandle, PLUID Value, PLSA_UNICODE_STRING* Name);
  NTSTATUS NTAPI LsaLookupPrivilegeValue(LSA_HANDLE PolicyHandle, PLSA_UNICODE_STRING Name, PLUID Value);
