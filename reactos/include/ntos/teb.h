...
typedef struct _RTL_ROS_USER_PROCESS_PARAMETERS
{
...
} RTL_ROS_USER_PROCESS_PARAMETERS, *PRTL_ROS_USER_PROCESS_PARAMETERS;
...
typedef struct _PEB
{
   ...
   PRTL_ROS_USER_PROCESS_PARAMETERS ProcessParameters;  // 10h
