...
static MUI_ENTRY csCZSelectFSEntries[] =
{
    ...
    },
    {
        8,
        19,
        "\x07  Zvolte souborovì syst‚m çipkami nahoru a dol….",
        0
    },
    {
        8,
        21,
        "\x07  StisknØte ENTER pro zform tov n¡ odd¡lu.",
        0
    },
    {
        8,
        23,
        "\x07  StisknØte ESC pro vybr n¡ jin‚ho odd¡lu.",
        0
    },
    {
        0,
...
{
    {
        ...
        "\n"
        "  \x07  StisknØte ENTER pro pokraŸov n¡ instalace.\n"
        "  \x07  StisknØte F3 pro ukonŸen¡ instalace.",
    ...
    },
    {
        //ERROR_WARN_PARTITION,
          ...
          "\n"
          "  \x07  StisknØte F3 pro ukonŸen¡ instalace."
          "  \x07  StisknØte ENTER pro pokraŸov n¡.",
          "F3= UkonŸit  ENTER = PokraŸovat"
    },
    {
        //ERROR_NEW_PARTITION,
...
MUI_STRING csCZStrings[] =
{
    ...
    {STRING_FORMATDISK1,
    " Zform tovat odd¡l na souborovì syst‚m %S (rychl‚ form tov n¡) "},
    {STRING_FORMATDISK2,
