...
DRVFN gaDxgFuncs [] = 
{
    ...
    {DXG_INDEX_DxDdCreateD3DBuffer2, (PFN)DxDdCreateD3DBuffer},
    ...
    {DXG_INDEX_DxDdGetFlipStatus, (PFN)},
    {DXG_INDEX_DxDdGetInternalMoCompInfo, (PFN)},
    {DXG_INDEX_DxDdGetMoCompBuffInfo, (PFN)},
    {DXG_INDEX_DxDdGetMoCompGuids, (PFN)},
    {DXG_INDEX_DxDdGetMoCompFormats, (PFN)},
    {DXG_INDEX_DxDdGetScanLine, (PFN)},
    {DXG_INDEX_DxDdLock, (PFN)},
    {DXG_INDEX_DxDdLockD3D, (PFN)},
    {DXG_INDEX_DxDdQueryDirectDrawObject, (PFN)},
    {DXG_INDEX_DxDdQueryMoCompStatus, (PFN)},
    {DXG_INDEX_DxDdReenableDirectDrawObject, (PFN)},
    {DXG_INDEX_DxDdReleaseDC, (PFN)},
    {DXG_INDEX_DxDdRenderMoComp, (PFN)},
    {DXG_INDEX_DxDdResetVisrgn, (PFN)},
    {DXG_INDEX_DxDdSetColorKey, (PFN)},
    {DXG_INDEX_DxDdSetExclusiveMode, (PFN)},
    {DXG_INDEX_DxDdSetGammaRamp, (PFN)},
    {DXG_INDEX_DxDdCreateSurfaceEx, (PFN)},
    {DXG_INDEX_DxDdSetOverlayPosition, (PFN)},
    {DXG_INDEX_DxDdUnattachSurface, (PFN)},
