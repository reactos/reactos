...
/*
 * $Source: /cygdrive/c/RCVS/CVS/ReactOS/reactos/lib/kjs/ksrc/mrgsort.c,v $
 * $Id: mrgsort.c,v 1.1 2004/01/10 20:38:17 arty Exp $
 */
	     ...
	     void *comparison_func_context)
{
  ...
  /* Allocate tmp buffer. */
  tmp = js_malloc (number_of_elements * size);
  /* assert (tmp != NULL); */
