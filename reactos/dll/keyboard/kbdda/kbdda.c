...
ROSDATA VSC_LPWSTR key_names[] = {
  ...
  { 0x45, L"PAUSE" },
  { 0x46, L"SCROLL LOCK" },
  { 0x47, L"7 (Numerisk del)" },
  { 0x48, L"8 (Numerisk del)" },
  { 0x49, L"9 (Numerisk del)" },
  { 0x4a, L"- (Numerisk del)" },
  { 0x4b, L"4 (Numerisk del)" },
  { 0x4c, L"5 (Numerisk del)" },
  { 0x4d, L"6 (Numerisk del)" },
  { 0x4e, L"+ (Numerisk del)" },
  { 0x4f, L"1 (Numerisk del)" },
  { 0x50, L"2 (Numerisk del)" },
  { 0x51, L"3 (Numerisk del)" },
  { 0x52, L"0 (Numerisk del)" },
  { 0x53, L"DECIMAL (Numerisk del)" },
  { 0x54, L"SYS REQ" },
  { 0x57, L"F11" },
  { 0x58, L"F12" },
  { 0x7c, L"F13" },
