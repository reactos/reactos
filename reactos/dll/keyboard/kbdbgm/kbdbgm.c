 ...
 * ћарица - Ѕългарска клавиатурна подредба по Ѕƒ— 5237-78 за –еактќ—
...
ROSDATA USHORT scancode_to_vk[] = {
  ...
  /* - 0f - */
  /* First Letters Row ѕърви буквен ред*/
  VK_TAB,       'Q',          'W',          'E',
  'R',          'T',          'Y',          'U',
  'I',          'O',          'P',          
  VK_OEM_4,     VK_OEM_6,     VK_RETURN,
  /* - 1d - */
  /* Second Letters Row ¬тори буквен ред*/
  VK_LCONTROL,  
  'A',          'S',          'D',          'F',
  'G',          'H',          'J',          'K',
...
ROSDATA VK_TO_WCHARS2 key_to_chars_2mod[] = {
  ...
  { '9',         NOCAPS, {'9', '_'} },
  { '0',         NOCAPS, {'0', 0x2116} }, /* є */
/* «а следващото копче търси (-|) търси VK_OEM_MINUS */
  { VK_OEM_PLUS, NOCAPS, {'=', '+'} },

  /* First letter row ѕърви ред букви ,ыу”е≈и»шЎщўк с—дƒз«ц÷;І недовършен*/
  { 'Q',         NOCAPS,   {0x2c, 0x44b} },
  { 'W',         CAPS,   {0x443, 0x423} },
  { 'E',         CAPS,   {0x435, 0x415} },
  { 'R',         CAPS,   {0x438, 0x418} },
  ...
  /* Second letter row ¬тори ред букви ь№€яајоќж∆г√т“нЌв¬мћч„ */
  { 'A',         CAPS,   {0x44c, 0x42c} },
  { 'S',         CAPS,   {0x44f, 0x42f} },
  { 'D',         CAPS,   {0x430, 0x410} },
  { 'F',         CAPS,   {0x43e, 0x41e} },
  ...
  /* Third letter row “рети ред букви  юёй…ъЏэЁф‘х’пѕр–лЋ */
  { 'Z',         CAPS,   {0x44e, 0x42e} },
  { 'X',         CAPS,   {0x439, 0x419} },
  { 'C',         CAPS,   {0x44a, 0x42a} },
  { 'V',         CAPS,   {0x436, 0x416} },
...
/* { VK_OEM_5, NOCAPS, {0x5c, 0x2f, 0x1c} }, —тарата стойност, над€вам се тук да е бЅ */
  { VK_OEM_5, CAPS, {0x431, 0x411} },
  { VK_OEM_102, NOCAPS, {0x5c, 0x2f, 0x1c} }, /* “ук освен да е допълнителното копче до л€вата см€на */
