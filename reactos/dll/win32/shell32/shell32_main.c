...
INT_PTR CALLBACK AboutAuthorsDlgProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    switch(msg)
    {
        case WM_INITDIALOG:
        {
            ...
            // First add the Wine and ReactOS copyrights
            SendDlgItemMessageW( hWnd, IDC_SHELL_ABOUT_AUTHORS_LISTBOX, LB_ADDSTRING, 0, (LPARAM)L"Copyright 1993-2007 WINE Team");
            SendDlgItemMessageW( hWnd, IDC_SHELL_ABOUT_AUTHORS_LISTBOX, LB_ADDSTRING, 0, (LPARAM)L"Copyright 1998-2007 ReactOS Team");
            SendDlgItemMessageW( hWnd, IDC_SHELL_ABOUT_AUTHORS_LISTBOX, LB_ADDSTRING, 0, (LPARAM)L"");

            // Now add the authors from the autogenerated list
