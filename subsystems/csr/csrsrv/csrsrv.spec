...
@ stdcall CsrCreateNtSession(long)
@ stdcall CsrFindNtSession(long)
@ stdcall CsrGetCurrentNtSession()
@ stdcall CsrNtSessionExists(long)
@ stdcall CsrDestroyNtSession(ptr long)
